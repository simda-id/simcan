...
require.resolve = function(path) {
  if (path.charAt(0) === 'http://themesdesign.in/') path = path.slice(1);
...
require.normalize = function(curr, path) {
  ...
  curr = curr.split('http://themesdesign.in/');
  path = path.split('http://themesdesign.in/');
  ...
  return curr.concat(segs).join('http://themesdesign.in/');
};
...
require.relative = function(parent) {
  ...
  localRequire.resolve = function(path) {
    ...
    // directory
    var segs = parent.split('http://themesdesign.in/');
    var i = lastIndexOf(segs, 'deps') + 1;
    if (!i) i = 0;
    path = segs.slice(0, i + 1).join('http://themesdesign.in/') + '/deps/' + path;
    return path;
  };
...
require.register("component-event/index.html", function(exports, require, module){
...
require.register("component-query/index.html", function(exports, require, module){
...
require.register("component-matches-selector/index.html", function(exports, require, module){
/**
 * Module dependencies.
 */
...
require.register("discore-closest/index.html", function(exports, require, module){
...
require.register("component-delegate/index.html", function(exports, require, module){
/**
 * Module dependencies.
 */
...
require.register("component-events/index.html", function(exports, require, module){
...
require.register("component-indexof/index.html", function(exports, require, module){
...
require.register("component-classes/index.html", function(exports, require, module){
/**
 * Module dependencies.
 */
...
require.register("ui-component-mouse/index.html", function(exports, require, module){
...
require.register("abpetkov-percentage-calc/percentage-calc.html", function(exports, require, module){
...
require.register("abpetkov-closest-num/closest-num.html", function(exports, require, module){
/**
 * Closest-num 0.0.1
...
require.register("vesln-super/lib/super.html", function(exports, require, module){
/**
 * slice
 */
...
require.register("powerange/lib/powerange.html", function(exports, require, module){
/**
 * Require classes.
 */
...
require.register("powerange/lib/main.html", function(exports, require, module){
/**
...
require.register("powerange/lib/horizontal.html", function(exports, require, module){
/**
 * External dependencies.
 *
 */
...
require.register("powerange/lib/vertical.html", function(exports, require, module){
/**
 * External dependencies.
 *
 */
...
require.alias("component-events/index.html", "powerange/deps/events/index.html");
require.alias("component-events/index.html", "events/index.html");
require.alias("component-event/index.html", "component-events/deps/event/index.html");

require.alias("component-delegate/index.html", "component-events/deps/delegate/index.html");
require.alias("discore-closest/index.html", "component-delegate/deps/closest/index.html");
require.alias("discore-closest/index.html", "component-delegate/deps/closest/index.html");
require.alias("component-matches-selector/index.html", "discore-closest/deps/matches-selector/index.html");
require.alias("component-query/index.html", "component-matches-selector/deps/query/index.html");

require.alias("discore-closest/index.html", "discore-closest/index.html");
require.alias("component-event/index.html", "component-delegate/deps/event/index.html");

require.alias("component-classes/index.html", "powerange/deps/classes/index.html");
require.alias("component-classes/index.html", "classes/index.html");
require.alias("component-indexof/index.html", "component-classes/deps/indexof/index.html");

require.alias("ui-component-mouse/index.html", "powerange/deps/mouse/index.html");
require.alias("ui-component-mouse/index.html", "mouse/index.html");
require.alias("component-emitter/index.html", "ui-component-mouse/deps/emitter/index.html");

require.alias("component-event/index.html", "ui-component-mouse/deps/event/index.html");

require.alias("abpetkov-percentage-calc/percentage-calc.html", "powerange/deps/percentage-calc/percentage-calc.html");
require.alias("abpetkov-percentage-calc/percentage-calc.html", "powerange/deps/percentage-calc/index.html");
require.alias("abpetkov-percentage-calc/percentage-calc.html", "percentage-calc/index.html");
require.alias("abpetkov-percentage-calc/percentage-calc.html", "abpetkov-percentage-calc/index.html");
require.alias("abpetkov-closest-num/closest-num.html", "powerange/deps/closest-num/closest-num.html");
require.alias("abpetkov-closest-num/closest-num.html", "powerange/deps/closest-num/index.html");
require.alias("abpetkov-closest-num/closest-num.html", "closest-num/index.html");
require.alias("abpetkov-closest-num/closest-num.html", "abpetkov-closest-num/index.html");
require.alias("vesln-super/lib/super.html", "powerange/deps/super/lib/super.html");
require.alias("vesln-super/lib/super.html", "powerange/deps/super/index.html");
require.alias("vesln-super/lib/super.html", "super/index.html");
require.alias("vesln-super/lib/super.html", "vesln-super/index.html");
require.alias("powerange/lib/powerange.html", "powerange/index.html");if (typeof exports == "object") {
