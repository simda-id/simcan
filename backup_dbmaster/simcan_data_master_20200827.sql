...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_bidang
DROP TABLE IF EXISTS `90_ref_bidang`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_fungsi
DROP TABLE IF EXISTS `90_ref_fungsi`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_kegiatan
DROP TABLE IF EXISTS `90_ref_kegiatan`;
CREATE TABLE IF NOT EXISTS `90_ref_kegiatan` (
  ...
  UNIQUE KEY `idx_ref_program` (`id_program`,`kd_kegiatan`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=880 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;

-- Data exporting was unselected.

-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_program
DROP TABLE IF EXISTS `90_ref_program`;
...
) ENGINE=InnoDB AUTO_INCREMENT=371 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;

-- Data exporting was unselected.

-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_program_nasional
DROP TABLE IF EXISTS `90_ref_program_nasional`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_pronas_mapping
DROP TABLE IF EXISTS `90_ref_pronas_mapping`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_rekening_mapping
DROP TABLE IF EXISTS `90_ref_rekening_mapping`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_rek_1
DROP TABLE IF EXISTS `90_ref_rek_1`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_rek_2
DROP TABLE IF EXISTS `90_ref_rek_2`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_rek_3
DROP TABLE IF EXISTS `90_ref_rek_3`;
CREATE TABLE IF NOT EXISTS `90_ref_rek_3` (
  ...
  UNIQUE KEY `kd_rek_1` (`id_rek_2`,`kd_rek_3`) USING BTREE,
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_rek_4
DROP TABLE IF EXISTS `90_ref_rek_4`;
CREATE TABLE IF NOT EXISTS `90_ref_rek_4` (
  ...
  UNIQUE KEY `kd_rek_1` (`id_rek_3`,`kd_rek_4`) USING BTREE,
  CONSTRAINT `90_ref_rek_4_ibfk_1` FOREIGN KEY (`id_rek_3`) REFERENCES `90_ref_rek_3` (`id_rek_3`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=503 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;

-- Data exporting was unselected.

-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_rek_5
DROP TABLE IF EXISTS `90_ref_rek_5`;
CREATE TABLE IF NOT EXISTS `90_ref_rek_5` (
  ...
  UNIQUE KEY `kd_rek_1` (`id_rek_4`,`kd_rek_5`) USING BTREE,
  CONSTRAINT `90_ref_rek_5_ibfk_1` FOREIGN KEY (`id_rek_4`) REFERENCES `90_ref_rek_4` (`id_rek_4`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=1827 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;

-- Data exporting was unselected.

-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_rek_6
DROP TABLE IF EXISTS `90_ref_rek_6`;
CREATE TABLE IF NOT EXISTS `90_ref_rek_6` (
  ...
  UNIQUE KEY `kd_rek_1` (`id_rek_5`,`kd_rek_6`) USING BTREE,
  CONSTRAINT `90_ref_rek_6_ibfk_1` FOREIGN KEY (`id_rek_5`) REFERENCES `90_ref_rek_5` (`id_rek_5`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=10655 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;

-- Data exporting was unselected.

-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_sd_1
DROP TABLE IF EXISTS `90_ref_sd_1`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_sd_2
DROP TABLE IF EXISTS `90_ref_sd_2`;
CREATE TABLE IF NOT EXISTS `90_ref_sd_2` (
  ...
  UNIQUE KEY `id_sd_1` (`id_sd_1`,`kd_sd_2`),
  CONSTRAINT `90_ref_sd_2_ibfk_1` FOREIGN KEY (`id_sd_1`) REFERENCES `90_ref_sd_1` (`id_sd_1`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Data exporting was unselected.

-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_sd_3
DROP TABLE IF EXISTS `90_ref_sd_3`;
CREATE TABLE IF NOT EXISTS `90_ref_sd_3` (
  ...
  UNIQUE KEY `id_sd_2` (`id_sd_2`,`kd_sd_3`) USING BTREE,
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_sd_4
DROP TABLE IF EXISTS `90_ref_sd_4`;
CREATE TABLE IF NOT EXISTS `90_ref_sd_4` (
  ...
  UNIQUE KEY `id_sd_3` (`id_sd_3`,`kd_sd_4`) USING BTREE,
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_sd_5
DROP TABLE IF EXISTS `90_ref_sd_5`;
CREATE TABLE IF NOT EXISTS `90_ref_sd_5` (
  ...
  UNIQUE KEY `id_sd_4` (`id_sd_4`,`kd_sd_5`) USING BTREE,
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_sd_6
DROP TABLE IF EXISTS `90_ref_sd_6`;
CREATE TABLE IF NOT EXISTS `90_ref_sd_6` (
  ...
  UNIQUE KEY `id_sd_5` (`id_sd_5`,`kd_sd_6`) USING BTREE,
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_sd_mapping
DROP TABLE IF EXISTS `90_ref_sd_mapping`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_spm_bidang
DROP TABLE IF EXISTS `90_ref_spm_bidang`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_spm_jenis
DROP TABLE IF EXISTS `90_ref_spm_jenis`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_spm_mapping
DROP TABLE IF EXISTS `90_ref_spm_mapping`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_sub_kegiatan
DROP TABLE IF EXISTS `90_ref_sub_kegiatan`;
CREATE TABLE IF NOT EXISTS `90_ref_sub_kegiatan` (
  ...
  UNIQUE KEY `idx_ref_program` (`id_kegiatan`,`kd_sub_kegiatan`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=4092 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;

-- Data exporting was unselected.

-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_sub_kegiatan_mapping
DROP TABLE IF EXISTS `90_ref_sub_kegiatan_mapping`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_sub_unit
DROP TABLE IF EXISTS `90_ref_sub_unit`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_sub_unit_mapping
DROP TABLE IF EXISTS `90_ref_sub_unit_mapping`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_unit
DROP TABLE IF EXISTS `90_ref_unit`;
CREATE TABLE IF NOT EXISTS `90_ref_unit` (
  ...
  KEY `idx_ref_unit` (`id_bidang`,`id_bidang2`,`id_bidang3`,`kd_unit`,`status_data`,`jns_pemda`) USING BTREE,
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_ref_urusan
DROP TABLE IF EXISTS `90_ref_urusan`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_aktivitas_pd
DROP TABLE IF EXISTS `90_trx_anggaran_aktivitas_pd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_belanja_pd
DROP TABLE IF EXISTS `90_trx_anggaran_belanja_pd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_dokumen
DROP TABLE IF EXISTS `90_trx_anggaran_dokumen`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_indikator
DROP TABLE IF EXISTS `90_trx_anggaran_indikator`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_kegiatan_pd
DROP TABLE IF EXISTS `90_trx_anggaran_kegiatan_pd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_keg_indikator_pd
DROP TABLE IF EXISTS `90_trx_anggaran_keg_indikator_pd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_lokasi_pd
DROP TABLE IF EXISTS `90_trx_anggaran_lokasi_pd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_pelaksana
DROP TABLE IF EXISTS `90_trx_anggaran_pelaksana`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_pelaksana_pd
DROP TABLE IF EXISTS `90_trx_anggaran_pelaksana_pd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_program
DROP TABLE IF EXISTS `90_trx_anggaran_program`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_program_pd
DROP TABLE IF EXISTS `90_trx_anggaran_program_pd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_prog_indikator_pd
DROP TABLE IF EXISTS `90_trx_anggaran_prog_indikator_pd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_subkegiatan_pd
DROP TABLE IF EXISTS `90_trx_anggaran_subkegiatan_pd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_subkeg_indikator_pd
DROP TABLE IF EXISTS `90_trx_anggaran_subkeg_indikator_pd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_tapd
DROP TABLE IF EXISTS `90_trx_anggaran_tapd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_tapd_unit
DROP TABLE IF EXISTS `90_trx_anggaran_tapd_unit`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_unit_kpa
DROP TABLE IF EXISTS `90_trx_anggaran_unit_kpa`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_unit_pa
DROP TABLE IF EXISTS `90_trx_anggaran_unit_pa`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.90_trx_anggaran_urusan
DROP TABLE IF EXISTS `90_trx_anggaran_urusan`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.ta_belanja_item
...
-- Dumping structure for table dbsimcan_simulasi_merah.trx_realisasi_keu
...
-- Dumping structure for table dbsimcan_simulasi_merah.trx_rkpd_ubah_aktivitas_pd
DROP TABLE IF EXISTS `trx_rkpd_ubah_aktivitas_pd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.trx_rkpd_ubah_belanja_pd
DROP TABLE IF EXISTS `trx_rkpd_ubah_belanja_pd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.trx_rkpd_ubah_dokumen
DROP TABLE IF EXISTS `trx_rkpd_ubah_dokumen`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.trx_rkpd_ubah_indikator
DROP TABLE IF EXISTS `trx_rkpd_ubah_indikator`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.trx_rkpd_ubah_kegiatan_pd
DROP TABLE IF EXISTS `trx_rkpd_ubah_kegiatan_pd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.trx_rkpd_ubah_keg_indikator_pd
DROP TABLE IF EXISTS `trx_rkpd_ubah_keg_indikator_pd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.trx_rkpd_ubah_lokasi_pd
DROP TABLE IF EXISTS `trx_rkpd_ubah_lokasi_pd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.trx_rkpd_ubah_pelaksana
DROP TABLE IF EXISTS `trx_rkpd_ubah_pelaksana`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.trx_rkpd_ubah_pelaksana_pd
DROP TABLE IF EXISTS `trx_rkpd_ubah_pelaksana_pd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.trx_rkpd_ubah_program
DROP TABLE IF EXISTS `trx_rkpd_ubah_program`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.trx_rkpd_ubah_program_pd
DROP TABLE IF EXISTS `trx_rkpd_ubah_program_pd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.trx_rkpd_ubah_prog_indikator_pd
DROP TABLE IF EXISTS `trx_rkpd_ubah_prog_indikator_pd`;
...
-- Dumping structure for table dbsimcan_simulasi_merah.trx_rkpd_ubah_urusan
DROP TABLE IF EXISTS `trx_rkpd_ubah_urusan`;
...
-- Dumping structure for view dbsimcan_simulasi_merah.13_vref_kegiatan
DROP VIEW IF EXISTS `13_vref_kegiatan`;
...
CREATE TABLE `13_vref_kegiatan` (
	...
	`kode_program` VARCHAR(18) NOT NULL COLLATE 'utf8mb4_general_ci',
	`id_kegiatan` INT(11) NOT NULL,
	`kd_kegiatan` INT(11) NOT NULL,
	`uraian_kegiatan` VARCHAR(255) NULL COLLATE 'utf8mb4_unicode_ci',
	`kode_kegiatan` VARCHAR(23) NOT NULL COLLATE 'utf8mb4_general_ci'
) ENGINE=MyISAM;

-- Dumping structure for view dbsimcan_simulasi_merah.13_vref_rekening
DROP VIEW IF EXISTS `13_vref_rekening`;
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view dbsimcan_simulasi_merah.13_vref_sub_unit
DROP VIEW IF EXISTS `13_vref_sub_unit`;
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view dbsimcan_simulasi_merah.13_vref_unit
DROP VIEW IF EXISTS `13_vref_unit`;
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view dbsimcan_simulasi_merah.90_vref_bidang
DROP VIEW IF EXISTS `90_vref_bidang`;
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view dbsimcan_simulasi_merah.90_vref_rekening
DROP VIEW IF EXISTS `90_vref_rekening`;
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view dbsimcan_simulasi_merah.90_vref_sub_kegiatan
DROP VIEW IF EXISTS `90_vref_sub_kegiatan`;
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view dbsimcan_simulasi_merah.90_vref_sub_unit
DROP VIEW IF EXISTS `90_vref_sub_unit`;
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view dbsimcan_simulasi_merah.90_vref_sumberdana
DROP VIEW IF EXISTS `90_vref_sumberdana`;
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view dbsimcan_simulasi_merah.90_vref_unit
DROP VIEW IF EXISTS `90_vref_unit`;
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view dbsimcan_simulasi_merah.v_anggaran_belanja
DROP VIEW IF EXISTS `v_anggaran_belanja`;
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view dbsimcan_simulasi_merah.v_rkpd_ubah_belanja
DROP VIEW IF EXISTS `v_rkpd_ubah_belanja`;
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for procedure dbsimcan_simulasi_merah.SP_anggaran_belanja
DROP PROCEDURE IF EXISTS `SP_anggaran_belanja`;
DELIMITER //
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `13_vref_kegiatan` AS select `a`.`kd_urusan` AS `kd_urusan`,`a`.`kode_urusan` AS `kode_urusan`,`a`.`nm_urusan` AS `nm_urusan`,`b`.`id_bidang` AS `id_bidang`,`b`.`kd_bidang` AS `kd_bidang`,`b`.`nm_bidang` AS `nm_bidang`,concat(`a`.`kd_urusan`,'.',right(concat('0',`b`.`kd_bidang`),2)) AS `kode_bidang`,`c`.`id_program` AS `id_program`,`c`.`kd_program` AS `kd_program`,`c`.`uraian_program` AS `uraian_program`,concat(`a`.`kd_urusan`,'.',right(concat('0',`b`.`kd_bidang`),2),'-',right(concat('00',`c`.`kd_program`),3)) AS `kode_program`,`d`.`id_kegiatan` AS `id_kegiatan`,`d`.`kd_kegiatan` AS `kd_kegiatan`,`d`.`nm_kegiatan` AS `uraian_kegiatan`,concat(`a`.`kd_urusan`,'.',right(concat('0',`b`.`kd_bidang`),2),'-',right(concat('00',`c`.`kd_program`),3),'.',right(concat('0000',`d`.`kd_kegiatan`),4)) AS `kode_kegiatan` from (((`ref_urusan` `a` join `ref_bidang` `b` on((`a`.`kd_urusan` = `b`.`kd_urusan`))) join `ref_program` `c` on((`b`.`id_bidang` = `c`.`id_bidang`))) join `ref_kegiatan` `d` on((`c`.`id_program` = `d`.`id_program`)));
