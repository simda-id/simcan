...
--
-- Host: localhost
-- Generation Time: Nov 18, 2019 at 04:13 AM
...
INSERT INTO `ref_fungsi` (`kd_fungsi`, `kode_fungsi`, `nm_fungsi`, `status_data`, `created_at`, `updated_at`) VALUES
(1, 1, 'Pelayanan Umum', 0, '2019-10-30 06:28:11', '2019-10-30 06:31:35'),
(2, 2, 'Pertahanan', 0, '2019-10-30 06:28:11', '2019-10-30 06:31:35'),
(3, 3, 'Ketertiban dan Keamanan', 0, '2019-10-30 06:28:11', '2019-10-30 06:31:35'),
(4, 4, 'Ekonomi', 0, '2019-10-30 06:28:11', '2019-10-30 06:31:35'),
(5, 5, 'Lingkungan Hidup', 0, '2019-10-30 06:28:11', '2019-10-30 06:31:35'),
(6, 6, 'Perumahan dan Fasilitas Umum', 0, '2019-10-30 06:28:11', '2019-10-30 06:31:35'),
(7, 7, 'Kesehatan', 0, '2019-10-30 06:28:11', '2019-10-30 06:31:35'),
(8, 8, 'Pariwisata dan Budaya', 0, '2019-10-30 06:28:11', '2019-10-30 06:31:35'),
(9, 9, 'Agama', 0, '2019-10-30 06:28:11', '2019-10-30 06:31:35'),
(10, 10, 'Pendidikan', 0, '2019-10-30 06:28:11', '2019-10-30 06:31:35'),
(11, 11, 'Perlindungan Sosial', 0, '2019-10-30 06:28:11', '2019-10-30 06:31:35');
...
(1, 1, 1, 1, 1, 'Kas di Kas Daerah', NULL, 1),
...
) ENGINE=InnoDB AUTO_INCREMENT=1598 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=494 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;
...
INSERT INTO `ref_urusan` (`kd_urusan`, `kode_urusan`, `nm_urusan`, `status_data`, `created_at`, `updated_at`) VALUES
(1, 0, 'Urusan Wajib Pelayanan Dasar', 0, '2019-10-30 06:33:57', '2019-10-30 06:34:11'),
(2, 0, 'Urusan Wajib Bukan Pelayanan Dasar', 0, '2019-10-30 06:33:57', '2019-10-30 06:34:11'),
(3, 0, 'Urusan Pilihan', 0, '2019-10-30 06:33:57', '2019-10-30 06:34:11'),
(4, 0, 'Urusan Pemerintahan Fungsi Penunjang', 0, '2019-10-30 06:33:57', '2019-10-30 06:34:11');
...
--
-- Table structure for table `trx_log_api_keu`
--
...
CREATE TABLE IF NOT EXISTS `trx_log_api_keu` (
  ...
  `tgl_kirim` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `status_kirim` int(11) NOT NULL,
  `log_kirim` varchar(500) CHARACTER SET latin1 DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_log`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `trx_program_nasional_urusan`
--
...
--
-- Table structure for table `trx_program_provinsi_urusan`
--
...
(1, 2, 'administrator', 'admin@bpkp.go.id', NULL, '$2y$10$jR4xkjKFcnS9RSwkKz0odef0Qu7wsqb4YYnx16ElnCC72eXcLvRYy', '7Bouscaw8qoo3E9aYCe9Uu3qKJDVsTlNKTLOvwFtsW8tpWNvaOJRv14anl8q', 1, 0, '0000-00-00 00:00:00', '2019-10-01 11:04:44', '2017-04-06 23:30:42', '2019-11-14 20:07:19'),
(2, 1, 'superAdmin@simcan.dev', 'super@simcan.dev', NULL, '$2y$10$tZIfh.n2Fw9bO.0dMvA/nOr6oNA7gdmg8aU9gHylOS79z2RfCc10W', 'wAp9MGZKgnlBBcbHFYTzlyzQqbViGDVZ9mdDoLn3S4RUKJiGpVfSVYCXq5qa', 1, 0, '0000-00-00 00:00:00', '2019-10-01 11:04:44', '2017-10-08 18:02:03', '2019-11-12 11:07:34');
...
ALTER TABLE `ref_bidang`
  ADD CONSTRAINT `ref_bidang_ibfk_1` FOREIGN KEY (`kd_fungsi`) REFERENCES `ref_fungsi` (`kd_fungsi`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ref_bidang_ibfk_2` FOREIGN KEY (`kd_urusan`) REFERENCES `ref_urusan` (`kd_urusan`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `trx_program_provinsi_urusan`
--
ALTER TABLE `trx_program_provinsi_urusan`
  ADD CONSTRAINT `trx_program_provinsi_urusan_ibfk_1` FOREIGN KEY (`id_progprov`) REFERENCES `trx_program_provinsi` (`id_progprov`) ON DELETE CASCADE ON UPDATE CASCADE;
