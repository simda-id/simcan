...
-- Dumping structure for table dbsimcan_simulasi_merah.trx_anggaran_subkegiatan_pd
DROP TABLE IF EXISTS `trx_anggaran_subkegiatan_pd`;
CREATE TABLE IF NOT EXISTS `trx_anggaran_subkegiatan_pd` (
  `id_kegiatan_pd` bigint(20) NOT NULL AUTO_INCREMENT,
  `id_program_pd` bigint(20) NOT NULL,
  `id_keg_old` bigint(20) NOT NULL DEFAULT '0',
  `id_kegiatan_pd_rkpd_final` int(11) DEFAULT NULL,
  ...
  UNIQUE KEY `id_unit_id_renja_id_kegiatan_ref` (`id_unit`,`id_kegiatan_ref`,`id_program_pd`,`tahun_anggaran`,`id_kegiatan_pd_rkpd_final`,`id_perubahan`) USING BTREE,
  KEY `FK_trx_forum_skpd_trx_forum_skpd_program` (`id_program_pd`) USING BTREE,
  CONSTRAINT `trx_anggaran_subkegiatan_pd_ibfk_1` FOREIGN KEY (`id_program_pd`) REFERENCES `trx_anggaran_program_pd` (`id_program_pd`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=2395 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `trx_rkpd_ubah_kegiatan_pd` (
  ...
  `updated_by` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_kegiatan_pd`) USING BTREE,
  UNIQUE KEY `id_unit_id_renja_id_kegiatan_ref` (`id_unit`,`id_kegiatan_ref`,`id_program_pd`,`tahun_rkpd`,`status_pelaksanaan`) USING BTREE,
  KEY `FK_trx_forum_skpd_trx_forum_skpd_program` (`id_program_pd`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `trx_rkpd_ubah_keg_indikator_pd` (
  ...
  `updated_by` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_indikator_kegiatan_pd`) USING BTREE,
  UNIQUE KEY `idx_trx_renja_rancangan_indikator` (`tahun_rkpd`,`status_pelaksanaan`,`kd_indikator`,`id_perubahan`,`id_kegiatan_pd`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `trx_rkpd_ubah_lokasi_pd` (
  ...
  `updated_by` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_lokasi_pd`) USING BTREE,
  UNIQUE KEY `id_trx_forum_lokasi` (`id_aktivitas_pd`,`tahun_rkpd`,`id_lokasi`,`status_pelaksanaan`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `trx_rkpd_ubah_pelaksana` (
  ...
  `updated_by` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_pelaksana_rkpd`) USING BTREE,
  UNIQUE KEY `idx_trx_rkpd_program_pelaksana` (`tahun_rkpd`,`id_rkpd_program`,`id_unit`,`id_urusan_rkpd`) USING BTREE,
  KEY `fk_trx_rkpd_ranwal_pelaksana_1` (`id_urusan_rkpd`) USING BTREE,
  KEY `fk_trx_rkpd_ranwal_pelaksana_2` (`id_unit`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `trx_rkpd_ubah_pelaksana_pd` (
  ...
  `updated_by` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_pelaksana_pd`) USING BTREE,
  UNIQUE KEY `id_trx_forum_pelaksana` (`id_kegiatan_pd`,`tahun_rkpd`,`status_pelaksanaan`,`id_sub_unit`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=105 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `trx_rkpd_ubah_program` (
  ...
  KEY `FK_trx_rkpd_ubah_program_trx_rkpd_ubah_dokumen` (`id_dokumen`),
...
CREATE TABLE IF NOT EXISTS `trx_rkpd_ubah_program_pd` (
  ...
  `updated_by` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_program_pd`) USING BTREE,
  UNIQUE KEY `id_unit_id_renja_program_id_program_ref` (`id_unit`,`id_pelaksana_rkpd`,`id_program_ref`,`tahun_rkpd`,`jenis_belanja`,`status_pelaksanaan`) USING BTREE,
  KEY `FK_trx_forum_skpd_program_trx_forum_skpd_program_ranwal` (`id_pelaksana_rkpd`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=103 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `trx_rkpd_ubah_prog_indikator_pd` (
  ...
  `updated_by` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_indikator_program_pd`) USING BTREE,
  UNIQUE KEY `idx_trx_renja_rancangan_indikator` (`tahun_rkpd`,`status_pelaksanaan`,`kd_indikator`,`id_perubahan`,`id_program_pd`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=98 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `trx_rkpd_ubah_urusan` (
  ...
  `updated_by` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_urusan_rkpd`) USING BTREE,
  UNIQUE KEY `idx_trx_rkpd_program_pelaksana` (`tahun_rkpd`,`id_rkpd_program`,`id_bidang`) USING BTREE,
  KEY `fk_trx_rkpd_ranwal_pelaksana` (`id_rkpd_program`) USING BTREE,
  KEY `fk_trx_rkpd_ranwal_pelaksana_1` (`id_bidang`) USING BTREE,
