...
class TrxRenstraProgram extends Model
{
    ...
    protected $fillable = ['thn_id','no_urut','id_sasaran_renstra','id_program_renstra','id_program_rpjmd','id_program_ref','id_perubahan','uraian_program_renstra','pagu_tahun1',
        'pagu_tahun2',
        'pagu_tahun3',
        'pagu_tahun4',
        'pagu_tahun5',
