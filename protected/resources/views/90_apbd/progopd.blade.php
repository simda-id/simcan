...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
      <?php
                $this->title = 'Data Program Renja - APBD';
    ...
    <div class="col-md-12">
      <div class="panel panel-info">
        <div class="panel-heading">
          <p>
            <h2 id="judul" class="panel-title"> Data Program Renja Perangkat Daerah - APBD'90</h2>
          </p>
        </div>
                  ...
                  <form class="form-horizontal" role="form" autocomplete='off' action="" method="">
                    <div class="table-responsive">
                      <table class="table table-striped table-bordered">
                        <tbody>
                          <tr>
                            <td width="20%" style="text-align: left; vertical-align:top;">Program Pemda - APBD</td>
                ...
                <table id="tblSubKegiatanRenja" class="table table-striped table-bordered table-responsive compact"
                  ...
                  <thead>
                    <tr>
                      ...
                      <th rowspan="2" width='5%' style="text-align: center; vertical-align:middle">Aksi</th>
                      <th rowspan="2" width='5%' style="text-align: center; vertical-align:middle">No Urut</th>
                      <th rowspan="2" style="text-align: center; vertical-align:middle">Nama Sub Kegiatan Perangkat
                        Daerah
                      </th>
                      <th colspan="2" width='20%' style="text-align: center; vertical-align:middle">Pagu Sub Kegiatan
                      </th>
                      <th rowspan="2" width='5%' style="text-align: center; vertical-align:middle">Status</th>
                    </tr>
                    <tr>
...
@include('90_apbd.program_pd')
@include('90_apbd.program_indikator_pd')
@include('90_apbd.kegiatan_pd')
@include('90_apbd.kegiatan_indikator_pd')
@include('90_apbd.subkegiatan_pd')
@include('90_apbd.subkegiatan_indikator_pd')
@include('90_apbd.pelaksana_pd')
@include('90_apbd.aktivitas_pd')
@include('90_apbd.lokasi_pd')
@include('90_apbd.belanja_pd')

@include('90_apbd.cariProgramRenstra')
@include('90_apbd.cariKegiatanRenstra')
@include('90_apbd.cariProgramRef')
@include('90_apbd.cariKegiatanRef')
@include('90_apbd.cariSubKegiatanRef')
@include('90_apbd.cariIndikator')
@include('90_apbd.cariSubUnit')
@include('90_apbd.cariAktivitasASB')
@include('90_apbd.cariLokasiModal')
@include('90_apbd.cariLokasiTeknisModal')
@include('90_apbd.cariItemSSH')
@include('90_apbd.cariRekening')
@include('90_apbd.aktivitasMove')
@include('90_apbd.ModalCopyBelanja')
@include('90_apbd.loadBelanjaASB')

@endsection

@section('scripts')
<script src="{{ asset('/protected/resources/views/90_apbd/js/js_penyesuaian_pd.js')}}"></script>
@endsection