...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <?php
        $this->title = 'Kode Sumber Dana Pmd-90';
        ...
        <div class="col-md-12">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h2 class="panel-title">Referensi Kode Sumber Dana sesuai Permendagri 90</h2>
                </div>
                <div class="panel-body"><br>
                    <div class='tabs-x tabs-above tab-bordered tabs-krajee'>
                        <ul class="nav nav-tabs nav-justified" role="tablist">
                            <li class="active"><a href="#tabrek12" aria-controls="tabrek12" role="tab"
                                    data-toggle="tab">Sumber Dana - Kelompok</a>
                            </li>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="10%" style="text-align: center; vertical-align:middle">Kode
                                                    Sumber Dana</th>
                                                <th style="text-align: center; vertical-align:middle">Nama Sumber Dana
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                ...
                                <form class="form-horizontal" role="form" autocomplete='off' action="" method="">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-responsive compact">
                                            <tbody>
                                                <tr class="backBidang">
                                                    <td width="20%" style="text-align: left; vertical-align:top;">Sumber
                                                        Dana
                                                    </td>
                                    ...
                                    <thead>
                                        <tr>
                                            <th width='15%' style="text-align: center; vertical-align:middle">Kode
                                                Jenis</th>
                                            <th style="text-align: center; vertical-align:middle">Nama Jenis Sumber Dana
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                ...
                                <table id="tblObyek" class="table table-striped table-bordered table-responsive compact"
                                    ...
                                    <thead>
                                        <tr>
                                            <th width='15%' style="text-align: center; vertical-align:middle">Kode
                                                Obyek</th>
                                            <th style="text-align: center; vertical-align:middle">Nama Obyek Sumber Dana
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
    ...
    <script id="details-golongan" type="text/x-handlebars-template">
        <table class="table table-striped table-bordered table-responsive compact details-table" id="golongan-@{{id_sd_1}}">
        <thead>
            <tr>
                <th width="10%" style="text-align: center; vertical-align:middle;">Kode Kelompok</th>
                <th style="text-align: center; vertical-align:middle;">Uraian Kelompok Sumber Dana</th>
            </tr>
        </thead>
        <tbody></tbody>
        </table>
    ...
    <script type="text/javascript" language="javascript" class="init"
        src="{{ asset('/protected/resources/views/90_parameter/js_sumberdana.js')}}">
    </script>
    @endsection