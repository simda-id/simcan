...
@include("90_ppas.program_rkpd");
@include("90_ppas.indikator_program_rkpd");
@include("90_ppas.urusan_program_rkpd");
@include("90_ppas.pelaksana_program_rkpd");
@include("90_ppas.cariIndikator");
@include("90_ppas.cariProgramRPJMD");
@include("90_ppas.cariRefUnit");
@include("90_ppas.StatusProgram");

@endsection

@section("scripts")
<script src="{{ asset('/protected/resources/views/90_ppas/js/js_rkpd.js')}}"></script>
@endsection