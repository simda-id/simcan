          ...
          <div class="panel-body">
                {{-- <div class='tabs-x tabs-above tab-bordered tabs-krajee'>                     --}}
                  ...
                  <ul class="nav nav-tabs" role="tablist">
                      ...
                      <li class="disabled"><a href="#rekap" aria-controls="rekap" role="tab-kv" data-toggle="tab">Rekapitulasi APBD</a></li>
                      <li class="disabled"><a href="#tapd" aria-controls="tapd" role="tab-kv" data-toggle="tab">Daftar TAPD</a></li>
                      <li class="disabled"><a href="#tapd_unit" aria-controls="tapd_unit" role="tab-kv" data-toggle="tab">Unit TAPD</a></li>
                  </ul>
                  <div class="tab-content">
                      ...
                      <div role="tabpanel" class="tab-pane fade in" id="tapd">
                        <br>                        
                        <button type="button" class="btn btn-success btn-labeled btnTambahTim" id='btnTambahTim' data-dismiss="modal" aria-hidden="true">
                          <span class="btn-label"><i class="fa fa-plus fa-fw fa-lg"></i></span>Tambah TAPD</button>
                        <table id="tblTAPD" class="table table-striped table-bordered table-responsive"  cellspacing="0" width="100%">
                            <thead>
                              <tr>
                      ...
                      <div role="tabpanel" class="tab-pane fade in" id="tapd_unit">
                          ...
                          <div class="form-group">
                            <a id="btnBackTapd" class="btn btn-warning" title="Kembali ke Daftar Anggota TAPD"><i class="fa fa-arrow-left fa-fw fa-lg"></i></a>
                            <label for="nip_tapd" class="col-sm-3 control-label" align='left'>Organisasi Perangkat Daerah :</label>
                            <div class="col-sm-6">
                              <select type="text" class="select2 form-control id_unit_ref col-sm-12" id="id_unit_ref" name="id_unit_ref"></select>
                            </div>
                            <input type="hidden" class="form-control" id="id_tapd_unit" name="id_tapd_unit">
                            <button type="button" id="btnTambahUnit" class="btn btn-success btn-labeled btnTambahUnit" data-dismiss="modal" aria-hidden="true">
                                <span class="btn-label"><i class="fa fa-plus fa-fw fa-lg"></i></span>Tambah Unit</button>                            
                          </div>                         
                          <table id="tblUnitTAPD" class="table table-striped table-bordered table-responsive"  cellspacing="0" width="100%">
                            <thead>
                              <tr>
                                  <th width="5%" style="text-align: center; vertical-align:middle">No</th>
...
<div id="TambahTapd" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" >
  <div class="modal-dialog modal-lg"  >
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"></h4>
      ...
      <div class="modal-body">
        <form class="form-horizontal" autocomplete='off' action="" method="post" onsubmit="return false;">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control nip" id="nip_tapd_display" name="nip_tapd_display" maxlength="18" style="text-align: center;" disabled>
            </div>
              ...
              <span class="btn btn-sm btn-primary btnPegawai" id="btnPegawai" name="btnPegawai"><i class="fa fa-search fa-fw fa-lg"></i></span>
          </div> 
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <textarea type="text" class="form-control" id="jabatan_tapd" name="jabatan_tapd" required="required" rows="3" disabled></textarea> 
            </div> 
          </div>      
          <div class="form-group">
            <label for="peran_tapd" class="col-sm-3 control-label" align='left'>Peran dalam TAPD :</label>
            <div class="col-sm-9">
              <textarea type="text" class="form-control" id="peran_tapd" name="peran_tapd" rows="3" required="required"></textarea>
            </div> 
          </div> 
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <div id="radioBtn" class="btn-group">
                <a class="btn btn-primary btn-sm active" id="flag_tim_rinci_1" data-toggle="flag_tim_rinci" data-title="1">Aktif</a>
                <a class="btn btn-primary btn-sm notActive" id="flag_tim_rinci_0" data-toggle="flag_tim_rinci" data-title="0">Non Aktif</a>
              </div>
    ...
    <div class="modal-dialog modal-xs">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="alert alert-danger">
              <i class="fa fa-exclamation-triangle fa-3x fa-pull-left fa-border text-danger" aria-hidden="true"></i>
                Yakin akan menghapus Keanggotaan : <strong><span class="nama_pegawai_del"></span></strong>  dari <strong>Tim Anggaran Pemerintah Daerah tahun {{Session::get('tahun')}}</strong>?
                <br>
          </div>
        </div>
          <div class="modal-footer">
            <div class="ui-group-buttons">
            <button type="button" id="btnDelTimTapd" class="btn btn-labeled btn-danger" data-dismiss="modal" ><span class="btn-label"><i class="fa fa-trash-o fa-lg fa-fw"></i></span> Hapus</button>
            <div class="or"></div>
            <button type="button" class="btn btn-labeled btn-warning" data-dismiss="modal" aria-hidden="true"><span class="btn-label"><i class="fa fa-sign-out fa-lg fa-fw"></i></span> Tutup</button>
            </div>
          </div>
...
@section('scripts')
  <script type="text/javascript" language="javascript" class="init" src="{{ asset('/protected/resources/views/apbd/js/js_doku.js')}}"></script>
@endsection
