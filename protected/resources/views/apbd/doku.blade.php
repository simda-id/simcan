...
<div class="container-fluid">
    ...
    <div class="col-md-12">
      <div class="panel panel-info">
        <div class="panel-heading">
          <p>
            <h2 class="panel-title">Dokumen Anggaran Pendapatan dan Belanja Daerah (APBD)</h2>
          </p>
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="alert alert-danger">
            ...
            Yakin akan menghapus Dokumen Anggaran Pendapatan dan Belanja Daerah (APBD) dengan nomor dokumen:
  ...
  <script type="text/javascript" language="javascript" class="init"
    src="{{ asset('/protected/resources/views/apbd/js/js_doku.js')}}"></script>
  @endsection