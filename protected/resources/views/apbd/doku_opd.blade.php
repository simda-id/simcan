      ...
      <div class="col-md-12">
        <div class="panel panel-info">
          <div class="panel-heading">
            <p><h2 class="panel-title">Dokumen Rencana Kerja dan Anggaran (RKA)</h2></p>
          </div>

          <div class="panel-body"><form name="" class="form-horizontal" role="form" autocomplete='off' action="" method="post">
                ...
                <div class="form-group">
                  ...
                  <ul class="nav nav-tabs" role="tablist">
                      <li class="active"><a href="#dokumen" aria-controls="dokumen" role="tab" data-toggle="tab">Dokumen RKA SKPD</a></li>
                      <li class="disabled"><a href="#kpa_unit" aria-controls="kpa_unit" role="tab-kv" data-toggle="tab">Daftar Pejabat KPA</a></li>
                  </ul>
                  <div class="tab-content">
                      ...
                      <div role="tabpanel" class="tab-pane fade in" id="kpa_unit">
                        <br>                        
                        <button type="button" class="btn btn-success btn-labeled btnTambahKpa" id='btnTambahKpa' data-dismiss="modal" aria-hidden="true">
                          <span class="btn-label"><i class="fa fa-plus fa-fw fa-lg"></i></span>Tambah KPA</button>
                        <table id="tblKPA" class="table table-striped table-bordered table-responsive"  cellspacing="0" width="100%">
                            <thead>
                              <tr>
        ...
        <form class="form-horizontal" autocomplete='off' action="" method="post" onsubmit="return false;">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              ...
              <button id="btnPegawai" type="button" class="btn btn-primary"><i class="fa fa-search fa-fw fa-lg"></i></button>
          </div> 
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <textarea type="text" class="form-control" id="jabatan_tapd" name="jabatan_tapd" required="required" rows="2" disabled></textarea> 
            </div> 
          </div>     
        </form>
      </div>
        ...
        <div class="modal-body">
            ...
            <div class="alert alert-danger">
              <i class="fa fa-exclamation-triangle fa-3x fa-pull-left fa-border text-danger" aria-hidden="true"></i>
                Yakin akan menghapus Dokumen Rencana Kerja dan Anggaran (RKA) dengan nomor dokumen: <strong><span class="ur_dokumen_del"></span></strong>  ?
                <br>
                <br>
                <strong>Catatan : Penghapusan dokumen ini akan menghapus data Rencana Kerja dan Anggaran (RKA) yang telah diproses !!!!</strong>
          </div>
        </div>
          <div class="modal-footer">
            <div class="ui-group-buttons">
...
<div id="TambahKpa" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" >
  <div class="modal-dialog modal-lg"  >
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"></h4>
      ...
      <div class="modal-body">
        <form class="form-horizontal" autocomplete='off' action="" method="post" onsubmit="return false;">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control nip" id="nip_kpa_display" name="nip_kpa_display" maxlength="18" style="text-align: center;" disabled>
            </div>
              ...
              <span class="btn btn-sm btn-primary btnPegawaiKpa" id="btnPegawaiKpa" name="btnPegawaiKpa"><i class="fa fa-search fa-fw fa-lg"></i></span>
          </div> 
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <textarea type="text" class="form-control" id="jabatan_kpa" name="jabatan_kpa" required="required" rows="3" disabled></textarea> 
            </div> 
          </div>      
          <div class="form-group">
    ...
    <div class="modal-dialog modal-xs">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="modal-footer">
            <div class="ui-group-buttons">
            <button type="button" id="btnDelKpa" class="btn btn-labeled btn-danger" data-dismiss="modal" ><span class="btn-label"><i class="fa fa-trash-o fa-lg fa-fw"></i></span> Hapus</button>
            <div class="or"></div>
            <button type="button" class="btn btn-labeled btn-warning" data-dismiss="modal" aria-hidden="true"><span class="btn-label"><i class="fa fa-sign-out fa-lg fa-fw"></i></span> Tutup</button>
            </div>
          </div>
...
@section('scripts')
  <script type="text/javascript" language="javascript" class="init" src="{{ asset('/protected/resources/views/apbd/js/js_doku_opd.js')}}"></script>
@endsection
