    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" autocomplete='off' action="" method="post" onsubmit="return false;">
          ...
          <input type="hidden" name="temp_tahun_rkpd" id="temp_tahun_rkpd" value="{{Session::get('tahun')}}">      
...
@section('scripts')
    <script src="{{ asset('/protected/resources/views/apbd1/js/js_doku.js')}}"></script>
@endsection
