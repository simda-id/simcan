...
$(".disabled").click(function (e) {
  ...
  var pelaksana_reviu;
  var check_data;
  var tahun_session = document.getElementById('tahun_rkpd').value;
...
$(document).on('click', '.view-pelaksana', function() {
      ...
      temp_ur_program_rpjmd = data.uraian_program_rpjmd;
...
$(document).on('click', '.view-unit', function() {
    var data = UrusanTable.row( $(this).parents('tr') ).data();
      ...
      document.getElementById("nm_program_rkpd_pelaksana").innerHTML = temp_ur_program_rpjmd;
      document.getElementById("nm_bidang_pelaksana").innerHTML = data.nm_bidang;
      document.getElementById("nm_urusan_pelaksana").innerHTML = data.nm_urusan;
...
$(document).on('click', '.edit-indikator', function() {
    var data = indiProg_tbl.row( $(this).parents('tr') ).data();
      ...
      $('.form-horizontal').show();
      $('#id_indikator_rkpd').val(data.id_indikator_program_rkpd);
      $('#id_rkpd_ranwal_indikator').val(data.id_anggaran_pemda);
      ...
      $('#target_indikator_rpjmd').val(data.target_rkpd);
      $('#target_indikator_rkpd').val(data.target_keuangan);
