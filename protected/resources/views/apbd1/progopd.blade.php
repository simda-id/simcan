...
@include('apbd1.cariProgNas')
@include('apbd1.cariProgProv')
@include('apbd1.cariPindah')
...
@section('scripts')
<script src="{{ asset('/protected/resources/views/apbd1/js/js_penyesuaian_pd.js')}}"></script>
@endsection