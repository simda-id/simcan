...
@include("apbd1.program_rkpd");
@include("apbd1.indikator_program_rkpd");
@include("apbd1.urusan_program_rkpd");
@include("apbd1.pelaksana_program_rkpd");
@include("apbd1.cariIndikator");
@include("apbd1.cariProgramRPJMD");
@include("apbd1.cariRefUnit");
@include("apbd1.StatusProgram");

@endsection

@section("scripts")
<script src="{{ asset('/protected/resources/views/apbd1/js/js_rkpd.js')}}"></script>
@endsection