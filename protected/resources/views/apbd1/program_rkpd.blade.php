      ...
      <div class="modal-body">
        <form name="frmEditProgram" class="form-horizontal" role="form" autocomplete='off' action="" method="post"
          ...
          <div class="form-group">
            ...
            <div class="col-sm-2">
              <input type="text" class="form-control number no_prog" name="no_urut_program" id="no_urut_program"
                disabled>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="pagu_rpjmd_program" class="col-sm-2 control-label" align='left'>Pagu APBD</label>
            <div class="col-sm-2">
            ...
            <label for="pagu_rkpd_program" class="col-sm-1 control-label" align='left'>Pagu APBD-Per</label>
            <div class="col-sm-2">
