    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form name="frmModalAktivitas" class="form-horizontal" role="form" autocomplete='off' action="" method="post"
          ...
          <div class="form-group">
            <label for="pagu_aktivitas_renja" class="col-sm-3 control-label" align='left'>Pagu APBD :</label>
            <div class="col-sm-3">
              <input type="text" class="form-control number" id="pagu_aktivitas_renja" name="pagu_aktivitas_renja"
                disabled>
            </div>
            <label for="pagu_aktivitas" class="col-sm-2 control-label" align='left'>Pagu APBD-Per :</label>
            <div class="col-sm-3">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              ...
              <label>
                <input type="radio" class="rbGroupKeu" name="rbGroupKeu" id="rbGroupKeu" value="1"> Di-Grouping per
                Aktivitas
              </label>
              <label class="hidden">
                <input type="radio" class="rbGroupKeu" name="rbGroupKeu" id="rbGroupKeu" value="2"> Di-Grouping per
                Lokasi
              </label>
            </div>
          </div>
