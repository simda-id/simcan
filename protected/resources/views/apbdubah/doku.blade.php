...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
      <?php
                $this->title = 'Dokumen Anggaran Pendapatan dan Belanja Daerah (APBD) Perubahan';
    ...
    <div class="col-md-12">
      <div class="panel panel-info">
        <div class="panel-heading">
          <p>
            <h2 class="panel-title">Dokumen Anggaran Pendapatan dan Belanja Daerah (APBD) Perubahan</h2>
          </p>
        </div>
        ...
        <div class="modal-body">
          <form class="form-horizontal" autocomplete='off' action="" method="post" onsubmit="return false;">
            ...
            <div class="form-group">
              ...
              <label for="kd_perubahan" class="col-sm-2 control-label" style="text-align: right;">Perubahan Ke
                :</label>
              <div class="col-sm-1">
  ...
  <div id="HapusDokumen" class="modal fade" role="dialog" tabindex="-1" data-focus-on="input:first"
    ...
    <div class="modal-dialog modal-xs">
      <div class="modal-content">
        <div class="modal-header">
          <h4>Hapus Dokumen Anggaran Pendapatan dan Belanja Daerah (APBD) Perubahan</h4>
        </div>
        <div class="modal-body">
          ...
          <div class="alert alert-danger">
            ...
            Yakin akan menghapus Dokumen Anggaran Pendapatan dan Belanja Daerah (APBD) Perubahan dengan nomor dokumen:
  ...
  <script type="text/javascript" language="javascript" class="init"
    src="{{ asset('/protected/resources/views/apbdubah/js/js_doku.js')}}"></script>
  @endsection