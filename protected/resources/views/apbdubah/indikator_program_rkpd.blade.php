    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" autocomplete='off' action="" method="post" onsubmit="return false;">
          ...
          <div class="form-group">
            <label for="target_indikator_rpjmd" class="col-sm-3 control-label" align='left'>Target Capaian Menurut RPJMD
              :</label>
            <div class="col-sm-2">
              <input type="text" class="form-control number" id="target_indikator_rpjmd" name="target_indikator_rpjmd"
                disabled>
            </div>
            <label for="target_indikator_rkpd" class="col-sm-3 control-label" align='left'>Target Capaian RKPD Tahun
              Berjalan :</label>
            <div class="col-sm-3">
              <input type="text" class="form-control number" id="target_indikator_rkpd" name="target_indikator_rkpd"
                required="required">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <select type="text" class="form-control id_satuan_output select2" id="id_satuan_output"
                name="id_satuan_output" disabled></select>
            </div>
          </div>
        </form>
      </div>
