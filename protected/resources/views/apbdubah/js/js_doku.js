$( document ).ready( function () {
  ...
  $.ajax( {
    type: "GET",
    url: 'UbahApbd/getDataDokReferensi' + vars,
    dataType: "json",
  ...
  var dokumen_tbl = $( '#tblDokumen' ).DataTable( {
    ...
    "bDestroy": true,
    dom: 'BfRtip',
    "ajax": { "url": "./UbahApbd/getDataDokumen" },
    "columns": [
  ...
  function loadTblRekapPPAS ( id_dokumen_keu ) {
    ...
    TblRekapPPAS = $( '#tblRekapPPAS' ).DataTable( {
      ...
      "bDestroy": true,
      dom: 'BfRtip',
      "ajax": { "url": "./UbahApbd/getDataRekap" + vars },
      "columns": [
  ...
  function loadTblTAPD ( id_dokumen_keu ) {
    ...
    TblTAPD = $( '#tblTAPD' ).DataTable( {
      ...
      "bDestroy": true,
      dom: 'BfRtip',
      "ajax": { "url": "./UbahApbd/getDataTapd" + vars },
      "columns": [
        { data: 'no_urut', sClass: "dt-center" },
        { data: 'action', 'searchable': false, 'orderable': false, sClass: "dt-center" },
        {
  ...
  function loadTblTAPDUnit ( id_tapd ) {
    ...
    TblTAPDUnit = $( '#tblUnitTAPD' ).DataTable( {
      ...
      "bDestroy": true,
      dom: 'BfRtip',
      "ajax": { "url": "./UbahApbd/getDataTapdUnit" + vars },
      "columns": [
        { data: 'no_urut', sClass: "dt-center" },
