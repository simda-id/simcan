      ...
      <div class="modal-body">
        <form name="frmModalKegiatan" class="form-horizontal" role="form" autocomplete='off' action="" method="post"
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3 chkKegiatan hidden">
              <label class="checkbox-inline">
                <input class="checkKegiatan" type="checkbox" name="checkKegiatan" id="checkKegiatan" value="1"> Telah
                Direviu</label>
            </div>
          </div>
          <div class="form-group lblKegiatanRenja">
            ...
            <span class="btn btn-sm btn-primary btnCariKegiatanRenstra" id="btnCariKegiatanRenstra"
              name="btnCariKegiatanRenstra"><i class="fa fa-search fa-fw fa-lg"></i></span>
          </div>
          <div class="form-group urKegiatanRef">
            ...
            <span class="btn btn-sm btn-primary btnCariKegiatanRef" id="btnCariKegiatanRef" name="btnCariKegiatanRef"><i
          ...
          <div class="form-group" id="idStatuskegrenja">
            <label for="status_pelaksanaan_kegrenja" class="col-sm-3 control-label" align='left'>Status Pelaksanaan
              :</label>
            <div class="col-sm-8" id="myRadio">
              <label class="radio-inline">
                <input type="radio" class="sp_kegrenja" name="status_pelaksanaan_kegrenja"
                  id="status_pelaksanaan_kegrenja" value="0">Tepat Waktu
              </label>
              <label class="radio-inline hidden">
                <input type="radio" class="sp_kegrenja" name="status_pelaksanaan_kegrenja"
                  id="status_pelaksanaan_kegrenja" value="1">Dimajukan
              </label>
              <label class="radio-inline">
                <input type="radio" class="sp_kegrenja" name="status_pelaksanaan_kegrenja"
                  id="status_pelaksanaan_kegrenja" value="2">Ditunda
              </label>
              <label class="radio-inline">
                <input type="radio" class="sp_kegrenja" name="status_pelaksanaan_kegrenja"
                  id="status_pelaksanaan_kegrenja" value="3">Dibatalkan
              </label>
              <label class="radio-inline hidden" id="sp_kegrenja4">
                <input type="radio" class="sp_kegrenja" name="status_pelaksanaan_kegrenja"
                  id="status_pelaksanaan_kegrenja" value="4">Baru
              </label>
            </div>
          </div>
          <div class="form-group KetPelaksanaan_keg">
            <label for="keterangan_status_kegiatan" class="col-sm-3 control-label" align='left'>Keterangan Pelaksanaan
              :</label>
            <div class="col-sm-8">
              <textarea type="text" class="form-control keterangan_status_kegiatan" name="keterangan_status_kegiatan"
                id="keterangan_status_kegiatan" rows="3" disabled></textarea>
            </div>
          </div>
          <div class="form-group">
            <div class="col-sm-11">
                  ...
                  <tr>
                    <td width="25%" style="text-align: center; vertical-align:middle;">
                      <label for="pagu_renstra" class="control-label" align='left'
                        style="text-align: center; vertical-align:middle;">Uraian</label>
                    </td>
                    <td width="25%" style="text-align: center; vertical-align:middle;">
                      <label for="pagu_renstra" class="control-label" align='left'
                        style="text-align: center; vertical-align:middle;">Pagu Renstra</label>
                    </td>
                    <td width="25%" style="text-align: center; vertical-align:middle;">
                      <label for="pagu_renja_kegiatan" class="control-label" align='left'
                        style="text-align: center; vertical-align:middle;">Pagu Tahun ini</label>
                    </td>
                    <td width="25%" style="text-align: center; vertical-align:middle;">
                ...
                <tbody>
                  <tr>
                    ...
                    <td style="text-align: center; vertical-align:middle;"><input type="text"
                        class="form-control number" id="pagu_renstra" name="pagu_renstra"
                        style="text-align: right; vertical-align:middle" disabled></td>

                    <td style="text-align: center; vertical-align:middle;"><input type="text"
                        class="form-control number" id="pagu_renja_kegiatan" name="pagu_renja_kegiatan"
                        style="text-align: right; vertical-align:middle" disabled></td>

                    <td style="text-align: center; vertical-align:middle;"><input type="text"
                        class="form-control number" id="pagu_selanjutnya" name="pagu_selanjutnya"
                        style="text-align: right; vertical-align:middle" disabled></td>
                  </tr>
                  <tr>
                    <td style="text-align: center; vertical-align:middle;">
                      <label for="pagu_renstra" class="control-label" align='left'
                        style="text-align: center; vertical-align:middle;">APBD-Per</label>
                    </td>
                    <td style="text-align: center; vertical-align:middle;"><input type="text"
                        class="form-control number" id="pagu_renstra_forum" name="pagu_renstra_forum"
                        style="text-align: right; vertical-align:middle" disabled></td>

                    <td style="text-align: center; vertical-align:middle;"><input type="text"
                        class="form-control number" id="pagu_renja_kegiatan_forum" name="pagu_renja_kegiatan_forum"
                        style="text-align: right; vertical-align:middle"></td>

                    <td style="text-align: center; vertical-align:middle;"><input type="text"
                        class="form-control number" id="pagu_selanjutnya_forum" name="pagu_selanjutnya_forum"
                        style="text-align: right; vertical-align:middle"></td>
                  </tr>
                </tbody>
              </table>
          ...
          <div class="form-group hidden">
            ...
            <div class="col-sm-3">
              <input type="text" class="form-control number" id="pagu_tahun_kegiatan" name="pagu_tahun_kegiatan"
                disabled>
            </div>
      ...
      <div class="modal-footer">
        <div class="row">
          <div class="col-sm-2 text-left idbtnHapusKeg">
            <button id="btnHapusKegRenja" class="btn btn-sm btn-danger btn-labeled"><span class="btn-label"><i
                  class="fa fa-trash fa-fw fa-lg"></i></span>Hapus</button>
          </div>
          <div class="col-sm-10 text-right">
            <div class="ui-group-buttons">
              <button type="button" id="btnKegiatan" class="btn btn-sm btn-success btnKegiatan btn-labeled"
                data-dismiss="modal">
