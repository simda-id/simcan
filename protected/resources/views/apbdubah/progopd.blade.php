...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
      <?php
                $this->title = 'Data Program Renja OPD - APBD Perubahan';
...
@include('apbdubah.program_pd')
@include('apbdubah.program_indikator_pd')
@include('apbdubah.kegiatan_pd')
@include('apbdubah.kegiatan_indikator_pd')
@include('apbdubah.pelaksana_pd')
@include('apbdubah.aktivitas_pd')
@include('apbdubah.lokasi_pd')
@include('apbdubah.belanja_pd')

@include('apbdubah.cariProgramRenstra')
@include('apbdubah.cariKegiatanRenstra')
@include('apbdubah.cariProgramRef')
@include('apbdubah.cariKegiatanRef')
@include('apbdubah.cariIndikator')
@include('apbdubah.cariSubUnit')
@include('apbdubah.cariAktivitasASB')
@include('apbdubah.cariLokasiModal')
@include('apbdubah.cariLokasiTeknisModal')
@include('apbdubah.cariItemSSH')
@include('apbdubah.cariRekening')
@include('apbdubah.cariProgNas')
@include('apbdubah.cariProgProv')
@include('apbdubah.cariPindah')
@include('apbdubah.ModalCopyBelanja')
@include('apbdubah.loadBelanjaASB')
@include('bebas.FrmCariPegawai')

@endsection

@section('scripts')
<script src="{{ asset('/protected/resources/views/apbdubah/js/js_penyesuaian_pd.js')}}"></script>
@endsection