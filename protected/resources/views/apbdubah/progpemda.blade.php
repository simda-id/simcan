...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
      <?php
                $this->title = "Data Program RKPD - APBD Perubahan";
    ...
    <div class="col-md-12">
      <div class="panel panel-info">
        <div class="panel-heading">
          <h2 class="panel-title">Daftar Program RKPD-APBD</h2>
        </div>
...
@include("apbdubah.program_rkpd");
@include("apbdubah.indikator_program_rkpd");
@include("apbdubah.urusan_program_rkpd");
@include("apbdubah.pelaksana_program_rkpd");
@include("apbdubah.cariIndikator");
@include("apbdubah.cariProgramRPJMD");
@include("apbdubah.cariRefUnit");
@include("apbdubah.StatusProgram");

@endsection

@section("scripts")
<script src="{{ asset('/protected/resources/views/apbdubah/js/js_rkpd.js')}}"></script>
@endsection