    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form name="frmProgRenja" class="form-horizontal" role="form" autocomplete='off' action="" method="post"
          ...
          <div class="form-group">
            <label for="pagu_rkpd_program" class="col-sm-3 control-label" align='left'>Pagu APBD :</label>
            <div class="col-sm-3">
              <input type="text" class="form-control number" id="pagu_renja_program" name="pagu_renja_program" disabled>
            </div>
            <label for="pagu_forum_program" class="col-sm-2 control-label" align='left'>Pagu APBD-Per :</label>
            <div class="col-sm-3">
