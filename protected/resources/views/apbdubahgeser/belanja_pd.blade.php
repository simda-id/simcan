      ...
      <div class="modal-body">
        <form name="frmModalBelanja" class="form-horizontal" role="form" autocomplete='off' action="" method="post"
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3 chkBelanja">
              <label class="checkbox-inline">
                <input class="checkBelanja" type="checkbox" name="checkBelanja" id="checkBelanja" value="1"> Telah
                Direviu</label>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group hidden">
            ...
            <div class="col-sm-8">
              <textarea type="name" class="form-control" id="uraian_aktivitas_asb" name="uraian_aktivitas_asb" rows="3"
                disabled=""></textarea>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <select type="text" class="form-control zona_ssh select2" id="zona_ssh" name="zona_ssh"></select>
            </div>
          </div>
          <div class="form-group">
              ...
              <table class="table table-bordered table-responsive">
                ...
                <tbody style="background-color: #fff">
                  <tr>
                    ...
                    <td rowspan="2" width="15%" style="text-align: left; vertical-align:middle;"><input type="text"
                        class="form-control number" id="koefisien_rkpd" name="koefisien_rkpd" disabled></td>
                    <td rowspan="2" width="20%" style="text-align: left; vertical-align:middle;"><input type="text"
                        class="form-control number" id="harga_satuan" name="harga_satuan" disabled></td>
                    <td rowspan="2" width="20%" style="text-align: left; vertical-align:middle;"><input type="text"
                        class="form-control number" id="jumlah_belanja" name="jumlah_belanja" disabled></td>
                  </tr>
                  <tr>
                    <td width="20%" style="text-align: left; vertical-align:middle;">
                  ...
                  <tr>
                    <td rowspan="2" width="5%" style="text-align: center; vertical-align:middle;">APBD-Per</td>
                    ...
                    <td rowspan="2" width="15%" style="text-align: left; vertical-align:middle;"><input type="text"
                        class="form-control number" id="koefisien_anggaran" name="koefisien_anggaran"></td>
                    <td rowspan="2" width="20%" style="text-align: left; vertical-align:middle;"><input type="text"
                        class="form-control number" id="harga_satuan_forum" name="harga_satuan_forum" disabled></td>
                    <td rowspan="2" width="20%" style="text-align: left; vertical-align:middle;"><input type="text"
                        class="form-control number" id="jumlah_belanja_forum" name="jumlah_belanja_forum" disabled></td>
                  </tr>
                  <tr>
                    <td width="20%" style="text-align: left; vertical-align:middle;">
