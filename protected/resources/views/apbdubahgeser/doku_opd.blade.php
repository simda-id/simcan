...
<div class="container-fluid">
              ...
              <form class="form-horizontal" role="form" autocomplete='off' action="#" method="">
                <div>
                  ...
                  <a type="button" id="btnAddDokumen" class="btn btn-labeled btn-sm btn-success"
                    ...
                    Dokumen</a>
                  <a type="button" id="btnCopyDokumen" name="btnCopyDokumen"
                    class="btn btn-labeled btn-sm btn-primary btnCopyDokumen" data-dismiss="modal"><span
                      class="btn-label"><i class="fa fa-download fa-fw fa-lg"></i></span> Copy
                    Dokumen RKA</a>
                </div>
              </form>
  ...
  <script type="text/javascript" language="javascript" class="init"
    src="{{ asset('/protected/resources/views/apbd1/js/js_doku_opd.js')}}"></script>
  @endsection