$( document ).ready( function () {
  ...
  var tahun_session = $( '#tahun_anggaran' ).val();

  $( '#prosesbar' ).hide();
  $( '#kd_perubahan' ).number( true, 0, ',', '' );
  ...
  $.ajax( {
    type: "GET",
    url: 'UbahGeser/getDataDokReferensi' + vars,
    dataType: "json",
  ...
  var dokumen_tbl = $( '#tblDokumen' ).DataTable( {
    ...
    "bDestroy": true,
    dom: 'BfRtip',
    "ajax": { "url": "./UbahGeser/getDataDokumen" },
    "columns": [
  ...
  function loadTblRekapPPAS ( id_dokumen_keu ) {
    ...
    TblRekapPPAS = $( '#tblRekapPPAS' ).DataTable( {
      ...
      "bDestroy": true,
      dom: 'BfRtip',
      "ajax": { "url": "./UbahGeser/getDataRekap" + vars },
      "columns": [
  ...
  function loadTblTAPD ( id_dokumen_keu ) {
    ...
    TblTAPD = $( '#tblTAPD' ).DataTable( {
      ...
      "bDestroy": true,
      dom: 'BfRtip',
      "ajax": { "url": "./UbahGeser/getDataTapd" + vars },
      "columns": [
        { data: 'no_urut', sClass: "dt-center" },
        { data: 'action', 'searchable': false, 'orderable': false, sClass: "dt-center" },
        {
  ...
  function loadTblTAPDUnit ( id_tapd ) {
    ...
    TblTAPDUnit = $( '#tblUnitTAPD' ).DataTable( {
      ...
      "bDestroy": true,
      dom: 'BfRtip',
      "ajax": { "url": "./UbahGeser/getDataTapdUnit" + vars },
      "columns": [
        { data: 'no_urut', sClass: "dt-center" },
  ...
  $( document ).on( 'click', '#btnAddDokumen', function () {
    $.ajax( {
      type: "GET",
      url: './UbahGeser/getDataPerencana',
      dataType: "json",
      success: function ( data ) {
        $( '#btnDokumen' ).removeClass( 'editDokumen' );
        $( '#btnDokumen' ).addClass( 'addDokumen' );
        $( '.modal-title' ).text( 'Tambah Dokumen Penyusunan APBD Pergeseran' );
  ...
  $( '.modal-footer' ).on( 'click', '.addDokumen', function () {
    ...
    $.ajax( {
      type: 'post',
      url: 'UbahGeser/addDokumen',
      data: {
        '_token': $( 'input[name=_token]' ).val(),
        'id_dokumen_ref': $( '#id_dokumen_ref' ).val(),
        'id_perubahan': $( '#kd_perubahan' ).val(),
  ...
  $( document ).on( 'click', '#btnEditDokumen', function () {
    ...
    $( '#kd_perubahan' ).val( data.id_perubahan );
