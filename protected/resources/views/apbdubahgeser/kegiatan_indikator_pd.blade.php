          ...
          <div class="form-group">
            ...
            <div class="col-sm-3 chkIndikatorKeg hidden">
              <label class="checkbox-inline">
                <input class="checkIndikatorKeg" type="checkbox" name="checkIndikatorKeg" id="checkIndikatorKeg"
                  value="1"> Telah Direviu</label>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-2">
              <input type="text" class="form-control number" id="target_indikatorKeg_renstra"
                name="target_indikatorKeg_renstra" disabled>
            </div>
            <label for="target_indikatorKeg_renja" class="col-sm-3 control-label" align='left'>Target Capaian Rancangan
              RKPD :</label>
            <div class="col-sm-3">
              <input type="text" class="form-control number" id="target_indikatorKeg_renja"
                name="target_indikatorKeg_renja" required="required">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-3" for="id_satuan_output_keg">Satuan Indikator :</label>
            <div class="col-sm-8">
              <select type="text" class="form-control id_satuan_output_keg select2" id="id_satuan_output_keg"
                name="id_satuan_output_keg" disabled></select>
            </div>
          </div>
        </form>
      </div>
