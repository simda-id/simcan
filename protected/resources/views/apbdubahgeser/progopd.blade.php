...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
      <?php
                $this->title = 'Data Program Renja OPD - Pergeseran APBD-P';
...
@include('apbdubahgeser.program_pd')
@include('apbdubahgeser.program_indikator_pd')
@include('apbdubahgeser.kegiatan_pd')
@include('apbdubahgeser.kegiatan_indikator_pd')
@include('apbdubahgeser.pelaksana_pd')
@include('apbdubahgeser.aktivitas_pd')
@include('apbdubahgeser.lokasi_pd')
@include('apbdubahgeser.belanja_pd')

@include('apbdubahgeser.cariProgramRenstra')
@include('apbdubahgeser.cariKegiatanRenstra')
@include('apbdubahgeser.cariProgramRef')
@include('apbdubahgeser.cariKegiatanRef')
@include('apbdubahgeser.cariIndikator')
@include('apbdubahgeser.cariSubUnit')
@include('apbdubahgeser.cariAktivitasASB')
@include('apbdubahgeser.cariLokasiModal')
@include('apbdubahgeser.cariLokasiTeknisModal')
@include('apbdubahgeser.cariItemSSH')
@include('apbdubahgeser.cariRekening')
@include('apbdubahgeser.cariProgNas')
@include('apbdubahgeser.cariProgProv')
@include('apbdubahgeser.cariPindah')
@include('apbdubahgeser.ModalCopyBelanja')
@include('apbdubahgeser.loadBelanjaASB')
@include('bebas.FrmCariPegawai')

@endsection

@section('scripts')
<script src="{{ asset('/protected/resources/views/apbdubahgeser/js/js_penyesuaian_pd.js')}}"></script>
@endsection