...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
      <?php
                $this->title = "Data Program RKPD - Pergeseran APBD-P";
    ...
    <div class="col-md-12">
      <div class="panel panel-info">
        <div class="panel-heading">
          <h2 class="panel-title">Daftar Program RKPD - Pergeseran APBD-P</h2>
        </div>
                  ...
                  <table id="tblProgramRKPD" class="table table-striped table-bordered table-responsive compact"
                    ...
                    <thead>
                      <tr>
                        ...
                        <th rowspan="2" width="10%" style="text-align: center; vertical-align:middle">Pagu Pergeseran
                        </th>
                  ...
                  <table id="tblIndikatorRKPD"
                    ...
                    <thead>
                      <tr>
                        ...
                        <th width="5%" style="text-align: center; vertical-align:middle">Target Pergeseran</th>
...
@include("apbdubahgeser.program_rkpd");
@include("apbdubahgeser.indikator_program_rkpd");
@include("apbdubahgeser.urusan_program_rkpd");
@include("apbdubahgeser.pelaksana_program_rkpd");
@include("apbdubahgeser.cariIndikator");
@include("apbdubahgeser.cariProgramRPJMD");
@include("apbdubahgeser.cariRefUnit");
@include("apbdubahgeser.StatusProgram");

@endsection

@section("scripts")
<script src="{{ asset('/protected/resources/views/apbdubahgeser/js/js_rkpd.js')}}"></script>
@endsection