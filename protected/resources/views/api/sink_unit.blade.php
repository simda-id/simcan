...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
      <?php
                $this->title = 'Sinkronisasi Unit Perangkat Daerah';
    ...
    <div class="col-md-12">
      <div class="panel panel-info">
        <div class="panel-heading">
          <h2 class="panel-title">Sinkronisasi Referensi Unit & Sub Unit Perangkat Daerah</h2>
        </div>
          ...
          <div class='tabs-x tabs-above tab-bordered tabs-krajee'>
            ...
            <div class="tab-content">
              ...
              <div role="tabpanel" class="tab-pane fade in" id="unit">
                ...
                <div class="col-md-12">
                  <div class="add">
                    <button id="btnAddBulkUnit" type="button" class="btnAddBulkUnit btn btn-labeled btn-sm btn-success">
                      <span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span>Update Unit Perangkat
                  ...
                  <div class="">
                    <table id="tblUnit" class="table table-striped table-bordered table-responsive compact" width="100%"
                      ...
                      <thead>
                        <tr>
                          <th colspan="3" width='18%' style="text-align: center; vertical-align:middle">Kode Unit</th>
                          <th rowspan="2" style="text-align: center; vertical-align:middle">Uraian Unit Simda Integrated
                          </th>
                          <th rowspan="2" style="text-align: center; vertical-align:middle">Uraian Unit Simda Keuangan
                          </th>
              ...
              <div role="tabpanel" class="tab-pane fade in" id="subunit">
                ...
                <div class="col-md-12">
                  <div class="add">
                    <button id="btnAddBulkSubUnit" type="button"
                      class="btnAddBulkSubUnit btn btn-labeled btn-sm btn-success">
                      <span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span>Update Sub Unit Perangkat
                      Daerah Simda Keuangan</button>
                  </div>
                  <div class="">
                    <table id="tblSubUnit" class="table table-striped table-bordered table-responsive compact"
                      ...
                      <thead>
                        <tr>
                          <th colspan="4" width='20%' style="text-align: center; vertical-align:middle">Kode Sub Unit
                          </th>
                          <th rowspan="2" style="text-align: center; vertical-align:middle">Uraian Sub Unit Simda
                            Integrated</th>
                          <th rowspan="2" style="text-align: center; vertical-align:middle">Uraian Sub Unit Simda
                            Keuangan</th>
                          <th rowspan="2" width='10%' style="text-align: center; vertical-align:middle">Aksi</th>
  ...
  <script type="text/javascript" language="javascript" class="init"
    src="{{ asset('/protected/resources/views/api/js/js_sink_unit.js')}}">
  </script>
  @endsection