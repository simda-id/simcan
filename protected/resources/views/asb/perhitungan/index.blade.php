        ...
        <div class="panel-body">
          <div class='tabs-x tabs-above tab-bordered tabs-krajee'>
            <ul class="nav nav-tabs" role="tablist">
              <li class="active"><a href="#perkada" aria-controls="perkada" role="tab" data-toggle="tab">Tahun
                  Perhitungan</a></li>
            ...
            <div class="tab-content">
              <div role="tabpanel" class="tab-pane active" id="perkada">
                ...
                <div class="ui-group-buttons">
                  <a class="test-hitung btn btn-labeled btn-primary" role="button"><span class="btn-label"><i
                        class="fa fa-file-text-o fa-fw fa-lg"></i></span>Pencetakan Perhitungan ASB</a>
                  <div class="or"></div>
                  <a class="add-hitungasb btn btn-labeled btn-success" role="button"><span class="btn-label"><i
                        class="fa fa-calculator fa-fw fa-lg" aria-hidden="true"></i></span>Proses Perhitungan ASB </a>
                </div>
                <div class="table-responsive">
                  <table id='tblPerkada' class="table display compact table-striped table-bordered" cellspacing="0"
                    width="100%">
                    <thead>
                      <tr>
              ...
              <div role="tabpanel" class="tab-pane" id="kelompok">
                ...
                <div id="divKelompok">
                  <div class="table-responsive">
                    <table id="tblKelompok" class="table display compact table-striped table-bordered" cellspacing="0"
                      width="100%">
                      <thead>
                        <tr>
              ...
              <div role="tabpanel" class="tab-pane" id="subkelompok">
                ...
                <div id="divSubKelompok">
                  <div class="table-responsive">
                    <table id="tblSubKelompok" class="table display compact table-striped table-bordered"
              ...
              <div role="tabpanel" class="tab-pane" id="subsubkelompok">
                ...
                <div id="divSubSubKel">
                  <div class="table-responsive">
                    <table id="tblSubSubKelompok" class="table display compact table-striped" cellspacing="0"
                      width="100%">
                      <thead>
                        <tr>
                          <th width="10%" style="text-align: center; vertical-align:middle">No Urut</th>
              ...
              <div role="tabpanel" class="tab-pane" id="detailzona">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                      <tbody>
                        <tr>
                          <td width="15%" style="text-align: left; vertical-align:top;">No Perkada</td>
                          <td id="" name="" style="text-align: left; vertical-align:top;"><label id="no_perkada_zona"
                              align='left'></label></td>
                        </tr>
                        <tr>
                          <td width="15%" style="text-align: left; vertical-align:top;">Nama Kelompok</td>
                          <td style="text-align: left; vertical-align:top;"><label id="nm_kel_zona"
                              align='left'></label></td>
                        </tr>
                        <tr>
                          <td width="15%" style="text-align: left; vertical-align:top;">Nama Sub Kelompok</td>
                          <td style="text-align: left; vertical-align:top;"><label id="nm_subkel_zona"
                              align='left'></label></td>
                        </tr>
                        <tr>
                          <td width="15%" style="text-align: left; vertical-align:top;">Nama Sub Kelompok</td>
                          <td style="text-align: left; vertical-align:top;"><label id="nm_subsubkel_zona"
                              align='left'></label></td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <div id="divZona">
                  <div class="table-responsive">
                    <table id="tblZona" class="table display compact table-striped table-bordered" cellspacing="0"
                      width="100%">
                      <thead>
                        <tr>
                          <th width="10%" style="text-align: center; vertical-align:middle">No Urut</th>
              ...
              <div role="tabpanel" class="tab-pane" id="detailaktivitas">
                    ...
                    <table class="table table-striped table-bordered">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="text-align: left; vertical-align:top;"><label id="nm_zona_aktiv"
                              align='left'></label></td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <div id="divAktivitas">
                  <div class="table-responsive">
                    <table id="tblAktivitas" class="table display compact table-striped table-bordered" cellspacing="0"
                      width="100%">
                      <thead>
                        <tr>
                          <th width="10%" style="text-align: center; vertical-align:middle">No Urut</th>
              ...
              <div role="tabpanel" class="tab-pane" id="detailkomponen">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                      <tbody>
                        ...
                        <tr>
                          <td width="15%" style="text-align: left; vertical-align:top;">Nama Zona Wilayah</td>
                          <td style="text-align: left; vertical-align:top;"><label id="nm_zona_komp"
                              align='left'></label></td>
                        </tr>
                        <tr>
                ...
                <div class="table-responsive">
                  <table id="tblKomponen" class="table display compact table-striped table-bordered" cellspacing="0"
                    width="100%">
                    <thead>
                      <tr>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                      <tbody>
                        ...
                        <tr>
                          <td width="15%" style="text-align: left; vertical-align:top;">Nama Zona Wilayah</td>
                          <td style="text-align: left; vertical-align:top;"><label id="nm_zona_rinc"
                              align='left'></label></td>
                        </tr>
                        <tr>
                          <td width="15%" style="text-align: left; vertical-align:top;">Nama Aktivitas</td>
...
<div id="SimulasiHitung" class="modal fade" role="dialog" data-backdrop="static">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" autocomplete='off' action="" method="" onsubmit="return false;">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" id="nomor_perkada_simulasi" name="nomor_perkada_simulasi" class="form-control"
                readonly>
            </div>
            ...
            <span class="btn btn-sm btn-primary btnCariASB" id="btnCariASB" name="btnCariASB"
              title="Pemilihan Aktivitas ASB yang akan disimulasikan"><i class="fa fa-search fa-fw fa-lg"></i></span>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-2">
              <input type="text" class="form-control number" id="v1_simulasi" name="v1_simulasi"
          ...
          <div class="form-group">
            ...
            <div class="col-sm-2">
              <input type="text" class="form-control number" id="v2_simulasi" name="v2_simulasi"
                style="text-align: right;">
            </div>
      ...
      <div class="modal-footer">
        <div class="row">
          <div class="col-sm-2 text-left idbtnHapusBelanja"></div>
          <div class="col-sm-10 text-right">
            <div class="ui-group-buttons">
...
<div id="UbahStatus" class="modal fade" role="dialog" data-backdrop="static">
  <div class="modal-dialog modal-xs">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form name="frmUbahStatus" class="form-horizontal" role="form" autocomplete='off' action="" method=""
          ...
          <table class="table table-striped table-bordered">
            <tbody>
              <tr>
                ...
                <td id="" name="" style="text-align: left; vertical-align:top;"><label id="tahun_perhitungan_status"
                    align='left'></label></td>
              </tr>
              <tr>
                <td width="35%" style="text-align: left; vertical-align:top;"><b>No Perkada</b></td>
                <td id="" name="" style="text-align: left; vertical-align:top;"><label id="no_perkada_status"
                    align='left'></label></td>
              </tr>
              <tr>
                ...
                <td id="" name="" style="text-align: left; vertical-align:top;">
                  <label class="radio-inline">
                    <input type="radio" class="status_hitung" name="status_hitung" id="status_hitung"
                      value="0">Draft</label>
                  <label class="radio-inline">
                    <input type="radio" class="status_hitung" name="status_hitung" id="status_hitung"
                      value="1">Aktif</label>
                  <label class="radio-inline">
                    <input type="radio" class="status_hitung" name="status_hitung" id="status_hitung" value="2">Non
                    Aktif</label>
                </td>
              </tr>
            </tbody>
          ...
          <div class="col-sm-10 text-right">
            <div class="ui-group-buttons">
              <button type="button" class="btn  btn-primary btnUbahStatus btn-labeled" data-dismiss="modal">
                <span class="btn-label"><i id="fooSimulasi"
...
<div id="HapusHitung" class="modal fade" role="dialog" data-backdrop="static">
  <div class="modal-dialog modal-xs">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form name="frmHapusHitung" class="form-horizontal" role="form" autocomplete='off' action="" method=""
          onsubmit="return false;">
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
          ...
          <table class="table table-striped table-bordered">
            <tbody>
              <tr>
                <td width="35%" style="text-align: left; vertical-align:top;"><b>Tahun Perhitungan</b></td>
                <td id="" name="" style="text-align: left; vertical-align:top;"><label id="tahun_perhitungan_hapus"
                    align='left'></label></td>
              </tr>
              <tr>
                <td width="35%" style="text-align: left; vertical-align:top;"><b>No Perkada</b></td>
                <td id="" name="" style="text-align: left; vertical-align:top;"><label id="no_perkada_hapus"
                    align='left'></label></td>
              </tr>
              <tr>
                <td width="35%" style="text-align: left; vertical-align:top;"><b>Status Perhitungan</b></td>
                <td id="" name="" style="text-align: left; vertical-align:top;"><label id="status_hitung_hapus"
                    align='left'></label></td>
              </tr>
            </tbody>
          </table>
...
<div id="cariAktivitasASB" class="modal fade" role="dialog" data-backdrop="static" tabindex="-1"
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" autocomplete='off' action="" method="">
          ...
          <div class="form-group">
            ...
            <span class="btn btn-sm btn-success btnLoadASB" id="btnLoadASB" name="btnLoadASB"
              title="Refresh Data Tabel ASB"><i class="fa fa-refresh fa-fw fa-lg"></i></span>
          </div>
          ...
          <div class="form-group">
            <div class="col-sm-12">
              <table id='tblCariAktivitasASB' class="table display compact table-striped table-bordered" cellspacing="0"
                width="100%">
                <thead>
                  <tr>
                    <th width="5%" style="text-align: center; vertical-align:middle;">No Urut</th>
...
<script type="text/javascript" language="javascript" class="init">
  ...
  var id_sk_asb, id_hitung_asb, id_kel_asb, id_subkel_asb, id_subsubkel_asb, id_aktiv_asb, id_komp_asb;
  var id_rinci_asb, nm_sk_asb, nm_kel_asb, nm_subkel_asb, nm_subsubkel_asb, nm_aktiv_asb, nm_komp_asb;
  var nm_rinci_asb, flag_perkada, id_zona_asb, nm_zona_asb;
