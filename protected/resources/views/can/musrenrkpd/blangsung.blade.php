            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select type="text" class="form-control" id="sumber_data_lokasi" name="sumber_data_lokasi" disabled>
                          ...
                          <option value="5">Rancangan RKPD</option>
                        </select>
                    {{-- </div> --}}
                </div>
            </div>
...
var tahun_temp,unit_temp,sub_unit_temp,ProgRkpd_temp,PelaksanaRkpd_temp, bidang_temp,jenis_belanja_temp;
...
$('.modal-footer').on('click', '.addProgRenja', function() {
      ...
      $.ajax({
          ...
          data: {
              ...
              'id_rkpd_rancangan' : $('#id_pelaksana_prog_pd').val(),
              // 'id_rkpd_rancangan' : $('#id_rancangan_prog_pd').val(),
...
$(document).on('click', '#btnCopyBelanja', function() {
  ...
  CopyBelanjaTbl = $('#tblCopyBelanja').DataTable( {
        ...
        autoWidth : false,
        dom: 'bfrtIp',
        "ajax": {"url": "./getLokasiCopy/"+id_aktivitas_temp},
        "columns": [
              { data: 'urut', sClass: "dt-center"},
