...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <?php
                $this->title = ' Angka Partisipasi Sekolah  ';
    ...
    <div role="tabpanel" class="tab-pane fade in active" id="aps">
                  <div class="col-md-12">
                  <div class="add">
                      <button id="btnAddaps" type="button" class="btn btn-labeled btn-sm btn-success"><span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span>Tambah Angka Partisipasi Sekolah</button>
                      <button id="btnPrintaps" type="button" class="btn btn-labeled btn-sm btn-primary"><span class="btn-label"><i class="glyphicon glyphicon-print"></i></span>Print Angka Partisipasi Sekolah</button>
                  </div>
                  <div class="">
                  <table id="tblaps" class="table table-striped table-bordered table-responsive compact" width="100%" cellspacing="0">
                        <thead>
                            <tr>
 ...
 <div id="Modalaps" class="modal fade" role="dialog" data-backdrop="static">
  <div class="modal-dialog modal-lg"  >
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form name="frmModalaps" class="form-horizontal" role="form" autocomplete='off' action="" method="post" onsubmit="return false;">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
<!--             <input type="hidden" name="id_pemda" id="id_pemda"> -->
<!--             <input type="hidden" name="id_aps" id="id_aps"> -->
            <div class="row">
            <div class="col-sm-2" style="text-align: center;">
              <i class="fa fa-snowflake-o fa-fw" style="font-size: 100px;color: #357EBD;"></i>
            </div>
            <div class="col-sm-10">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10 text-right">
                      <div class="ui-group-buttons">
                        <button type="button" class="btn btn-sm btn-success btnaps btn-labeled" data-dismiss="modal">
...
<div id="ModalHapusaps" class="modal fade" role="dialog" data-backdrop="static">
  <div class="modal-dialog modal-lg"  >
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"></h4>
      ...
      <div class="modal-body">
        <form name="frmModalHapusaps" class="form-horizontal" role="form" autocomplete='off' action="" method="post" onsubmit="return false;">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
<!--             <input type="hidden" name="id_pemda" id="id_pemda"> -->
<!--             <input type="hidden" name="id_aps" id="id_aps"> -->
            <div class="row">
        ...
        <div class="modal-footer">
                <div class="row">
                    ...
                    <div class="col-sm-10 text-right">
                      <div class="ui-group-buttons">
                        <button type="button" class="btn btn-sm btn-success btnHapusaps btn-labeled" data-dismiss="modal">
...
$(document).ready(function() {
	//alert('A');
var aps_tbl=$('#tblaps').DataTable({
                  processing: true,
                  serverSide: true,
                  dom : 'BfRtip',                  
                  autoWidth : false,
                  "ajax": {"url": "./aps/getListaps"},
                  "language": {
                      "decimal": ",",
                      "thousands": "."},
                  "columns": [
...
$(document).on('click', '#btnAddaps', function() {
	  $('.btnaps').removeClass('edit');
	  $('.btnaps').addClass('add');
	  $('.modal-title').text('Tambah Angka Partisipasi Sekolah');
...
$( ".kecamatan" ).change(function() {
    ...
    $.ajax({
        ...
        type: "GET",
        url: './aps/getSektoraps/'+$('#tahun').val()+'/'+$('#kecamatan').val()+'/'+$('#tingkat').val(),
        dataType: "json",
...
//edit function
$(document).on('click', '#btnEditaps', function() {
//alert("1");

var data = aps_tbl.row( $(this).parents('tr') ).data();

  $('.btnaps').removeClass('add');
  $('.btnaps').addClass('edit');
  $('.modal-title').text('Edit Angka Partisipasi Sekolah');
  $('.form-horizontal').show();
  $('#Modalaps').modal('show');
...
$(document).on('click', '#btnHapusaps', function() {
	var data = aps_tbl.row( $(this).parents('tr') ).data();
	$('.btnHapusaps').removeClass('add');
	  $('.btnHapusaps').addClass('remove');
	  $('.modal-title').text('Hapus Angka Partisipasi Sekolah');
	  $('.form-horizontal').show();
	 $('#ModalHapusaps').modal('show');
...
$(document).on('click', '#btnPrintaps', function() {

	//alert("print");
     window.open('./PrintAps/2018');
