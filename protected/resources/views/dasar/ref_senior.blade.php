...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <?php
                $this->title = ' Perkembangan Kesenian, Budaya dan Olahraga  ';
    ...
    <div role="tabpanel" class="tab-pane fade in active" id="senior">
                  <div class="col-md-12">
                  <div class="add">
                      <button id="btnAddsenior" type="button" class="btn btn-labeled btn-sm btn-success"><span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span>Tambah Kesenian, Budaya dan Olahraga</button>
                      <button id="btnPrintsenior" type="button" class="btn btn-labeled btn-sm btn-primary"><span class="btn-label"><i class="glyphicon glyphicon-print"></i></span>Print Kesenian, Budaya dan Olahraga</button>
                  </div>
                  <div class="">
                  <table id="tblsenior" class="table table-striped table-bordered table-responsive compact" width="100%" cellspacing="0">
                        <thead>
                            <tr>
 ...
 <div id="Modalsenior" class="modal fade" role="dialog" data-backdrop="static">
  <div class="modal-dialog modal-lg"  >
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form name="frmModalsenior" class="form-horizontal" role="form" autocomplete='off' action="" method="post" onsubmit="return false;">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
<!--             <input type="hidden" name="id_pemda" id="id_pemda"> -->
<!--             <input type="hidden" name="id_senior" id="id_senior"> -->
            <div class="row">
            <div class="col-sm-2" style="text-align: center;">
              <i class="fa fa-bank fa-fw" style="font-size: 100px;color: #357EBD;"></i>
            </div>
            <div class="col-sm-10">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10 text-right">
                      <div class="ui-group-buttons">
                        <button type="button" class="btn btn-sm btn-success btnsenior btn-labeled" data-dismiss="modal">
...
<div id="ModalHapussenior" class="modal fade" role="dialog" data-backdrop="static">
  <div class="modal-dialog modal-lg"  >
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"></h4>
      ...
      <div class="modal-body">
        <form name="frmModalHapussenior" class="form-horizontal" role="form" autocomplete='off' action="" method="post" onsubmit="return false;">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
<!--             <input type="hidden" name="id_pemda" id="id_pemda"> -->
<!--             <input type="hidden" name="id_senior" id="id_senior"> -->
            <div class="row">
        ...
        <div class="modal-footer">
                <div class="row">
                    ...
                    <div class="col-sm-10 text-right">
                      <div class="ui-group-buttons">
                        <button type="button" class="btn btn-sm btn-success btnHapussenior btn-labeled" data-dismiss="modal">
...
$(document).ready(function() {
	//alert('A');
var senior_tbl=$('#tblsenior').DataTable({
                  processing: true,
                  serverSide: true,
                  dom : 'BfRtip',                  
                  autoWidth : false,
                  "ajax": {"url": "./senior/getListsenior"},
                  "language": {
                      "decimal": ",",
                      "thousands": "."},
                  "columns": [
...
$(document).on('click', '#btnAddsenior', function() {
	  $('.btnsenior').removeClass('edit');
	  $('.btnsenior').addClass('add');
	  $('.modal-title').text('Tambah Data Perkembangan Kesenian, Budaya dan Olahraga');
	  $('.form-horizontal').show();
	  $('#Modalsenior').modal('show');
	  $('#nama_kolom').val("");
	  $('#kecamatan').val("");
	  $('#nmin1').val("");
	  $('#nmin2').val("");
...
$( ".kecamatan" ).change(function() {
    ...
    $.ajax({
        ...
        type: "GET",
        url: './senior/getSektorsenior/'+$('#tahun').val()+'/'+$('#kecamatan').val(),
        dataType: "json",
...
$('.modal-footer').on('click', '.add', function() {
    ...
    $.ajax({
        ...
        success: function(data) {
              $('#tblsenior').DataTable().ajax.reload();
...
//edit function
$(document).on('click', '#btnEditsenior', function() {
//alert("1");

var data = senior_tbl.row( $(this).parents('tr') ).data();

  $('.btnsenior').removeClass('add');
  $('.btnsenior').addClass('edit');
  $('.modal-title').text('Edit Data Perkembangan Kesenian, Budaya dan Olahraga');
  $('.form-horizontal').show();
  $('#Modalsenior').modal('show');
...
$(document).on('click', '#btnHapussenior', function() {
	var data = senior_tbl.row( $(this).parents('tr') ).data();
	$('.btnHapussenior').removeClass('add');
	  $('.btnHapussenior').addClass('remove');
	  $('.modal-title').text('Hapus Data Perkembangan Kesenian, Budaya dan Olahraga');
	  $('.form-horizontal').show();
	 $('#ModalHapussenior').modal('show');
...
$(document).on('click', '#btnPrintsenior', function() {

	//alert("print");
     window.open('./Printsenior/2018');
