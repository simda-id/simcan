        ...
        <form name="frmModalLokasi" class="form-horizontal" role="form" autocomplete='off' action="" method="post"
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3 chkLokasi">
              <label class="checkbox-inline">
                <input class="checkLokasi" type="checkbox" name="checkLokasi" id="checkLokasi" value="1"> Telah
                Direviu</label>
            </div>
          </div>
          <div class="form-group">
              ...
              <tbody style="background-color: #fff">
                <tr>
                  ...
                  <td width="30%" style="text-align: center; vertical-align:top;">
                    <input type="text" class="form-control number" id="volume_usulan_1_lokasi"
                      name="volume_usulan_1_lokasi" style="text-align: right; vertical-align:top;" disabled>
                  </td>
                  <td width="30%" style="text-align: center; vertical-align:top;">
                  ...
                  <td width="30%" style="text-align: center; vertical-align:top;">
                    <label class="radio">
                      <select type="text" class="form-control" id="id_satuan_1_lokasi"
                        name="id_satuan_1_lokasi"></select>
                    </label>
                  </td>
                </tr>
                <tr>
                  ...
                  <td width="30%" style="text-align: center; vertical-align:top;">
                    <input type="text" class="form-control number" id="volume_usulan_2_lokasi"
                      name="volume_usulan_2_lokasi" style="text-align: right; vertical-align:top;" disabled>
                  </td>
                  <td width="30%" style="text-align: center; vertical-align:top;">
                  ...
                  <td width="30%" style="text-align: center; vertical-align:top;">
                    <label class="radio">
                      <select type="text" class="form-control" id="id_satuan_2_lokasi"
                        name="id_satuan_2_lokasi"></select>
                    </label>
                  </td>
                </tr>
              </tbody>
          ...
          <div class="form-group" id="idStatusPelaksanaanLokasi">
            ...
            <div class="col-sm-8" id="myRadio">
              <label class="radio-inline">
                <input type="radio" class="sp_lokasi" name="status_pelaksanaan_lokasi" id="status_pelaksanaan_lokasi"
                  value="0">Tanpa Perubahan
              </label>
              <label class="radio-inline">
                <input type="radio" class="sp_lokasi" name="status_pelaksanaan_lokasi" id="status_pelaksanaan_lokasi"
                  value="1">Dengan Perubahan
              </label>
              <label class="radio-inline">
                <input type="radio" class="sp_lokasi" name="status_pelaksanaan_lokasi" id="status_pelaksanaan_lokasi"
                  value="2">Digabungkan
            ...
            <div class="col-sm-8 col-sm-offset-3" id="myRadio">
              <label class="radio-inline">
                <input type="radio" class="sp_lokasi" name="status_pelaksanaan_lokasi" id="status_pelaksanaan_lokasi"
                  value="3">Tidak dilaksanakan
              </label>
              <label class="radio-inline">
                <input type="radio" class="sp_lokasi" name="status_pelaksanaan_lokasi" id="status_pelaksanaan_lokasi"
                  value="4">Diluarkewenangan
              </label>
              {{-- <label class="radio-inline">
