      ...
      <div class="col-md-12">
        <div class="panel panel-info">
          ...
          <ul class="nav nav-tabs" role="tablist">
            <li class="active"><a href="#tujuan" aria-controls="tujuan" role="tab" data-toggle="tab">Tujuan</a></li>
          ...
          <div class="tab-content">            
            <div role="tabpanel" class="tab-pane active" id="tujuan">
            <br>
            ...
            <br>
            <div class="form-group">
              <button type="button" class="btn btn-labeled btn-success btnTambahHSP"><span class="btn-label"><i class="fa fa-plus fa-fw fa-lg"></i></span> Tambah Sasaran Program</button>
            </div>
            <div class="">
                    <table id="tblProgram" class="table compact table-responsive table-striped table-bordered display"  cellspacing="0" width="100%">
                      <thead>
                          <tr>
                            ...
                            <th rowspan="2" style="text-align: center; vertical-align:middle">Uraian Sasaran Program</th>
            ...
            <br>
            <div class="form-group">
              <button type="button" class="btn btn-labeled btn-success btnTambahHSP"><span class="btn-label"><i class="fa fa-plus fa-fw fa-lg"></i></span> Tambah Sasaran Kegiatan</button>
            </div>
              <div class="">
              <table id="tblKegiatan" class="table compact table-responsive table-striped table-bordered display" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      ...
                      <th rowspan="2" style="text-align: center; vertical-align:middle">Uraian Sasaran Kegiatan</th>
                      <th rowspan="2" width="10%" style="text-align: center; vertical-align:middle">Aksi</th>
                    </tr>
                    <tr>
                  </thead>
...
$(document).ready(function() {
  ...
  var tbl_Tujuan, tblInTujuan;
  function loadTblTujuan($data) {
  tbl_Tujuan = $('#tblTujuan').DataTable( {
          ...
          language: {
                "decimal": ",",
                "thousands": "."},
          "ajax": {"url": "cascading/getTujuanRenstra/"+$data},
          "columns": [
                {
