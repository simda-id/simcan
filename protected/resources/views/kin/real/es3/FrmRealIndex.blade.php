...
@include('kin.real.es3.JsRealDokumen')
@include('kin.real.es3.JsRealProgramIndikator')
@include('kin.real.es3.JsRealProgram')
@include('kin.real.es3.JsRealKegiatanIndikator')
});
</script>
@endsection
