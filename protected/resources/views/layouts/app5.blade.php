                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand navbar-right" href="{{ url('/home') }}">
                        <span class="fa-stack">
                            ...
                            <span style="color:#fff"> simd@<strong>Anggaran</strong> ::
                                {{Session::get('xPemda')}}</span>
                            @if ( Session::get('AppType') === 0 )
                            <span class="label" style="background-color: #3a87ad; color:#fff;">
                                {{Session::get('versiApp')}}
                                - Provinsi </span>
                            @else
                            <span class="label" style="background-color: #f89406; color:#fff;">
                                {{Session::get('versiApp')}}
                            </span>
                            @endif
                </div>
