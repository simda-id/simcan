...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <?php
                $this->title = 'Daftar Usulan Musrenbang Kecamatan';
        ...
        <div class="col-md-12">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                  <div class="col-md-12">
                    <div class="add">
                      <button id="btnAddMusrencam" type="button" class="btn btn-labeled btn-sm btn-success"><span class="btn-label"><i class="fa fa-plus fa-lg fa-fw"></i></span>Tambah Usulan Musrenbang Kecamatan</button>
                    </div>
                    <table id="tblMusrencam" class="table table-striped table-bordered table-responsive compact display" width="100%" cellspacing="0">
                            <thead>
                                <tr>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form name="frmModalMusrencam" class="form-horizontal" role="form" autocomplete='off' action="" method="post" onsubmit="return false;">
                ...
                <input type="hidden" id="id_Musrencam_rw" name="id_Musrencam_rw">
                <input type="hidden" id="id_Musrencam" name="id_Musrencam">
              ...
              <div class="modal-footer">
                <div class="row">
                    <div class="col-sm-2 text-left">
                        <button type="button" id="btnHapusMusrencam" class="btn btn-sm btn-danger btn-labeled">
                            <span class="btn-label"><i class="glyphicon glyphicon-trash"></i></span>Hapus</button>
                    </div>
                    <div class="col-sm-10 text-right">
                      <div class="ui-group-buttons">
                        <button type="button" id="btnMusrencam" class="btn btn-sm btn-success btn-labeled" data-dismiss="modal">
...
var usulan_tbl
    usulan_tbl=$('#tblMusrencam').DataTable({
                  processing: true,
                  serverSide: true,
                  dom : 'BfRtip',                  
                  autoWidth : false,
...
$('#btnEditMusrencam').click(function(){
...
$(document).on('click', '#btnDelMusrencam', function() {
    ...
    //   success: function(data) {
        $('#ModalMusrencam').modal('hide'); 
        $('#tblMusrencam').DataTable().ajax.reload();
