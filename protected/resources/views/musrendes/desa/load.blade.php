...
@section('content')
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <?php
                $this->title = 'Posting Data Musrenbang Desa/Kelurahan';
      ...
      <div class="col-md-12">
        <div class="panel panel-info">
          <div class="panel-heading">
            <h2 class="panel-title">Posting Data Musrenbang Desa/Kelurahan</h2>
          </div>
          ...
          <div class="panel-body">
            <form class="form-horizontal" role="form" autocomplete='off' action="" method="" >
                ...
                <div class="form-group">
                  ...
                  <div>
                    <a type="button" class="btn btn-labeled btn-sm btn-primary btnProses" data-dismiss="modal"><span class="btn-label"><i class="fa fa-check-square-o fa-lg fa-fw"></i></span> Posting Data Musrenbang Desa</a>
                  </div>
                </div>
                <div class="form-group">
