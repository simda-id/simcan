      ...
      <div class="col-md-12">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h2 class="panel-title">Detail Data Usulan Musrenbang Desa/Kelurahan</h2>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-7">
              {{-- <select class="form-control" id="id_asb_aktivitas" name="aktivitas_asb">
                                <?php foreach($asb as $val) { ?>
                                    <option value="<?php echo $val->id_aktivitas_asb;?>"><?php echo $val->nm_aktivitas_asb;?> </option>
                                <?php } ?>
                        </select> --}}
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <input type="textarea" class="form-control" id="txt_diskripsi_aktivitas" name="diskripsi_aktivitas" disabled="disabled" required="required" value="Usulan">
            </div>
          </div>
