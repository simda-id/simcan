...
<script id="details-inKeg" type="text/x-handlebars-template">
  ...
  @include('musrenrkpd.program_pd')
  @include('musrenrkpd.program_indikator_pd')
  @include('musrenrkpd.kegiatan_pd')
  @include('musrenrkpd.kegiatan_indikator_pd')
  @include('musrenrkpd.pelaksana_pd')
  @include('musrenrkpd.aktivitas_pd')
  @include('musrenrkpd.lokasi_pd')
  @include('musrenrkpd.belanja_pd')

  @include('musrenrkpd.cariProgramRenstra')
  @include('musrenrkpd.cariKegiatanRenstra')
  @include('musrenrkpd.cariProgramRef')
  @include('musrenrkpd.cariKegiatanRef')
  @include('musrenrkpd.cariIndikator')
  @include('musrenrkpd.cariSubUnit')
  @include('musrenrkpd.cariAktivitasASB')
  @include('musrenrkpd.cariLokasiModal')
  @include('musrenrkpd.cariLokasiTeknisModal')
  @include('musrenrkpd.cariItemSSH')
  @include('musrenrkpd.cariRekening')
  @include('musrenrkpd.ModalCopyBelanja')
  @include('musrenrkpd.loadBelanjaASB')

@endsection

@section('scripts')
  @include('musrenrkpd.js_penyesuaian_pd')
@endsection