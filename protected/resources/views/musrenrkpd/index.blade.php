...
@include('musrenrkpd.program_rkpd');
@include('musrenrkpd.indikator_program_rkpd');
@include('musrenrkpd.urusan_program_rkpd');
@include('musrenrkpd.pelaksana_program_rkpd');

@include('musrenrkpd.cariIndikator');
@include('musrenrkpd.cariProgramRPJMD');
@include('musrenrkpd.cariRefUnit');
@include('musrenrkpd.StatusProgram');

@endsection

@section('scripts')

@include('musrenrkpd.js_musren_rkpd')
@endsection
