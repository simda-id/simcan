    ...
    <div class="row">
      <div class="col-md-12">
        <ul class="breadcrumb">
          ...
          <li class="active">MUSRENBANG RKPD</li>
        </ul>
        <div class="panel panel-default">
          <div class="panel-heading">
            <h2 class="panel-title">Daftar Usulan Kegiatan Musrenbang RKPD</h2>
          </div>
                                      ...
                                      <a class="btn dropdown-toggle btn-primary btn-xs" data-toggle="dropdown" aria-hidden="true">
                                       Review<span class="caret"></span></a>
                                        <ul class="dropdown-menu dropdown-menu-action" role="menu">
                                          ...
                                          <li class="divider"></li>
                                          <li><a title="edit_data" data-toggle="modal" class="edit_data" data-id="" href="{{url('/musrenrkpd/edit')}}"><i class="glyphicon glyphicon-pencil"></i> Edit Data Musrenbang RKPD</a></li>
                                        </ul>    
                                  </div>
                                  </div>
                                </th>
