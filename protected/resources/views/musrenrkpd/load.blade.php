...
@section('content')
  <div class="container">
    <div class="row">
      <div class="col-sm-8">
        <ul class="breadcrumb">
          <li><a href="{{ url('/') }}">MUSRENBANG</a></li>
          <li class="active">LOAD MUSRENBANG RKPD</li>
        </ul>
        <div class="panel panel-default">
          <div class="panel-heading">
            <h2 class="panel-title">Proses Load Data Musrenbang RKPD</h2>
          </div>

          <div class="panel-body">
            <p><a class="btn btn-lg btn-primary" href="#"><i class="glyphicon glyphicon-download-alt"></i> Proses</a></p>
            <table class="table table-condensed table-responsive" cellspacing="0" width="100%">
            <tr>
              <td width="25%"> <label>Tahun Perencanaan</label></td>
              <td width="1%"> : </td>
              <td>
            ...
            <tr>
              <td width="25%"> <label>Unit OPD Pelaksana</label></td>
              <td width="1%"> : </td>
              <td>
                <select class="form-control" id="id_desa" name="desa">
