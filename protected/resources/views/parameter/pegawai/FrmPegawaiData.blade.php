<div id="ModalPegawai" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frmModalPegawai" name="frmModalPegawai" class="form-horizontal" autocomplete='off' action=""
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control nip" id="nip_pegawai_display" name="nip_pegawai_display"
                maxlength="18">
          ...
          <div id="divRiwayat">
            <ul class="nav nav-tabs" role="tablist">
              <li class="active"><a href="#pangkat" aria-controls="pangkat" role="tab" data-toggle="tab">Riwayat
                  Pangkat</a></li>
            ...
            <div class="tab-content">
              ...
              <div role="tabpanel" class="tab-pane" id="unit">
                ...
                <table id='tblRiwayatUnit' class="table display compact table-striped table-bordered table-responsive"
                  cellspacing="0">
                  <thead>
                    <tr>
                      <th width="5%" style="text-align: center; vertical-align:middle">No Urut</th>
        ...
        <div class="row">
          ...
          <div class="col-sm-10 text-right">
            <div class="ui-group-buttons">
              <button id="btnSimpanPegawai" type="button" class="btn btn-success btn-labeled btnSimpanPegawai"
                data-dismiss="modal">
...
<div id="HapusPegawai" class="modal fade" role="dialog" tabindex="-1" data-focus-on="input:first"
  data-backdrop="static">
  <div class="modal-dialog modal-xs">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="ui-group-buttons">
          <button type="button" id="btnAksiDelPegawai" class="btn btn-labeled btn-danger btnAksiDelPegawai"
