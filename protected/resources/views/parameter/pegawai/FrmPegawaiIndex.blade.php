      ...
      <div class="panel panel-warning">
        ...
        <div class="panel-body">
          ...
          <ul class="nav nav-tabs" role="tablist">
            <li class="active"><a href="#pegawai" aria-controls="pegawai" role="tab" data-toggle="tab">Daftar
                Pegawai</a></li>
          </ul>
          ...
          <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="pegawai">
              <br>
              <table id='tblPegawai' class="table display table-striped table-bordered table-responsive"
                cellspacing="0">
                <thead>
                  <tr>
...
@include('parameter.pegawai.FrmPegawaiData')
@include('parameter.pegawai.FrmPegawaiRiwayatPangkat')
@include('parameter.pegawai.FrmPegawaiRiwayatUnit')
...
<script type="text/javascript" language="javascript" class="init"
  src="{{ asset('/protected/resources/views/parameter/pegawai/js_pegawai.js')}}"> </script>
@endsection