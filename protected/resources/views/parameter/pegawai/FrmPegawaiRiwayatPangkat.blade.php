<div id="ModalRiwayat" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frmModalRiwayat" name="frmModalRiwayat" class="form-horizontal" autocomplete='off' action=""
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <select class="form-control select2 golongan" name="cb_golongan" id="cb_golongan"></select>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control datepicker" id="tmt_pangkat_x" name="tmt_pangkat_x"
        ...
        <div class="row">
          ...
          <div class="col-sm-10 text-right">
            <div class="ui-group-buttons">
              <button id="btnSimpanRiwayat" type="button" class="btn btn-success btn-labeled btnSimpanRiwayat"
                data-dismiss="modal">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="alert alert-danger">
          ...
          Yakin akan menghapus Riwayat Kepangkatan Pengawai : <strong><span class="nama_pangkat_hapus"></span></strong>
          ini ?
          <br>
          <br>
          <br>
      ...
      <div class="modal-footer">
        <div class="ui-group-buttons">
          <button type="button" id="btnAksiDelRiwayat" class="btn btn-labeled btn-danger btnAksiDelRiwayat"
