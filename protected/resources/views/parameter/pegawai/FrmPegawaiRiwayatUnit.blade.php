<div id="ModalRiwayatUnit" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frmModalRiwayatUnit" name="frmModalRiwayatUnit" class="form-horizontal" autocomplete='off' action=""
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control" id="nama_pegawai_riwayat_unit" name="nama_pegawai_riwayat_unit"
                readonly>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <select class="form-control select2 cb_unit_riwayat" name="cb_unit_riwayat" id="cb_unit_riwayat"></select>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <div class="col-sm-4">
                <label class="radio-inline">
                  <input class="checkLevelJabatan" type="radio" name="checkLevelJabatan" id="checkLevelJabatan"
                    value="0"> Kepala Dinas/Badan/Sederajat</label>
              </div>
              <div class="col-sm-4">
                <label class="radio-inline">
                  <input class="checkLevelJabatan" type="radio" name="checkLevelJabatan" id="checkLevelJabatan"
                    value="1"> Kepala Bidang/Bagian/Sederajat</label>
              </div>
              <div class="col-sm-4">
                <label class="radio-inline">
                  <input class="checkLevelJabatan" type="radio" name="checkLevelJabatan" id="checkLevelJabatan"
                    value="2"> Kepala Seksi/SubBagian/Sederajat</label>
              </div>
            </div>
          </div>
          <div class="form-group ">
            ...
            <div class="col-sm-8">
              <select class="form-control select2 cb_jabatan_riwayat_unit" name="cb_jabatan_riwayat_unit"
                id="cb_jabatan_riwayat_unit"></select>
            </div>
          </div>
          <div class="form-group">
            <label for="nama_eselon3_text" class="col-sm-3 control-label" align='left'></label>
            <div class="col-sm-8">
              <textarea type="text" class="form-control" rows="3" id="nama_eselon3_text" name="nama_eselon3_text"
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control datepicker" id="tmt_unit_x" name="tmt_unit_x"
        ...
        <div class="row">
          ...
          <div class="col-sm-10 text-right">
            <div class="ui-group-buttons">
              <button id="btnSimpanRiwayatUnit" type="button" class="btn btn-success btn-labeled btnSimpanRiwayatUnit"
                data-dismiss="modal">
...
<div id="HapusRiwayat" class="modal fade" role="dialog" tabindex="-1" data-focus-on="input:first"
  data-backdrop="static">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="alert alert-danger">
          ...
          Yakin akan menghapus Riwayat Kepangkatan Pengawai : <strong><span
              class="nama_unit_pegawai_hapus"></span></strong> ini ?
          <br>
          <br>
          <br>
        </div>
      ...
      <div class="modal-footer">
        <div class="ui-group-buttons">
          <button type="button" id="btnAksiDelRiwayatUnit" class="btn btn-labeled btn-danger btnAksiDelRiwayatUnit"
