$( document ).ready( function () {
  ...
  function LoadPangkat ( id_pegawai ) {
    tblPangkat = $( '#tblRiwayatPangkat' ).DataTable( {
      ...
      "columns": [
        { data: 'urut', sClass: "dt-center" },
        { data: 'tmt_display', sClass: "dt-center" },
        { data: 'pangkat_display' },
        { data: 'action', 'searchable': false, 'orderable': false, sClass: "dt-center" }
      ],
      "order": [ [ 0, 'asc' ] ],
  ...
  $( document ).on( 'click', '.btnTambahPangkat', function () {
    ...
    $( '#cb_golongan' ).val( 0 ).trigger( 'change' );
    $( '#tmt_pangkat' ).val();
    $( '#tmt_pangkat_x' ).val();
    $( '.form-horizontal' ).show();
  ...
  $( document ).on( 'click', '.btnDetailPangkat', function () {
    ...
    $( '#cb_golongan' ).val( data.pangkat_pegawai ).trigger( 'change' );
  ...
  $( document ).on( 'click', '.btnTambahUnit', function () {
    ...
    $( '#cb_unit_riwayat' ).val( 0 ).trigger( 'change' );
    document.frmModalRiwayatUnit.checkLevelJabatan[ 0 ].checked = true;
    $( '#cb_jabatan_riwayat_unit' ).val( 0 ).trigger( 'change' );
  ...
  $( document ).on( 'click', '.btnDetailUnit', function () {
    ...
    $( '#cb_unit_riwayat' ).val( data.id_unit ).trigger( 'change' );
    ...
    $( '#cb_jabatan_riwayat_unit' ).val( data.id_sotk ).trigger( 'change' );
