      ...
      <div class="col-md-12">
        <div class="panel panel-info">
          ...
          <div class="panel-body">
            <div class="add">
              <p><a class="add-indikator btn-labeled btn btn-sm btn-success"><span class="btn-label"><i class="fa fa-plus fa-lg fa-fw"></i></span> Tambah Indikator</a></p>
            </div>
            <br>
...
$(document).on('click', '.add-indikator', function() {
  ...
  document.frmModalIndikator.jenis_indikator[0].checked=true;
  document.frmModalIndikator.sifat_indikator[0].checked=true;
