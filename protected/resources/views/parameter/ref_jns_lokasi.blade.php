      ...
      <div class="col-md-12">
        <div class="panel panel-info">
          <div class="panel-heading">
            <p><h2 class="panel-title"><i class="fa fa-map-marker fa-fw fa-lg text-success"></i> Referensi Jenis Lokasi Non Kewilayahan</h2></p>
          </div>
          ...
          <div class="panel-body">
                <br>
                  ...
                  <div class="">
                  <table id='tblJenisLokasi' class="table display compact table-striped table-bordered table-responsive" cellspacing="0" width="100%">
                        <thead>
                              <tr>
...
@section('scripts')
  <script type="text/javascript" language="javascript" class="init" src="{{ asset('/protected/resources/views/parameter/js/js_jns_lokasi.js')}}"></script>
@endsection
