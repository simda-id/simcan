    ...
    <div class="col-md-12">
      <div class="panel panel-info">
        ...
        <div class="panel-body">
          <form class="form-horizontal" action="#" method="post" role="form" autocomplete='off'
              ...
              <div class="col-sm-9">
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="kode_pemda" name="kode_pemda" readonly
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control" id="nama_pemda" name="nama_pemda"
                        placeholder="Nama Resmi Pemda misal : Pemerintah Kota XXX" readonly>
                    </div>
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="ibukota" name="ibukota"
                        placeholder="Ibukota Pemerintah Daerah">
                    </div>
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="jabatan_kada" name="jabatan_kada"
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="nama_kada" name="nama_kada"
                        placeholder="Nama Lengkap Bupati/Walikota">
                    </div>
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="col-sm-8 form-control" id="nama_sekda" name="nama_sekda"
                        placeholder="Nama Lengkap Sekretaris Daerah">
                    </div>
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control nip" id="nip_sekda_display" name="nip_sekda_display"
                        maxlength="18">
              ...
              <div class="col-sm-6">
                ...
                <div class="col-sm-12">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="nm_unit_perencanaan" name="nm_unit_perencanaan"
                      readonly>
                    <span class="input-group-btn">
                      <button class="btn btn-primary" data-toggle="modal" id="btnCariPerencana"
                        name="btnCariPerencana"><i class="fa fa-search fa-fw"></i></button>
                    </span>
                  </div>
                </div>
                <div class="col-sm-12">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" id="nama_kabappeda" name="nama_kabappeda"
                    placeholder="Nama Lengkap Kepala Badan yang berfungsi perencanaan">
                </div>
                <div class="col-sm-12">
                  <label for="nip_kabappeda" class="" align='left'>NIP Kepala Unit Perencanaan :</label>
                </div>
                <div class="col-sm-12">
                  <input type="text" class="form-control nip" id="nip_kabappeda_display" name="nip_kabappeda_display"
                    maxlength="18">
                ...
                <div class="col-sm-12">
                  <div class="input-group">
                    ...
                    <div class="input-group-btn">
                      <button class="btn btn-primary" data-toggle="modal" id="btnCariKeuangan" name="btnCariKeuangan"><i
                          class="glyphicon glyphicon-search"></i></button>
                    </div>
                  </div>
                </div>
                <div class="col-sm-12">
                  <label for="nama_kabpkad" class="control-label" align='left'>Nama Kepala Unit Pengelola Keuangan
                    :</label>
                </div>
                <div class="col-sm-12">
                  <input type="text" class="form-control" id="nama_kabpkad" name="nama_kabpkad"
                    placeholder="Nama Lengkap Kepala Badan yang mengelola keuangan daerah">
                </div>
                <div class="col-sm-12">
                  <label for="nip_kabpkad" class="" align='left'>NIP Kepala Unit Pengelola Keuangan :</label>
                </div>
                <div class="col-sm-12">
                  <input type="text" class="form-control nip" id="nip_kabpkad_display" name="nip_kabpkad_display"
                    maxlength="18">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="panel panel-info">
        <div class="panel-body">
          <div class="col-sm-12">
            <label for="" class="control-label" align='left'>Registered to : {{Session::get('xPemda')}} , Rilis :
              {{Session::get('versiApp')}}
            </label>
          </div>
        </div>
      </div>
        ...
        <form class="form-horizontal" role="form" autocomplete='off' action="" method="" onsubmit="return false;">
          <div class="form-group">
            <div class="col-sm-12">
              ...
              <table id='tblUnit' class="table display table-striped table-bordered compact table-responsive"
