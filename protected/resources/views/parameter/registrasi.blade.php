        ...
        <div class="wrapper fadeInDown">
            <div id="formContent">
                ...
                <form class="form-horizontal" action="#" method="post" role="form" autocomplete='off'
                    enctype="multipart/form-data" onsubmit="return false;"><input type="hidden" name="_token"
                        value="{{ csrf_token() }}">
                    <div class="form-group">
                        <label for="name" class="fadeIn second">
                            <h4>Aplikasi ini akan diregistrasi atas
                                nama : </h4>
                        </label>
                        {{-- @foreach($data as $row) --}}
                        <div class="">
                            <input type="text" class="form-control fadeIn third" id="nama_pemda" name="nama_pemda"
                    ...
                    <div class="form-group text-center">
                        <button type="button" id="btnRegPemda" class="btn btn-success btn-lg">
                            Registrasi Pemda</button>
                    </div>
                </form>
