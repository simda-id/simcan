        ...
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-lg-2 text-right">
                    <a href="{{url('sotk')}}" id="btnBatal" type="button" class="btn btn-sm btn-danger btn-labeled">
...
<style type="text/css">
    ...
    .orgchart .level1 .title {
        background-color: #006699;
    }

    .orgchart .level1 .content {
        border-color: #006699;
    }

    .orgchart .level2 .title {
        background-color: #009933;
    }

    .orgchart .level2 .content {
        border-color: #009933;
    }

    .orgchart .level3 .title {
        background-color: #993366;
    }

    .orgchart .level3 .content {
        border-color: #993366;
    }

    .orgchart .level4 .title {
        background-color: #996633;
    }

    .orgchart .level4 .content {
        border-color: #996633;
    }

    .orgchart .level5 .title {
        background-color: #cc0066;
    }

    .orgchart .level5 .content {
        border-color: #cc0066;
    }
</style>
@endsection
