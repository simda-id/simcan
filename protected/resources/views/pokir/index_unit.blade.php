    ...
    <div class="col-md-12">
      <div class="panel panel-primary">
        <div class="panel-heading">
          <p>
            <h2 class="panel-title">Tindak Lanjut Data Pokok-Pokok Pikiran DPRD</h2>
          </p>
        </div>
        <div class='panel-body'>
          <form name="" class="form-horizontal" role="form" autocomplete='off' action="" method="post">
            ...
            <div class="form-group">
              ...
              <a class="btn btn-labeled btn-info printPokir" data-toggle="modal"><span class="btn-label"><i
                    class="fa fa-print fa-fw fa-lg"></i></span> Cetak Pokok-Pokok Pemikiran</a>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <a id="btnProses" type="button" class="btn btn-success btn-labeled"><span class="btn-label"><i
                      class="fa fa-download fa-fw fa-lg"></i></span> Load Data Usulan</a>
                <a id="btnUnLoad" type="button" class="btn btn-danger btn-labeled"><span class="btn-label"><i
                      class="fa fa-chain-broken fa-fw fa-lg"></i></span> Unload Data Usulan</a>
                <a id="btnPosting" type="button" class="btn btn-primary btn-labeled"><span class="btn-label"><i
                      class="fa fa-check-square-o fa-fw fa-lg"></i></span> Posting Data Usulan</a>
              </div>
            </div>
          </form>
      ...
      <div class="modal-body">
        <form name="frmModalUsulan" class="form-horizontal" role="form" autocomplete='off' action="" method="post"
          ...
          <div class="form-group">
            ...
            <div class="col-sm-2">
              <input type="text" class="form-control nomor" id="no_urut_usulan" name="no_urut_usulan"
          ...
          <div class="form-group">
            ...
            <div class="col-sm-2">
              <input type="text" class="form-control" id="id_satuan_usulan" name="id_satuan_usulan"
                style="text-align: center;" readonly>
            </div>
            <div class="col-sm-3">
              <input type="text" class="form-control number hidden" id="pagu_usulan" name="pagu_usulan"
                style="text-align: right;" readonly>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-2">
              <input type="text" class="form-control number" id="volume_usulan_tl" name="volume_usulan_tl"
                style="text-align: right;">
            </div>
            <div class="col-sm-2">
              <input type="text" class="form-control" id="id_satuan_usulan_tl" name="id_satuan_usulan_tl"
                style="text-align: center;" readonly>
            </div>
            <div class="col-sm-3">
              <input type="text" class="form-control number" id="pagu_usulan_tl" name="pagu_usulan_tl"
                style="text-align: right;">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <input type="text" class="form-control" id="kecamatan" name="kecamatan" style="text-align: center;"
                readonly>
            </div>
            <div class="col-sm-3">
          ...
          <div class="form-group">
            ...
            <span class="btn btn-primary" id="btnCariAktivitas" name="btnCariAktivitas"><i
        ...
        <div class="row">
          ...
          <div class="col-sm-10 text-right">
            <div class="ui-group-buttons">
              <button id="btnUsulan" type="button" class="btn btn-sm btn-success btn-labeled" data-dismiss="modal"><span
...
<div id="ModalCariAktivitas" class="modal fade" role="dialog" tabindex="-1" data-focus-on="input:first"
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" autocomplete='off' action="" method="">
          <div class="form-group">
            <div class="col-sm-12">
              <table id='tblCariAktivitas' class="table display table-striped table-bordered" cellspacing="0"
                width="100%">
                <thead>
                  <tr>
...
$('#tblCariAktivitas tbody').on( 'dblclick', 'tr', function () {
    ...
    document.getElementById("id_aktivitas_renja").value = data.id_aktivitas_pd;
    document.getElementById("id_aktivitas_forum").value = data.id_aktivitas_pd;
