...
@section("content")
  <div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <?php
                $this->title = "Data Program RKPD - PPAS";
      ...
      <div class="col-md-12">
        <div class="panel panel-info">
          <div class="panel-heading">
            <h2 class="panel-title">Daftar Program RKPD - PPAS</h2>
          </div>
          <div class="panel-body">
              <form name="" class="form-horizontal" role="form" autocomplete="off" action="" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-2"><input class="form-control text-center" type=text id="tahun_rkpd" name=tahun_rkpd value="{{Session::get('tahun')}}" disabled></div>
                  </div>
                  <div class="form-group">
                      <label for="id_dokumen_keu" class="control-label col-sm-3 text-left" for="id_dokumen_keu">Nomor Dokumen PPAS :</label>
          ...
          <div class="tabs-x tabs-above tab-bordered tabs-krajee">
            <ul class="nav nav-tabs" role="tablist">
              <li class="active"><a href="#program" aria-controls="program" role="tab" data-toggle="tab">Program RKPD - PPAS</a></li>
              <li class="disabled"><a href="#indikator" aria-controls="indikator" role="tab-kv" data-toggle="tab">Indikator Program RKPD - PPAS</a></li>
              <li class="disabled"><a href="#urusan" aria-controls="urusan" role="tab-kv" data-toggle="tab">Urusan Pemerintahan RKPD - PPAS</a></li>
              <li class="disabled"><a href="#pelaksana" aria-controls="pelaksana" role="tab-kv" data-toggle="tab">Pelaksana Program RKPD - PPAS</a></li>
            </ul>
            <div class="tab-content">
              <div role="tabpanel" class="tab-pane fade in active" id="program">
              <br>              
              <div>
                <a id="btnTambahProg" class="add-programrkpd btn btn-labeled btn-success" data-toggle="popover" data-html="true" data-container="body" title="Penyususan PPAS " data-trigger="hover" data-content="Program baru yang belum ada di RKPD">
              ...
              <table id="tblProgramRKPD" class="table display table-responsive table-striped compact table-bordered"  cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th rowspan="2" style="text-align: center; vertical-align:middle">Uraian Program RKPD - PPAS</th>
              ...
              <div class="divAddIndikator">
                <p>
                  <a id="btnTambahIndikator" class="add-indikator btn btn-labeled btn-success" data-toggle="popover" data-html="true" data-container="body" title="Penyusunan PPAS" data-trigger="hover" data-content="Indikator baru yang belum ada di RKPD, namun menjadi indikator program pada RKPD tahun berjalan"><span class="btn-label"><i class="fa fa-plus fa-fw fa-lg"></i></span> Tambah Indikator</a>
                  <a id="btnReviuIndikator" class="btn btn-labeled btn-primary" data-toggle="popover" data-html="true" data-container="body" title="Penyusunan PPAS" data-trigger="hover" data-content="Melakukan Reviu Terhadap Data Indikator secara sekaligus atau sesuai pilihan"><span class="btn-label"><i class="fa fa-check-square-o fa-fw fa-lg"></i></span> Reviu Indikator</a>
                </p>
              </div>
              ...
              <div class="">
                <table class="table table-striped table-bordered table-responsive">
                  <tbody>
                    ...
                    <tr>
                      <td width="15%" style="text-align: left; vertical-align:top;">Program RKPD - PPAS</td>
              ...
              <div class="divAddPelaksana">
                <p>
                  <a id="btnBackUrusan" class="btn btn-warning hidden" data-toggle="popover" data-html="true" data-container="body" title="Penyusunan PPAS" data-trigger="hover" data-content="Kembali ke Tabel Urusan"><i class="fa fa-arrow-left fa-fw fa-lg"></i></a>
                  <a id="btnTambahPelaksana" class="add-pelaksana btn btn-labeled btn-success" data-toggle="popover" data-html="true" data-container="body" title="Penyusunan PPAS" data-trigger="hover" data-content="Perangkat Daerah Pelaksana selain yang telah ditetapkan di RKPD"><span class="btn-label"><i class="fa fa-plus fa-fw fa-lg"></i></span> Tambah Pelaksana</a>
                  <a id="btnReviuPelaksana" class="btn btn-labeled btn-primary" data-toggle="popover" data-html="true" data-container="body" title="Penyusunan PPAS" data-trigger="hover" data-content="Melakukan Reviu Terhadap Data Pelaksana secara sekaligus atau sesuai pilihan"><span class="btn-label"><i class="fa fa-check-square-o fa-fw fa-lg"></i></span> Reviu Pelaksana</a>
                </p>
              </div>
              <form class="form-horizontal" role="form" autocomplete="off" action="" method="" >
              <div class="">
...
@include("ppas.program_rkpd");
@include("ppas.indikator_program_rkpd");
@include("ppas.urusan_program_rkpd");
@include("ppas.pelaksana_program_rkpd");

@include("ppas.cariIndikator");
@include("ppas.cariProgramRPJMD");
@include("ppas.cariRefUnit");
@include("ppas.StatusProgram");

@endsection

@section("scripts")
    <script src="{{ asset('/protected/resources/views/ppas/js/js_rkpd.js')}}"></script>
@endsection
