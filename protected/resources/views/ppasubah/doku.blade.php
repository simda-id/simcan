...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
      <?php
                $this->title = 'Dokumen Proritas dan Plafond Anggaran Sementara (PPAS) Perubahan';
    ...
    <div class="col-md-12">
      <div class="panel panel-info">
        <div class="panel-heading">
          <p>
            <h2 class="panel-title">Dokumen Proritas dan Plafond Anggaran Sementara (PPAS) Perubahan</h2>
          </p>
        </div>
          ...
          <div class='tabs-x tabs-above tab-bordered tabs-krajee'>
            ...
            <ul class="nav nav-tabs" role="tablist">
              <li class="active"><a href="#dokumen" aria-controls="dokumen" role="tab" data-toggle="tab">Dokumen
                  PPAS</a></li>
              <li><a href="#rekap" aria-controls="rekap" role="tab-kv" data-toggle="tab">Rekapitulasi PPAS Perubahan</a>
              </li>
            </ul>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal" autocomplete='off' action="" method="post" onsubmit="return false;">
            ...
            <div class="form-group">
              <label class="control-label col-sm-3" for="title">Dokumen RKPD Perubahan :</label>
              <div class="col-sm-8">
  ...
  <div id="HapusDokumen" class="modal fade" role="dialog" tabindex="-1" data-focus-on="input:first"
    ...
    <div class="modal-dialog modal-xs">
      <div class="modal-content">
        <div class="modal-header">
          <h4>Hapus Dokumen Proritas dan Plafond Anggaran Sementara (PPAS) Perubahan</h4>
        </div>
        <div class="modal-body">
  ...
  <div id="StatusProgram" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-xs">
      <div class="modal-content">
        <div class="modal-header">
          <h4 style="text-align: center;">Perubahan Status Proritas dan Plafond Anggaran Sementara (PPAS) Perubahan</h4>
        </div>
        <div class="modal-body">
          ...
          <div class="alert alert-success">
            <div>
              ...
              <p>Yakin akan melakukan proses <strong><i><span id="ur_status_dokumen_posting"></span></i></strong> pada
                Dokumen Proritas dan Plafond Anggaran Sementara (PPAS) Perubahan Tahun <strong><span
  ...
  <script type="text/javascript" language="javascript" class="init"
    src="{{ asset('/protected/resources/views/ppasubah/js/js_doku.js')}}"> </script>
  @endsection