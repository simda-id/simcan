$( document ).ready( function () {
  ...
  $.ajax( {
    type: "GET",
    url: 'ppasubah/getDataDokReferensi' + vars,
    dataType: "json",
  ...
  var dokumen_tbl = $( '#tblDokumen' ).DataTable( {
    ...
    serverSide: true,
    "autoWidth": false,
    "ajax": { "url": "./ppasubah/getDataDokumen" },
    "language": {
      "decimal": ",",
      "thousands": "."
    },
  ...
  function loadTblRekapPPAS ( id_dokumen_keu ) {
    ...
    TblRekapPPAS = $( '#tblRekapPPAS' ).DataTable( {
      ...
      dom: 'BfRtip',
      autoWidth: false,
      "ajax": { "url": "./ppasubah/getDataRekap" + vars },
      "language": {
        "decimal": ",",
        "thousands": "."
      },
