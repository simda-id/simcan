...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
      <?php
        $this->title = 'Data Program Renja - PPAS Perubahan';
                  ...
                  <div class="add hidden">
                    <button id="btnPostingProgRKPD" type="button"
                      class="post-ProgRKPD btn btn-labeled btn-primary"><span class="btn-label"><i
                          class="fa fa-plus fa-fw fa-lg"></i></span>Posting Program RKPD - PPAS</button>
                  </div>
...
@include('ppasubah.program_pd')
@include('ppasubah.program_indikator_pd')
@include('ppasubah.kegiatan_pd')
@include('ppasubah.kegiatan_indikator_pd')
@include('ppasubah.pelaksana_pd')
@include('ppasubah.aktivitas_pd')
@include('ppasubah.lokasi_pd')
@include('ppasubah.belanja_pd')

@include('ppasubah.cariProgramRenstra')
@include('ppasubah.cariKegiatanRenstra')
@include('ppasubah.cariProgramRef')
@include('ppasubah.cariKegiatanRef')
@include('ppasubah.cariIndikator')
@include('ppasubah.cariSubUnit')
@include('ppasubah.cariAktivitasASB')
@include('ppasubah.cariLokasiModal')
@include('ppasubah.cariLokasiTeknisModal')
@include('ppasubah.cariItemSSH')
@include('ppasubah.cariRekening')
@include('ppasubah.ModalCopyBelanja')
@include('ppasubah.loadBelanjaASB')

@endsection

@section('scripts')
<script src="{{ asset('/protected/resources/views/ppasubah/js/js_penyesuaian_pd.js')}}"></script>
@endsection