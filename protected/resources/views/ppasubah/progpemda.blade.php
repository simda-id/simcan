...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
      <?php
                $this->title = "Data Program RKPD - PPAS Perubahan";
    ...
    <div class="col-md-12">
      <div class="panel panel-info">
        <div class="panel-heading">
          <h2 class="panel-title">Daftar Program RKPD - PPAS Perubahan</h2>
        </div>
        <div class="panel-body">
          <form name="" class="form-horizontal" role="form" autocomplete="off" action="" method="post">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2"><input class="form-control text-center" type=text id="tahun_rkpd" name=tahun_rkpd
                  value="{{Session::get('tahun')}}" disabled></div>
            </div>
            <div class="form-group">
          ...
          <div class="tabs-x tabs-above tab-bordered tabs-krajee">
            ...
            <div class="tab-content">
              <div role="tabpanel" class="tab-pane fade in active" id="program">
                ...
                <div>
                  <a id="btnTambahProg" class="add-programrkpd btn btn-labeled btn-success" data-toggle="popover"
                    data-html="true" data-container="body" title="Penyususan PPAS " data-trigger="hover"
                  ...
                  <table id="tblProgramRKPD" class="table display table-responsive table-striped compact table-bordered"
                    ...
                    <thead>
                      <tr>
                        ...
                        <th rowspan="2" style="text-align: center; vertical-align:middle">Uraian Program RKPD - PPAS
                        </th>
              ...
              <div role="tabpanel" class="tab-pane fade in" id="indikator">
                ...
                <div class="divAddIndikator">
                  <p>
                    <a id="btnTambahIndikator" class="add-indikator btn btn-labeled btn-success" data-toggle="popover"
                      data-html="true" data-container="body" title="Penyusunan PPAS" data-trigger="hover"
                      data-content="Indikator baru yang belum ada di RKPD, namun menjadi indikator program pada RKPD tahun berjalan"><span
                ...
                <div class="">
                  <table id="tblIndikatorRKPD"
                    class="table display table-striped compact table-bordered table-responsive" cellspacing="0"
                    width="100%">
                    <thead>
                      <tr>
              ...
              <div role="tabpanel" class="tab-pane fade in" id="urusan">
                ...
                <div class="">
                  <table id="tblUrusanRKPD" class="table display table-striped table-bordered table-responsive"
                    cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        {{-- <th></th> --}}
              ...
              <div role="tabpanel" class="tab-pane fade in" id="pelaksana">
                    ...
                    <table class="table table-striped table-bordered table-responsive">
                      ...
                      <td style="text-align: left; vertical-align:top;"><label id="nm_program_rpjmd_pelaksana" align="left"></label></td>
                        ...
                        <tr class="backUrusan">
                          ...
                          <td style="text-align: left; vertical-align:top;"><label id="nm_urusan_pelaksana"
                              align="left"></label></td>
                        </tr>
                        <tr class="backUrusan">
                          <td width="15%" style="text-align: left; vertical-align:top;">Bidang</td>
                          <td style="text-align: left; vertical-align:top;"><label id="nm_bidang_pelaksana"
                              align="left"></label></td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <div class="">
                  <table id="tblPelaksanaRKPD" class="table display table-striped compact table-bordered"
                    cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th width="5%" style="text-align: center; vertical-align:middle">Pilih</th>
...
@include("ppasubah.program_rkpd");
@include("ppasubah.indikator_program_rkpd");
@include("ppasubah.urusan_program_rkpd");
@include("ppasubah.pelaksana_program_rkpd");

@include("ppasubah.cariIndikator");
@include("ppasubah.cariProgramRPJMD");
@include("ppasubah.cariRefUnit");
@include("ppasubah.StatusProgram");

@endsection

@section("scripts")
<script src="{{ asset('/protected/resources/views/ppasubah/js/js_rkpd.js')}}"></script>
@endsection