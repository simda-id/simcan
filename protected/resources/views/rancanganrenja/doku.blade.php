          ...
          <div class="panel-body">
                <form class="form-horizontal" role="form" autocomplete='off' action="#" method="" >
                  <div class="form-group">
                    <label for="tahun_rkpd_main" class="col-sm-2 control-label text-left" align='left'>Tahun Perencanaan :</label>
                      <div class="col-sm-2">                            
...
@section('scripts')
  <script type="text/javascript" language="javascript" class="init" src="{{ asset('/protected/resources/views/rancanganrenja/js_doku.js')}}"></script>
@endsection
