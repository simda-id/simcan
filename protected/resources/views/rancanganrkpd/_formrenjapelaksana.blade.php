...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group{{ $errors->has('pagu_aktivitas_sebelumnya') ? ' has-error' : '' }}">
            <label for="name" class="col-md-4">Pagu Sebelumnya</label>

            <div class="col-md-8">
                <input type="text" class="form-control" name="pagu_aktivitas_sebelumnya" value="{{ isset($model['pagu_aktivitas_sebelumnya']) ? $model['pagu_aktivitas_sebelumnya'] : '' }}">

                @if ($errors->has('pagu_aktivitas_sebelumnya'))
                    <span class="help-block">
                        <strong>{{ $errors->first('pagu_aktivitas_sebelumnya') }}</strong>
                    </span>
                @endif
            </div>
        </div>    
