...
<script id="details-inKeg" type="text/x-handlebars-template">
  ...
  @include('rancanganrkpd.program_pd')
  @include('rancanganrkpd.program_indikator_pd')
  @include('rancanganrkpd.kegiatan_pd')
  @include('rancanganrkpd.kegiatan_indikator_pd')
  @include('rancanganrkpd.pelaksana_pd')
  @include('rancanganrkpd.aktivitas_pd')
  @include('rancanganrkpd.lokasi_pd')
  @include('rancanganrkpd.belanja_pd')

  @include('rancanganrkpd.cariProgramRenstra')
  @include('rancanganrkpd.cariKegiatanRenstra')
  @include('rancanganrkpd.cariProgramRef')
  @include('rancanganrkpd.cariKegiatanRef')
  @include('rancanganrkpd.cariIndikator')
  @include('rancanganrkpd.cariSubUnit')
  @include('rancanganrkpd.cariAktivitasASB')
  @include('rancanganrkpd.cariLokasiModal')
  @include('rancanganrkpd.cariLokasiTeknisModal')
  @include('rancanganrkpd.cariItemSSH')
  @include('rancanganrkpd.cariRekening')
  @include('rancanganrkpd.ModalCopyBelanja')
  @include('rancanganrkpd.loadBelanjaASB')

@endsection

@section('scripts')
  @include('rancanganrkpd.js_penyesuaian_pd')
@endsection