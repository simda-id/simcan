...
@include('rancanganrkpd.program_rkpd');
@include('rancanganrkpd.indikator_program_rkpd');
@include('rancanganrkpd.urusan_program_rkpd');
@include('rancanganrkpd.pelaksana_program_rkpd');

@include('rancanganrkpd.cariIndikator');
@include('rancanganrkpd.cariProgramRPJMD');
@include('rancanganrkpd.cariRefUnit');
@include('rancanganrkpd.StatusProgram');

@endsection

@section('scripts')

@include('rancanganrkpd.js_rancangan_rkpd')
@endsection
