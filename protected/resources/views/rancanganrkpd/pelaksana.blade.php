        ...
        <div class='tabs-x tabs-above tab-bordered tab-height-md tabs-krajee'>
            ...
            <div id="myTabContent-6" class="tab-content">
                <div class="tab-pane fade in active" id="unitpelaksana">
                    <div class="row">
                        <div class="col-md-12">
                            <a class="btn btn-primary btn-xs" href="#" data-href="{{ url('/rancanganrkpd/'.$title[1].'/'.$rkpd->id_rkpd_rancangan.'/pelaksana/tambah') }}" data-toggle="modal" data-target="#myModal" data-title="Tambah Pelaksana RKPD"><i class="glyphicon glyphicon-plus bg-white"></i> Tambah</a>
                            <table id="pelaksana-table" class="table table-striped table-bordered table-responsive">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: right; vertical-align:middle">Sebelumnya</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right; vertical-align:middle"> {{ number_format($data->pagu_aktivitas_forum, 0, ',', '.') }} </td>
                                        <td style="text-align: right; vertical-align:middle"> {{ number_format($data->pagu_aktivitas_sebelumnya, 0, ',', '.') }} </td>
                                        <td>
                                            <div class="btn-group" role="group">
                                                 <a id="rincian-{{ $data->id_pelaksana_rkpd }}" class="btn btn-default btn-xs" data-href="{{ url('/rancanganrkpd/'.$title['1'].'/'.$data->id_rkpd_rancangan.'/pelaksana/'.$data->id_pelaksana_rkpd.'/belanja') }}" ><i class="glyphicon glyphicon-menu-right bg-white"></i> Belanja</a>
                                                {{ Form::open(['method' => 'DELETE', 'url' => '/rancanganrkpd/'.$title[1].'/'.$data->id_rkpd_rancangan.'/pelaksana/'.$data->id_pelaksana_rkpd.'/delete', 'onsubmit' => 'return confirm(\'Anda Yakin?\');']) }}
                ...
                <div class="tab-pane fade" id="indikator">
                    <div class="row">
                        <div class="col-md-12">
                            <!--<a class="btn btn-primary btn-xs" href="#" data-href="{{ url('/rancanganrkpd/'.$title[1].'/'.$rkpd->id_rkpd_rancangan.'/indikator/tambah') }}" data-toggle="modal" data-target="#myModal" data-title="Tambah Indikator RKPD"><i class="glyphicon glyphicon-plus bg-white"></i> Tambah</a>-->
