        ...
        <div class='tabs-x tabs-above tab-bordered tab-height-md tabs-krajee'>
            ...
            <div id="myTabContent-6" class="tab-content">
                <div class="tab-pane fade in active" id="belanjadaftar">
                    <div class="row">
                        <div class="col-md-12">
                            <a class="btn btn-primary btn-xs" href="#" data-href="{{ url('/rancanganrkpd/'.$title[1].'/'.$rkpd->id_rkpd_rancangan.'/pelaksana/'.$pelaksana->id_pelaksana_rkpd.'/belanja/tambah') }}" data-toggle="modal" data-target="#myModal" data-title="Tambah Belanja RKPD"><i class="glyphicon glyphicon-plus bg-white"></i> Tambah</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                {{ Form::open(['method' => 'DELETE', 'url' => '/rancanganrkpd/'.$title[1].'/'.$rkpd->id_rkpd_rancangan.'/pelaksana/'.$data->id_pelaksana_rkpd.'/delete', 'onsubmit' => 'return confirm(\'Anda Yakin?\');']) }}
