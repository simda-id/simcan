      ...
      <div class="col-md-12">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h2 class="panel-title">Detail Usulan Rancangan Akhir RKPD</h2>
          </div>
          ...
          <table class="table table-condensed" cellspacing="0" width="100%">
            ...
            <tr>
              <td > <label>Program RKPD</label></td>
              <td> : </td>
              <td>Program pengadaan sarana dan prasarana pendidikan dasar</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td> : </td>
              <td>Pembangunan Sarana Pendidikan Sekolah Dasar</td>
            </tr>
            <tr>
                                      ...
                                      <a class="btn dropdown-toggle btn-primary btn-xs" data-toggle="dropdown" aria-hidden="true">
                                       Review<span class="caret"></span></a>
                                        <ul class="dropdown-menu dropdown-menu-action" role="menu">
                                          <li><a title="persetujuan" href=""><i class="fa fa-send"></i>Persetujuan Usulan</a></li>
                                          <li class="divider"></li>
                                          <li><a title="edit_data" data-toggle="modal" class="edit_data" data-id="" data-target="#PelaksanaModal" {{-- href="{{url('/forumskpd/tambah')}}" --}}><i class="fa fa-pencil"></i>Edit Data Pelaksana</a></li>
                                          <li><a title="edit_lokasi" data-toggle="modal" class="edit_lokasi" data-id="" data-target="#LokasiModal" {{-- href="{{url('/forumskpd/tambah')}}" --}}><i class="fa fa-pencil"></i>Edit Data Lokasi</a></li>
                                        </ul>    
                                  </div>
                                  </div>
                                </th>
          ...
          <div class="panel-footer">
            ...
            <div class="back">
                <a href="{{url('/ranhirrkpd')}}">
                <button class="btn btn-sm btn-danger" id="btn-back">
                <i class="glyphicon glyphicon-home" aria-hidden="true"></i> Kembali</button></a>
            </div>
          </div>
      ...
      <div class="modal-body">
        <form class="form-horizontal" autocomplete='off' 
          ...
          <div class="form-group">
            ...
            <div class="col-sm-7">
              <textarea rows="5" class="form-control" id="txt_diskripsi_aktivitas" name="diskripsi_aktivitas" required="required"></textarea>
            </div>
          </div>  
