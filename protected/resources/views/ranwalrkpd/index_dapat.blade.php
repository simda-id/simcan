    ...
    <div class="row">
        <div class="col-md-12">
            <?php
                ...
                $breadcrumb->add(['label' => 'Pendapatan Daerah']);
                $breadcrumb->end();
            ?>
        <div id="pesan"></div>          
        </div>
      ...
      <div class="col-md-12">
        <div class="panel panel-info">
          <div class="panel-heading">
            <h2 class="panel-title">Daftar Usulan Program Pendapatan Daerah Rancangan Awal RKPD</h2>
          </div>
    ...
    <div class="modal-dialog modal-xs">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="alert alert-danger">
              <p><i class="fa fa-exclamation-triangle fa-2x fa-pull-left text-danger"  aria-hidden="true"></i>
    ...
    <div class="modal-dialog modal-xs">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="alert alert-danger">
              <i class="fa fa-exclamation-triangle fa-3x fa-pull-left text-danger"  aria-hidden="true"></i>
...
$('#no_urut_program').number(true,0,',', '.');
  ...
  var progrkpd = $('#tblProgramRKPD').DataTable( {
        ...
        serverSide: true,
          deferRender: true,
        "autoWidth": false,
        "ajax": {"url": "blangsung/getDataDapat"},
        "language": {
                "decimal": ",",
                "thousands": "."},
        "columns": [
