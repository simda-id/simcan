    ...
    <div class="row">
        <div class="col-md-12">
            <?php
                ...
                $breadcrumb->add(['label' => 'Pendapatan Renja']);
                $breadcrumb->end();
            ?>          
        </div>
    </div>
                    ...
                    <br>
                            <div role="tabpanel" class="tab-pane fade in active" id="program">
                              <div class="table-responsive">
                                <div class="col-md-12">
                                    <table id="tblProgram" class="table table-striped display compact table-bordered" width="100%">
                                        <thead>
                                            <tr>
                            ...
                            <div role="tabpanel" class="tab-pane fade in" id="kegiatan">
                                  ...
                                  <div class="table-responsive">
                                    <table id="tblKegiatanRenja" class="table table-striped display compact table-bordered" width="100%">
                                        <thead>
                                            <tr>
                            ...
                            <div role="tabpanel" class="tab-pane fade in" id="aktivitas">
                                  ...
                                  <div class="table-responsive">
                                    <table id="tblAktivitas" class="table table-striped display compact table-bordered" width="100%">
                                        <thead>
                                            <tr>
                              ...
                              <div role="tabpanel" class="tab-pane fade in" id="pelaksana">
                                  ...
                                  <div class="table-responsive">
                                    <table id="tblPelaksana" class="table table-striped display compact table-bordered" width="100%">
                                        <thead>
                                            <tr>
                                                <th rowspan="2" width='5%' style="text-align: center; vertical-align:middle">No Urut</th>
                                ...
                                <div role="tabpanel" class="tab-pane fade in" id="lokasi">
                                  ...
                                  <div class="table-responsive">
                                    <table id="tblLokasi" class="table table-striped display compact table-bordered" width="100%">
                                        <thead>
                                            <tr>
                                                <th rowspan="2" width='5%' style="text-align: center; vertical-align:middle">No Urut</th>
                            ...
                            <div role="tabpanel" class="tab-pane fade in" id="belanja">
                                  ...
                                  <div class="table-responsive">
                                    <table id="tblBelanja" class="table table-striped display compact table-bordered" width="100%">
                                        <thead>
                                            <tr>
                                                <th rowspan="2" width='5%' style="text-align: center; vertical-align:middle">No Urut</th>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form name="frmModalBelanja" class="form-horizontal" role="form" autocomplete='off' action="" method="post" onsubmit="return false;">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-3" for="title">Uraian Belanja :</label>
                    <div class="col-sm-8">
                ...
                <div class="col-sm-12">
                    <table class="table table-bordered compact" width="100">
                        <thead style="background-color: #428bca; color:#fff;">
                          <tr>
                            <td width="25%" style="text-align: center; vertical-align:top;"><strong>Volume 1</strong></td>
                            <td width="25%" style="text-align: center; vertical-align:top;"><strong>Volume 2</strong></td>
                            <td style="text-align: center; vertical-align:top;"><strong>Harga Satuan & Jumlah</strong></td>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                              ...
                              <td style="text-align: right; vertical-align:middle;">
                                  <input type="text" class="form-control number" id="harga_satuan" name="harga_satuan" style="text-align: right; vertical-align:top;" >
                              </td>
                          </tr>
                          <tr>
                              <td width="25%" style="text-align: left; vertical-align:top;">
                                <select class="form-control id_satuan1" name="id_satuan1" id="id_satuan1" required="required"></select>
                              </td>                          
                              <td width="25%" style="text-align: left; vertical-align:top;">
                                <select class="form-control id_satuan2" name="id_satuan2" id="id_satuan2" required="required"></select>
                              </td>
                              <td style="text-align: right; vertical-align:middle;">
                                <input type="text" class="form-control number" id="jumlah_belanja" name="jumlah_belanja" style="text-align: right; vertical-align:top;" disabled>
                              </td>
                          </tr>
                        </tbody>
                    </table>
...
function loadTblProgRenja(tahun,unit){
   prog_renja_tbl=$('#tblProgram').DataTable({
                  ...
                  dom : 'BFRtIp',
                  autoWidth : false,
                  "ajax": {"url": "./blang/getProgramDapatRenja/"+tahun+"/"+unit},
                  "language": {
                      "decimal": ",",
                      "thousands": "."},
                  "columns": [
...
$(document).on('click', '.add-aktivitas', function() {
      ...
      document.frmModalAktivitas.sumber_aktivitas[1].checked=true;
      // document.getElementById("ur_aktivitas_kegiatan").setAttribute("disabled","disabled");
      $('.btnCariASB').hide();
...
function LoadTblRekening(){  
      rekening = $('#tblRekening').DataTable( {
        processing: true,
        serverSide: true,
        dom: 'BfrtIp',
        autoWidth : false,
        "ajax": {"url": "blang/getRekeningDapat"},
        "columns": [
              { data: 'no_urut'},
              { data: 'kd_rekening'},
              { data: 'nm_rekening'}
