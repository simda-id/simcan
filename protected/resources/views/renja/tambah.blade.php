      ...
      <div class="col-md-12">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h2 class="panel-title">Detail Data Kegiatan Rancangan Renja SKPD</h2>
          </div>
    ...
    <!-- <form class="form-horizontal" role="form"> -->
      <div class="modal-body">
        <form class="form-horizontal" autocomplete='off' 
          ...
          <div class="form-group">
            <label for="txt_diskripsi_aktivitas" class="col-sm-3 control-label" align='left' rows='5' type='textarea'>Pembahasan :</label>
            <div class="col-sm-7">
            <select class="form-control" id="id_tahun" name="tahun">
                        <option value="thn1">Musrenbang</option>
                        <option value="thn2">Renja SKPD</option>
            </select> 
            </div>
          </div> 
