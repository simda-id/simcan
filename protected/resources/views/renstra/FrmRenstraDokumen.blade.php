            ...
            <div class="modal-body">
              <form class="form-horizontal" autocomplete='off' action="" method="post" onsubmit="return false;">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                      <select class="form-control cb_ref_rpjmd" name="cb_ref_rpjmd" id="cb_ref_rpjmd"></select>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="text" class="form-control number" id="thn_1_dok" name="thn_1_dok" style="text-align: center;" required="required" readonly disabled>
                  </div>
                  <label for="thn_5_dok" class="col-sm-1 control-label" style="text-align: center;"> s.d </label>
                  <div class="col-sm-2">
                    <input type="text" class="form-control number" id="thn_5_dok" name="thn_5_dok" style="text-align: center;" required="required" readonly disabled>
                  </div>                  
                </div>
                <div class="form-group">
