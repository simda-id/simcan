      ...
      <div class="modal-body">
        <form name="frmModalPelaksana" class="form-horizontal" role="form" autocomplete='off' action="" method="post"
          ...
          <div class="form-group">
            ...
            <div class="col-sm-2">
              <div class="input-group">
                <input type="text" class="form-control number no_urut" id="no_urut_pelaksana_kegiatan"
                  name="no_urut_pelaksana_kegiatan" required="required">
              </div>
            </div>
            <label for="id_perubahan_edit" class="col-sm-3 control-label" align='left'>ID Perubahan :</label>
            <div class="col-sm-2">
              <div class="input-group">
                <input type="text" class="form-control number id_revisi" id="id_perubahan_pelaksana_kegiatan"
                  name="id_perubahan_pelaksana_kegiatan" required="required">
              </div>
            </div>
          </div>
          <div class="form-group div_entry_sub"=id="div_entry_sub">
            ...
            <div class="col-sm-9">
              <select class="form-control select2 cbpelaksana" name="cbpelaksana" id="cbpelaksana"></select>
            </div>
          </div>
...
<div id="HapusKegiatanPelaksanaModal" class="modal fade" role="dialog" data-backdrop="static">
  <div class="modal-dialog modal-xs">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="ui-group-buttons">
          <button type="button" class="btn btn-sm btn-danger btn-labeled btnDelKegiatanPelaksana"
