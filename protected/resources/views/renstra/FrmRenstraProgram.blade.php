        ...
        <div class="modal-body">
          <form class="form-horizontal" role="form" autocomplete='off' action="" method="post" >
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <input type="text" class="form-control number no_urut" id="no_urut_program_edit" name="no_urut_program_edit" required="required"> 
                </div>
                <label for="id_perubahan_program_edit" class="col-sm-2 control-label" style="text-align: right;">ID Perubahan :</label>
                <div class="col-sm-2">
                  <input type="text" class="form-control number id_revisi" id="id_perubahan_program_edit" name="id_perubahan_program_edit" required="required" >  
                </div>
              </div>
              <div class="form-group">
