    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" autocomplete='off' action="" method="post">
          ...
          <input type="hidden" class="form-control" id="id_program_renstra_edit" name="id_program_renstra_edit"
            readonly>
          ...
          <div class="form-group divSasaranRenstra">
            ...
            <div class="col-sm-8">
              <textarea type="name" class="form-control" id="id_sasaran_program_edit" name="id_sasaran_program_edit"
                rows="3" disabled></textarea>
            </div>
            <input type="hidden" class="form-control" id="id_sasaran_renstra_program_edit"
              name="id_sasaran_renstra_program_edit">
            <input type="hidden" class="form-control" id="id_sasaran_rpjmd_program_edit"
              name="id_sasaran_rpjmd_program_edit">
            <input type="hidden" class="form-control" id="id_sasaran_rpjmd_ori_edit" name="id_sasaran_rpjmd_ori_edit">
            <span class="btn btn-primary btnCariSasaranRenstra" id="btnCariSasaranRenstra"
              name="btnCariSasaranRenstra"><i class="fa fa-search fa-fw fa-lg"></i></span>
          </div>
          <div class="form-group">
            <label for="no_urut_edit" class="col-sm-3 control-label" align='left'>Nomor Urut :</label>
            <div class="col-sm-2">
              <input type="text" class="form-control number no_urut" id="no_urut_program_edit"
                name="no_urut_program_edit" required="required">
            </div>
            <label for="id_perubahan_program_edit" class="col-sm-2 control-label" style="text-align: right;">ID
              Perubahan :</label>
            <div class="col-sm-2">
              <input type="text" class="form-control number id_revisi" id="id_perubahan_program_edit"
                name="id_perubahan_program_edit" required="required">
            </div>
          </div>
          <div class="form-group">
            <label for="ur_program_rpjmd_edit" class="col-sm-3 control-label" align='left'>Uraian Program RPJMD
              :</label>
            <div class="col-sm-8">
              <input type="hidden" class="form-control" id="id_program_rpjmd_edit" name="id_program_rpjmd_edit"
                readonly>
              <textarea type="text" class="form-control" rows="3" id="ur_program_rpjmd_edit"
                name="ur_program_rpjmd_edit" required="required" readonly></textarea>
            </div>
            <span class="btn btn-primary btnCariProgramRPJMD" id="btnCariProgramRPJMD" name="btnCariProgramRPJMD"><i
          ...
          <div class="form-group">
            ...
            <span class="btn btn-primary btnCariProgramRef" id="btnCariProgramRef" name="btnCariProgramRef"><i
                class="fa fa-search fa-fw fa-lg"></i></span>
          ...
          <div class="form-group">
            <label for="ur_program_renstra_edit" class="col-sm-3 control-label" align='left'>Uraian Program Renstra
              :</label>
            <div class="col-sm-8">
              <textarea type="text" class="form-control" rows="3" id="ur_program_renstra_edit"
                name="ur_program_renstra_edit" required="required" readonly></textarea>
            </div>
          </div>
          <div class="form-group ">
            <label for="ur_sasaran_program_renstra_edit" class="col-sm-3 control-label" align='left'>Keterangan Program
              Renstra :</label>
            <div class="col-sm-8">
              <textarea type="text" class="form-control" rows="3" id="ur_sasaran_program_renstra_edit"
                name="ur_sasaran_program_renstra_edit" required="required"></textarea>
            </div>
          </div>
            ...
            <tbody>
              <tr>
                ...
                <td width="18%" style="text-align: center; vertical-align:middle">
                  <input type="text" class="form-control number" id="pagu1_edit" name="pagu1_edit"
              ...
              <tr>
                ...
                <td width="18%" style="text-align: center; vertical-align:middle">
                  <input type="text" class="form-control number" id="pagu1_cekkeg" name="pagu1_cekkeg"
                    style="text-align: right; " disabled readonly>
                </td>
                <td width="18%" style="text-align: center; vertical-align:middle">
                  <input type="text" class="form-control number" id="pagu2_cekkeg" name="pagu2_cekkeg"
                    style="text-align: right; " disabled readonly>
                </td>
                <td width="18%" style="text-align: center; vertical-align:middle">
                  <input type="text" class="form-control number" id="pagu3_cekkeg" name="pagu3_cekkeg"
                    style="text-align: right; " disabled readonly>
                </td>
                <td width="18%" style="text-align: center; vertical-align:middle">
                  <input type="text" class="form-control number" id="pagu4_cekkeg" name="pagu4_cekkeg"
                    style="text-align: right; " disabled readonly>
                </td>
                <td width="18%" style="text-align: center; vertical-align:middle">
                  <input type="text" class="form-control number" id="pagu5_cekkeg" name="pagu5_cekkeg"
                    style="text-align: right; " disabled readonly>
                </td>
              </tr>
              <tr>
                ...
                <td colspan="2" style="text-align: right; vertical-align:middle">
                  <input type="text" class="form-control number" id="pagu6_edit" name="pagu6_edit"
                    style="text-align: right; " disabled readonly>
                </td>
              </tr>
              <tr>
                ...
                <td colspan="2" style="text-align: right; vertical-align:middle">
                  <input type="text" class="form-control number" id="pagu6_cekkeg" name="pagu6_cekkeg"
                    style="text-align: right; " disabled readonly>
                </td>
              </tr>
            </tbody>
