      ...
      <div class="col-md-12">
        <div class="panel panel-info">
          ...
          <ul class="nav nav-tabs" role="tablist">
            <li class="active"><a href="#dokumen" aria-controls="dokumen" role="tab" data-toggle="tab">Dokumen Renstra</a></li>
            ...
            <li class="disabled"><a href="#sasaran" aria-controls="sasaran" role="tab" data-toggle="tab">Sasaran</a></li>
            <li class="disabled"><a href="#program" aria-controls="program" role="tab" data-toggle="tab">Program</a></li>
            {{-- <li><a href="#kegiatan" aria-controls="kegiatan" role="tab" data-toggle="tab">Kegiatan</a></li> --}}
            <li class="disabled"><a href="#btl" aria-controls="btl" role="tab" data-toggle="tab">Belanja Non Program</a></li>
            <li class="disabled"><a href="#pendapatan" aria-controls="pendapatan" role="tab" data-toggle="tab">Pendanaan</a></li>
          </ul>
          ...
          <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="dokumen">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                    <a id="btnAddDokumen" type="button" class="btn btn-success btn-labeled btnAddDokumen"><span class="btn-label"><i class="fa fa-plus-square-o fa-fw fa-lg"></i></span> Tambah Dokumen</a>
                </div>
              </div>
              </form>
                ...
                <table class="table table-striped table-bordered">
                  <tbody>
                    <tr class="backDokumen">
                      ...
                      <td style="text-align: left; vertical-align:top;"><label id="no_dokumen_tujuan" align='left'></label></td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered">
                  <tbody>
                    <tr class="backDokumen">
                      <td width="15%" style="text-align: left; vertical-align:top;">Nomor Renstra</td>
                      <td style="text-align: left; vertical-align:top;"><label id="no_dokumen_sasaran" align='left'></label></td>
                    </tr>
                    <tr class="backTujuan">
                      <td width="15%" style="text-align: left; vertical-align:top;">Tujuan Renstra</td>
                      <td style="text-align: left; vertical-align:top;"><label id="uraian_tujuan_sasaran" align='left'></label></td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="disabled"><a href="#strategi" aria-controls="sasaran" role="tab" data-toggle="tab">Strategi</a></li>
                <li class="disabled"><a href="#kebijakan" aria-controls="tujuan" role="tab" data-toggle="tab">Kebijakan</a></li>
            </ul>
            <div class="tab-content">
                  ...
                  <table class="table table-striped table-bordered">
                    <tbody>
                      <tr class="backSasaran1">
                        ...
                        <td style="text-align: left; vertical-align:top;"><label id="uraian_sasaran_kebijakan" align='left'></label></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-bordered">
                    <tbody>
                      <tr class="backSasaran1">
                        <td width="15%" style="text-align: left; vertical-align:top;">Sasaran Renstra</td>
                        <td style="text-align: left; vertical-align:top;"><label id="uraian_sasaran_strategi" align='left'></label></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered">
                  <tbody>
                    <tr class="backDokumen">
                      <td width="15%" style="text-align: left; vertical-align:top;">Nomor Renstra</td>
                      <td style="text-align: left; vertical-align:top;"><label id="no_dokumen_program" align='left'></label></td>
                    </tr>
                    <tr class="backTujuan">
                      <td width="15%" style="text-align: left; vertical-align:top;">Tujuan Renstra</td>
                      <td style="text-align: left; vertical-align:top;"><label id="uraian_tujuan_program" align='left'></label></td>
                    </tr>
                    <tr class="backSasaran">
                      <td width="15%" style="text-align: left; vertical-align:top;">Sasaran Renstra</td>
                      <td style="text-align: left; vertical-align:top;"><label id="uraian_sasaran_program" align='left'></label></td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li class="active"><a href="#program1" aria-controls="kegiatan" role="tab" data-toggle="tab">Program</a></li>
                <li class="disabled"><a href="#kegiatan" aria-controls="kegiatan" role="tab" data-toggle="tab">Kegiatan</a></li>
                <li class="disabled"><a href="#pelaksana" aria-controls="kegiatan" role="tab" data-toggle="tab">Sub Unit Pelaksana</a></li>
            </ul>
            <div class="tab-content">
                ...
                <table class="table table-striped table-bordered">
                  <tbody>
                    <tr class="backProgram">
                      ...
                      <td style="text-align: left; vertical-align:top;"><label id="uraian_program_kegiatan" align='left'></label></td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <table id="tblKegiatan" class="table compact table-responsive table-striped table-bordered display" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      ...
                      <th colspan="6" style="text-align: center; vertical-align:middle">Pagu Kegiatan per Tahun (juta rupiah)</th>
                      <th rowspan="2" width="10%" style="text-align: center; vertical-align:middle">Aksi</th>
                    </tr>
                    <tr>
                      @foreach($dataperda as $datas)
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered">
                  <tbody>
                    <tr class="backProgram">
                      <td width="15%" style="text-align: left; vertical-align:top;">Program Renstra</td>
                      <td style="text-align: left; vertical-align:top;"><label id="uraian_program_pelaksana" align='left'></label></td>
                    </tr>
                    <tr class="backKegiatan">
                      <td width="15%" style="text-align: left; vertical-align:top;">Kegiatan Renstra</td>
                      <td style="text-align: left; vertical-align:top;"><label id="uraian_kegiatan_pelaksana" align='left'></label></td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <div role="tabpanel" class="tab-pane" id="btl">
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered">
                  <tbody>
                    <tr class="backDokumen">
                      <td width="15%" style="text-align: left; vertical-align:top;">Nomor Renstra</td>
                      <td style="text-align: left; vertical-align:top;"><label id="no_dokumen_btl" align='left'></label></td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li class="active"><a href="#progbtl" aria-controls="progbtl" role="tab" data-toggle="tab">Program</a></li>
                <li class="disabled"><a href="#kegiatanbtl" aria-controls="kegiatanbtl" role="tab" data-toggle="tab">Kegiatan</a></li>
                <li class="disabled"><a href="#pelaksanabtl" aria-controls="pelaksanabtl" role="tab" data-toggle="tab">Sub Unit Pelaksana</a></li>
            </ul>
           <div class="tab-content">
              <div role="tabpanel" class="tab-pane active" id="progbtl">
              <br>
              <button type="button" class="btn btn-primary btn-labeled btnTambahProgramBtl" data-dismiss="modal" aria-hidden="true">
                <span class="btn-label"><i class="fa fa-plus fa-fw fa-lg"></i></span>Tambah Program</button>
              <div class="">
                      <table id="tblProgramBtl" class="table compact table-responsive table-striped table-bordered display"  cellspacing="0" width="100%">
                        <thead>
                            <tr>
                ...
                <table class="table table-striped table-bordered">
                  <tbody>
                    <tr class="backProgramBtl">
                      <td width="15%" style="text-align: left; vertical-align:top;">Program Renstra</td>
                      <td style="text-align: left; vertical-align:top;"><label id="uraian_program_kegiatan_btl" align='left'></label></td>
                    </tr>
                  </tbody>
                </table>
              </div>
              </form>             
              <button type="button" class="btn btn-primary btn-labeled btnTambahKegiatanBtl" data-dismiss="modal" aria-hidden="true">
                <span class="btn-label"><i class="fa fa-plus fa-fw fa-lg"></i></span>Tambah Kegiatan</button>
              <div class="">
              <table id="tblKegiatanBtl" class="table compact table-responsive table-striped table-bordered display" cellspacing="0" width="100%">
                <thead>
                  <tr>
                    <th rowspan="2" width="5%" style="text-align: center; vertical-align:middle">Kode Program</th>
                    <th rowspan="2" width="5%" style="text-align: center; vertical-align:middle">Kode Kegiatan</th>
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered">
                  <tbody>
                    <tr class="backProgramBtl">
                      <td width="15%" style="text-align: left; vertical-align:top;">Program Renstra</td>
                      <td style="text-align: left; vertical-align:top;"><label id="uraian_program_pelaksana_btl" align='left'></label></td>
                    </tr>
                    <tr class="backKegiatanBtl">
                      <td width="15%" style="text-align: left; vertical-align:top;">Kegiatan Renstra</td>
                      <td style="text-align: left; vertical-align:top;"><label id="uraian_kegiatan_pelaksana_btl" align='left'></label></td>
                    </tr>
                  </tbody>
                </table>
              </div>
              </form>
              <button type="button" class="btn btn-primary btn-labeled btnTambahPelaksanaBtl" data-dismiss="modal" aria-hidden="true">
                <span class="btn-label"><i class="fa fa-plus fa-fw fa-lg"></i></span>Tambah Pelaksana Non Program</button>
              <div class="">
                <table id="tblPelaksanaBtl" class="table compact table-responsive table-striped table-bordered display"  cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      <th width="5%" style="text-align: center; vertical-align:middle">Kode Kegiatan</th>
                      <th width="5%" style="text-align: center; vertical-align:middle">Kode Unit</th>
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered">
                  <tbody>
                    <tr class="backDokumen">
                      <td width="15%" style="text-align: left; vertical-align:top;">Nomor Renstra</td>
                      <td style="text-align: left; vertical-align:top;"><label id="no_dokumen_pdt" align='left'></label></td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li class="active"><a href="#progpdt" aria-controls="progpdt" role="tab" data-toggle="tab">Program</a></li>
                <li class="disabled"><a href="#kegiatanpdt" aria-controls="kegiatanpdt" role="tab" data-toggle="tab">Kegiatan</a></li>
                <li class="disabled"><a href="#pelaksanapdt" aria-controls="pelaksanapdt" role="tab" data-toggle="tab">Sub Unit Pelaksana</a></li>
            </ul>
           <div class="tab-content">
              <div role="tabpanel" class="tab-pane active" id="progpdt">
              <br>
              <button type="button" class="btn btn-primary btn-labeled btnTambahProgramPdt" data-dismiss="modal" aria-hidden="true">
                <span class="btn-label"><i class="fa fa-plus fa-fw fa-lg"></i></span>Tambah Program Pendapatan</button>
              <div class="">
                      <table id="tblProgramPdt" class="table compact table-responsive table-striped table-bordered display"  cellspacing="0" width="100%">
                        <thead>
                            <tr>
                              <th rowspan="2" width="5%" style="text-align: center; vertical-align:middle">No Urut</th>
                              <th rowspan="2" width="5%" style="text-align: center; vertical-align:middle">Kode Program</th>
                ...
                <table class="table table-striped table-bordered">
                  <tbody>
                    <tr class="backProgramPdt">
                      <td width="15%" style="text-align: left; vertical-align:top;">Program Renstra</td>
                      <td style="text-align: left; vertical-align:top;"><label id="uraian_program_kegiatan_pdt" align='left'></label></td>
                    </tr>
                  </tbody>
                </table>
              </div>
              </form>            
              <button type="button" class="btn btn-primary btn-labeled btnTambahKegiatanPdt" data-dismiss="modal" aria-hidden="true">
                <span class="btn-label"><i class="fa fa-plus fa-fw fa-lg"></i></span>Tambah Kegiatan Pendapatan</button>
              <div class="">
              <table id="tblKegiatanPdt" class="table compact table-responsive table-striped table-bordered display" cellspacing="0" width="100%">
                <thead>
                  <tr>
                    <th rowspan="2" width="5%" style="text-align: center; vertical-align:middle">Kode Program</th>
                    <th rowspan="2" width="5%" style="text-align: center; vertical-align:middle">Kode Kegiatan</th>
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered">
                  <tbody>
                    <tr class="backProgramPdt">
                      <td width="15%" style="text-align: left; vertical-align:top;">Program Renstra</td>
                      <td style="text-align: left; vertical-align:top;"><label id="uraian_program_pelaksana_pdt" align='left'></label></td>
                    </tr>
                    <tr class="backKegiatanPdt">
                      <td width="15%" style="text-align: left; vertical-align:top;">Kegiatan Renstra</td>
                      <td style="text-align: left; vertical-align:top;"><label id="uraian_kegiatan_pelaksana_pdt" align='left'></label></td>
                    </tr>
                  </tbody>
                </table>
              </div>
              </form>
              <button type="button" class="btn btn-primary btn-labeled btnTambahPelaksanaPdt" data-dismiss="modal" aria-hidden="true">
                <span class="btn-label"><i class="fa fa-plus fa-fw fa-lg"></i></span>Tambah Pelaksana Pendapatan</button>
              <div class="">
                <table id="tblPelaksanaPdt" class="table compact table-responsive table-striped table-bordered display"  cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      <th width="5%" style="text-align: center; vertical-align:middle">Kode Kegiatan</th>
                      <th width="5%" style="text-align: center; vertical-align:middle">Kode Unit</th>
...
@section('scripts')
  <script type="text/javascript" language="javascript" class="init" src="{{ asset('/protected/resources/views/renstra/JsRenstraIndex.js')}}"> </script>
@endsection
