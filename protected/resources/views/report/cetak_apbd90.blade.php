      ...
      <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12 text-center">
          <h2 style="font-size: 40px;line-height: 60px;margin-bottom: 10px;font-weight: 900;"><span
              class="highlight">Laporan Anggaran dan Pendapatan Belanja Permendagri 90</span></h2>
          <br>
        </div>
      </div>
...
@endsection
@section('scripts')
<script src="{{ asset('/protected/resources/views/report/js/js_cetak_apbd90.js')}}"></script>
@endsection