    ...
    <div class="container">
      <div class="row text-center">
        <div class="col-sm-12 col-md-12 col-lg-12">
          <h2 style="font-size: 40px;line-height: 60px;margin-bottom: 10px;font-weight: 900;"><span
              class="highlight">Musyawarah Perencanaan Pembangunan Tahunan</span></h2>
          <br>
        </div>
      </div>
      <form class="form-horizontal" role="form" autocomplete='off' action="" method="">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <select class="form-control select2 cb_kecamatan" name="cb_kecamatan" id="cb_kecamatan"></select>
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-sm-3" for="cb_desa">Desa :</label>
          <div class="col-sm-8">
            <select class="form-control select2 cb_desa" name="cb_desa" id="cb_desa"></select>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <select class="form-control select2 cb_status" name="cb_status" id="cb_status">
...
@section('scripts')
<script src="{{ asset('/protected/resources/views/report/js/js_cetak_musrenbang.js')}}"></script>
@endsection