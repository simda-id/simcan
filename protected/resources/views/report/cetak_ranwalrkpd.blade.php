            ...
            <div class="row text-center">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <h2 style="font-size: 40px;line-height: 60px;margin-bottom: 10px;font-weight: 900;"><span
                            class="highlight">Laporan RKPD Ranwal Tahunan</span></h2>
                    <br>
                </div>
            </div>
...
$(document).on('click', '.btnProses', function() {
    if($('#jns_laporan').val()==1){
        ...
        window.open('../CetakTB47'+ vars, '_blank'); 
       // window.open('../CetakTB47/'+ $('#tahun_prarka').val()); 
    };
    if($('#jns_laporan').val()==2){
        window.open('../CetakTC31/'+ $('#unit_prarka').val()+'/'+ $('#tahun_prarka').val()); 
     };
     if($('#jns_laporan').val()==3){
         window.open('../CetakTB56/'+ $('#unit_prarka').val()+'/'+ $('#tahun_prarka').val()); 
      };
});
