    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <h2 style="font-size: 40px;line-height: 60px;margin-bottom: 10px;font-weight: 900;"><span class="highlight">Laporan Rancangan APBD Tahunan</span></h2>
                <br>
            </div>
        </div>
        <form class="form-horizontal" role="form" autocomplete='off' action="" method="" >
              ...
              <div class="form-group">
                <label for="no_dokumen" class="col-sm-3 control-label" align='left' style="color:#fff;">Nomor Dokumen :</label>
                <div class="col-sm-8">
...
@endsection
@section('scripts')
  <script src="{{ asset('/protected/resources/views/report/js/js_cetak_rapbd.js')}}"></script>
@endsection
