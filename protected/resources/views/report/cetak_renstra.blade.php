        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <h2 style="font-size: 40px;line-height: 60px;margin-bottom: 10px;font-weight: 900;"><span
                            class="highlight">Laporan Rencana Strategi Perangkat Daerah</span></h2>
                    <br>
                </div>
            </div>
            <form class="form-horizontal" role="form" autocomplete='off' action="" method="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control select2 cb_no_dokumen" name="cb_no_dokumen"
                            id="cb_no_dokumen"></select>
                    </div>
                </div>
                <div class="form-group">
...
$(document).on('click', '.btnProses', function() {
    ...
    if($('#jns_laporan').val()==4){
        window.open('../PaguIndikatifRenstra/'+$('#unit_prarka').val()); 
    };
});
