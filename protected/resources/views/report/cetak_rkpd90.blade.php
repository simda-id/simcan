        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <h2 style="font-size: 40px;line-height: 60px;margin-bottom: 10px;font-weight: 900;"><span
                            class="highlight">Laporan RKPD Tahunan versi Permendagri 90</span></h2>
                    <br>
                </div>
            </div>
            <form class="form-horizontal" role="form" autocomplete='off' action="" method="">
                ...
                <div class="form-group">
                    <label for="tahun_prarka" class="col-sm-3 control-label" align='left' style="color:#fff;">Tahun
                        :</label>
                    <div class="col-sm-2">
                        <select class="form-control select2 tahun_prarka" name="tahun_prarka"
                            id="tahun_prarka"></select>
                    </div>
                </div>
                <div class="form-group hidden">
                    <label for="no_dokumen" class="col-sm-3 control-label" align='left' style="color:#fff;">Nomor
                        Dokumen RKPD
                        :</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group hidden">
                    <label for="urusan_prarka" class="col-sm-3 control-label" align='left' style="color:#fff;">Urusan
                        :</label>
                    <div class="col-sm-8">
                        <select class="form-control select2 urusan_prarka" name="urusan_prarka"
                            id="urusan_prarka"></select>
                    </div>
                </div>
                <div class="form-group hidden">
                    <label class="control-label col-sm-3" for="bidang_prarka" style="color:#fff;">Bidang :</label>
                    <div class="col-sm-8">
                        <select class="form-control select2 bidang_prarka" name="bidang_prarka"
                            id="bidang_prarka"></select>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group has-feedback">
                    ...
                    <div class="col-sm-2 chkTandatangan">
                        <label class="checkbox-inline">
                            <input class="checkTandatangan" type="checkbox" name="checkTandatangan"
                                id="checkTandatangan" value="1" checked><span style="color:#fff;"> Pakai Tanda
                                Tangan</span>
                        </label>
                    </div>
...
@endsection
@section('scripts')
<script src="{{ asset('/protected/resources/views/report/js/js_cetak_rkpd90.js')}}"></script>
@endsection