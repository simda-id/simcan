            ...
            <div class="col-sm-12">
              <table class="table table-bordered table-responsive">
                ...
                <tbody style="background-color: #fff">
                  ...
                  <tr>
                    <td width="25%" style="text-align: left; vertical-align:middle;">
                      <select type="text" class="form-control select2" id="id_satuan1" name="id_satuan1"
                        disabled></select>
                    </td>

                    <td width="25%" style="text-align: left; vertical-align:middle;">
                      <select type="text" class="form-control select2" id="id_satuan2" name="id_satuan2"
                        disabled></select>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td width="25%" style="text-align: left; vertical-align:middle;">
                      <select type="text" class="form-control select2" id="id_satuan1_forum"
                        name="id_satuan1_forum"></select>
                    </td>

                    <td width="25%" style="text-align: left; vertical-align:middle;">
                      <select type="text" class="form-control select2" id="id_satuan2_forum"
                        name="id_satuan2_forum"></select>
                    </td>
                  </tr>
                </tbody>
              </table>
