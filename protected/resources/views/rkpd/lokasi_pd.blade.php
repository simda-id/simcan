        ...
        <form name="frmModalLokasi" class="form-horizontal" role="form" autocomplete='off' action="" method="post"
            ...
            <table class="table table-bordered table-condensed">
              ...
              <tbody style="background-color: #fff">
                <tr>
                  ...
                  <td width="30%" style="text-align: center; vertical-align:top;">
                    <label class="radio">
                      <select type="text" class="form-control select2" id="id_satuan_1" name="id_satuan_1"
                        disabled></select>
                    </label>
                  </td>
                </tr>
                <tr>
                  ...
                  <td width="30%" style="text-align: center; vertical-align:top;" disabled>
                    <label class="radio">
                      <select type="text" class="form-control select2" id="id_satuan_2" name="id_satuan_2"
                        disabled></select>
                    </label>
                  </td>
                </tr>
          ...
          <div class="form-group" id="idStatusPelaksanaanLokasi">
            ...
            <div class="col-sm-8 col-sm-offset-3" id="myRadio">
              ...
              <label class="radio-inline">
                <input type="radio" class="sp_lokasi" name="status_pelaksanaan_lokasi" id="status_pelaksanaan_lokasi"
                  value="3">Ditolak/Tidak dilaksanakan
              </label>
            </div>
          </div>
          <div class="form-group">
