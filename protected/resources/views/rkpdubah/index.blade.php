    ...
    <div class="col-md-12">
      <div class="panel panel-info">
        <div class="panel-heading">
          <h2 class="panel-title">Daftar Usulan Program RKPD Perubahan</h2>
        </div>
                  ...
                  <table id="tblProgramRKPD" class="table display table-responsive table-striped compact table-bordered"
                    ...
                    <thead>
                      <tr>
                        ...
                        <th rowspan="2" width="8%" style="text-align: center; vertical-align:middle">Status Pelaksanaan
                        </th>
                    ...
                    <table class="table table-striped table-bordered table-responsive">
                      <tbody>
                        <tr>
                          ...
                          <td style="text-align: left; vertical-align:top;"><label id="nm_program_rpjmd_indikator"
                              align='left'></label></td>
                        </tr>
                        <tr>
                  ...
                  <div class="">
                    <table class="table table-striped table-bordered table-responsive">
                      <tbody>
                        <tr>
                          <td width="15%" style="text-align: left; vertical-align:top;">Program RPJMD</td>
                          <td style="text-align: left; vertical-align:top;"><label id="nm_program_rpjmd_urusan"
                              align='left'></label></td>
                        </tr>
                        <tr>
                          <td width="15%" style="text-align: left; vertical-align:top;">Program RKPD</td>
                  ...
                  <div class="">
                    <table class="table table-striped table-bordered table-responsive">
                      <tbody>
                        <tr>
                          <td width="15%" style="text-align: left; vertical-align:top;">Program RPJMD</td>
                          <td style="text-align: left; vertical-align:top;"><label id="nm_program_rpjmd_pelaksana"
                              align='left'></label></td>
                        </tr>
                        <tr>
                          <td width="15%" style="text-align: left; vertical-align:top;">Program RKPD</td>
...
@include('rkpdubah.program_rkpd');
@include('rkpdubah.indikator_program_rkpd');
@include('rkpdubah.urusan_program_rkpd');
@include('rkpdubah.pelaksana_program_rkpd');

@include('rkpdubah.cariIndikator');
@include('rkpdubah.cariProgramRPJMD');
@include('rkpdubah.cariRefUnit');
@include('rkpdubah.StatusProgram');

@endsection

@section('scripts')
<script src="{{ asset('/protected/resources/views/rkpdubah/js/js_rkpd.js')}}"></script>
@endsection