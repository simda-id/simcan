$( document ).ready( function () {
    ...
    var id_dokumen_temp, id_rkpd_program_temp, temp_ur_program_rpjmd, temp_ur_program_rkpd, id_rkpd_urusan_temp;
    var indikator_reviu, pelaksana_reviu, check_data;
    ...
    $( '#pagu_apbd_program' ).number( true, 2, ',', '.' );
    $( '#target_indikator_rpjmd' ).number( true, 2, ',', '.' );
    $( '#target_indikator_apbd' ).number( true, 2, ',', '.' );
    ...
    $( "#cb_dokumen" ).change( function () {
        ...
        LoadProgramRkpd( id_dokumen_temp );
    } );
    ...
    function LoadProgramRkpd ( id_dokumen ) {
        progrkpd = $( '#tblProgramRKPD' ).DataTable( {
            ...
            deferRender: true,
            "autoWidth": false,
            "ajax": { "url": "rkpdubah/getData?id_dokumen=" + id_dokumen },
            language: {
                "decimal": ",",
                "thousands": ".",
                "sEmptyTable": "Tidak ada data yang tersedia pada tabel ini",
    ...
    function LoadIndikatorProg ( id_program ) {
        indiProg_tbl = $( '#tblIndikatorRKPD' ).DataTable( {
            ...
            deferRender: true,
            "autoWidth": false,
            "ajax": { "url": "rkpdubah/getIndikatorRKPD/" + id_program },
            language: {
                "decimal": ",",
                "thousands": ".",
                "sEmptyTable": "Tidak ada data yang tersedia pada tabel ini",
    ...
    function LoadUrusan ( id_program ) {
        UrusanTable = $( '#tblUrusanRKPD' ).DataTable( {
            ...
            deferRender: true,
            "autoWidth": false,
            "ajax": { "url": "rkpdubah/getUrusanRKPD/" + id_program },
            "language": {
                "decimal": ",",
                "thousands": "."
            },
    ...
    $( '#tblUrusanRKPD tbody' ).on( 'dblclick', 'tr', function () {
        ...
        id_rkpd_program_temp = data.id_rkpd_program;
        id_rkpd_urusan_temp = data.id_urusan_rkpd;
        ...
        LoadPelaksana( id_rkpd_program_temp, id_rkpd_urusan_temp );
    } );
    ...
    function LoadPelaksana ( id_ranwal, id_urusan ) {
        PelaksanaTable = $( '#tblPelaksanaRKPD' ).DataTable( {
            ...
            deferRender: true,
            "autoWidth": false,
            "ajax": { "url": "rkpdubah/getPelaksanaRKPD/" + id_ranwal + "/" + id_urusan },
            "language": {
                "decimal": ",",
                "thousands": "."
            },
    ...
    $( document ).on( 'click', '.view-indikator', function () {
        ...
        LoadIndikatorProg( id_rkpd_program_temp );
    } );
    ...
    $( document ).on( 'click', '.view-pelaksana', function () {
        ...
        LoadUrusan( id_rkpd_program_temp );
    } );
    ...
    $( document ).on( 'click', '.add-pelaksana', function () {
        ...
        $( '#id_urusan_rkpd_pelaksana' ).val( id_rkpd_urusan_temp );
        $( '#id_unit_rkpd' ).val( null );
        $( '#id_rkpd_ranwal_pelaksana' ).val( id_rkpd_program_temp );
    ...
    $( '.modal-footer' ).on( 'click', '.addPelaksana', function () {
        ...
        $.ajax( {
            type: 'post',
            url: 'rkpdubah/addPelaksanaRKPD',
            data: {
                '_token': $( 'input[name=_token]' ).val(),
                'id_rkpd_program': $( '#id_rkpd_ranwal_pelaksana' ).val(),
            ...
            success: function ( data ) {
                ...
                UrusanTable.ajax.reload( null, false );
    ...
    $( document ).on( 'click', '.edit-pelaksana', function () {
        ...
        $( '#id_rkpd_ranwal_pelaksana' ).val( data.id_rkpd_program );
    ...
    $( '.modal-footer' ).on( 'click', '.editPelaksana', function () {
        ...
        $.ajax( {
            type: 'post',
            url: 'rkpdubah/editPelaksanaRKPD',
            data: {
                '_token': $( 'input[name=_token]' ).val(),
    ...
    $( '.modal-footer' ).on( 'click', '.delUnitRKPD', function () {
        ...
        $.ajax( {
            type: 'post',
            url: 'rkpdubah/hapusPelaksanaRKPD',
            data: {
                '_token': $( 'input[name=_token]' ).val(),
    ...
    $( document ).on( 'click', '.add-urusan', function () {
        ...
        $( '.form-horizontal' ).show();
        $( '#id_rkpd_ranwal_urusan' ).val( id_rkpd_program_temp );
    ...
    $( '.modal-footer' ).on( 'click', '.addUrusan', function () {
        ...
        $.ajax( {
            type: 'post',
            url: 'rkpdubah/addUrusanRKPD',
            data: {
                '_token': $( 'input[name=_token]' ).val(),
                'no_urut': null,
                'id_rkpd_program': $( '#id_rkpd_ranwal_urusan' ).val(),
    ...
    $( document ).on( 'click', '.add-indikator', function () {
        ...
        $( '#id_rkpd_ranwal_indikator' ).val( id_rkpd_program_temp );
    ...
    $( '.modal-footer' ).on( 'click', '.addIndikator', function () {
        ...
        $.ajax( {
            type: 'post',
            url: 'rkpdubah/addIndikatorRKPD',
            data: {
                '_token': $( 'input[name=_token]' ).val(),
                'no_urut': $( '#no_urut_indikator' ).val(),
                'id_rkpd_program': $( '#id_rkpd_ranwal_indikator' ).val(),
    ...
    $( document ).on( 'click', '.edit-indikator', function () {
        ...
        $( '#id_rkpd_ranwal_indikator' ).val( data.id_rkpd_program );
    ...
    $( '.modal-footer' ).on( 'click', '.editIndikator', function () {
        ...
        $.ajax( {
            type: 'post',
            url: 'rkpdubah/editIndikatorRKPD',
            data: {
                '_token': $( 'input[name=_token]' ).val(),
                'no_urut': $( '#no_urut_indikator' ).val(),
    ...
    $( '.modal-footer' ).on( 'click', '.delIndikatorRKPD', function () {
        ...
        $.ajax( {
            type: 'post',
            url: 'rkpdubah/hapusIndikatorRKPD',
            data: {
                '_token': $( 'input[name=_token]' ).val(),
    ...
    $( '.modal-footer' ).on( 'click', '.addProgramRkpd', function () {
        ...
        $.ajax( {
            ...
            data: {
                ...
                'pagu_rpjmd': 0,
                'pagu_rkpd': $( '#pagu_rkpd_program' ).val(),
    ...
    $( document ).on( 'click', '.edit-program', function () {
        ...
        $( '.idStatusUsulan' ).hide();
        $( '.form-horizontal' ).show();
        $( '#id_rkpd_ranwal_program' ).val( data.id_rkpd_program );
        $( '#jns_belanja' ).val( data.jenis_belanja ).trigger( 'change' );
        ...
        $( '#pagu_rkpd_program' ).val( data.pagu_rkpd );
    ...
    $( '.modal-footer' ).on( 'click', '.editProgramRKPD', function () {
        ...
        $.ajax( {
            type: 'post',
            url: 'rkpdubah/editProgramRKPD',
            data: {
                '_token': $( 'input[name=_token]' ).val(),
                'id_rkpd_program': $( '#id_rkpd_ranwal_program' ).val(),
                'jenis_belanja': $( '#jns_belanja' ).val(),
                'thn_id_rpjmd': $( '#thn_id_rpjmd' ).val(),
                'id_program_rpjmd': $( '#id_program_rpjmd' ).val(),
                'uraian_program_rpjmd': $( '#ur_program_rkpd' ).val(),
    ...
    $( '.modal-footer' ).on( 'click', '.delProgramRKPD', function () {
        ...
        $.ajax( {
            type: 'post',
            url: 'rkpdubah/hapusProgramRKPD',
            data: {
                '_token': $( 'input[name=_token]' ).val(),
                'id_rkpd_program': $( '#id_program_hapus' ).val()
            },
            success: function ( data ) {
    ...
    function LoadCariProgram () {
        cariprogram = $( '#tblCariProgramRPJMD' ).DataTable( {
            ...
            serverSide: true,
            dom: 'bfrtIp',
            "ajax": { "url": "./rkpdubah/getRefProgramRPJMD" },
            "columns": [
                { data: 'no_urut', sClass: "dt-center" },
    ...
    $( document ).on( 'click', '#btnUnProgram', function () {
        var data = progrkpd.row( $( this ).parents( 'tr' ) ).data();
        $( '#id_program_ranwal_posting' ).val( data.id_rkpd_program );
    ...
    $( '.modal-footer' ).on( 'click', '#btnPostProgram', function () {
        ...
        $.ajax( {
            type: 'post',
            url: 'rkpdubah/postProgram',
            data: {
                '_token': $( 'input[name=_token]' ).val(),
                'tahun_rkpd': $( '#tahun_ranwal_posting' ).val(),
                'id_rkpd_program': $( '#id_program_ranwal_posting' ).val(),
    ...
    $( document ).on( 'click', '#btnReviuPelaksana', function () {
        ...
        $.each( rows_selected, function ( index, rowId ) {
            ...
            $.ajax( {
                type: 'POST',
                url: 'rkpdubah/postPelaksanaRKPD',
                data: {
                    '_token': $( 'input[name=_token]' ).val(),
    ...
    $( document ).on( 'click', '#btnReviuIndikator', function () {
        ...
        $.each( rows_selected, function ( index, rowId ) {
            ...
            $.ajax( {
                type: 'POST',
                url: 'rkpdubah/postIndikatorRKPD',
                data: {
                    '_token': $( 'input[name=_token]' ).val(),
                    'status_data': rows_data[ index ].status_data,
