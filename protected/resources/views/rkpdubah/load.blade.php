          ...
          <form name="" class="form-horizontal" role="form" autocomplete='off' action="" method="post">
            ...
            <div class="form-group">
              ...
              <button id="btnProses" type="button" class="btnProses btn btn-labeled btn-sm btn-primary">
                <span class="btn-label"><i class="glyphicon glyphicon-download-alt"></i></span>Proses Load Data dari
                Ranhir RKPD</button>
            </div>
            ...
            <div class="form-group hidden">
              ...
              <div class="col-sm-7">
                <select class="form-control id_rkpd_ranwal select2" name="id_rkpd_ranwal" id="id_rkpd_ranwal"></select>
              </div>
            </div>
          </form>
