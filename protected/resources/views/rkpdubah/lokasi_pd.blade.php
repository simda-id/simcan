      ...
      <div class="modal-body">
        <form name="frmModalLokasi" class="form-horizontal" role="form" autocomplete='off' action="" method="post"
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <select type="text" class="form-control select2" id="sumber_data_lokasi" name="sumber_data_lokasi"
                disabled>
                <option value="0">APBD</option>
                <option value="1">RKPD Perubahan</option>
              </select>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <div class="input-group">
                ...
                <div class="input-group-btn">
                  <btn class="btn btn-primary btnCariLokasi" id="btnCariLokasi" name="btnCariLokasi"><i
                      class="fa fa-search fa-fw fa-lg"></i></btn>
                </div>
              </div>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <div class="input-group">
                ...
                <div class="input-group-btn">
                  <btn class="btn btn-primary btnCariLokasiTeknis" id="btnCariLokasiTeknis" name="btnCariLokasiTeknis">
                    <i class="fa fa-search fa-fw fa-lg"></i></btn>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <table class="table table-bordered table-condensed">
              <thead style="background-color: #428bca; color: #fff">
                <tr>
                  <td rowspan="2" width="5%" style="text-align: center; vertical-align:middle;">No</td>
                ...
                <tr>
                  <td width="30%" style="text-align: center; vertical-align:middle;">APBD</td>
                  <td width="30%" style="text-align: center; vertical-align:middle;">RKPD</td>
                </tr>
              </thead>
              <tbody style="background-color: #fff">
                <tr>
                  ...
                  <td width="30%" style="text-align: center; vertical-align:top;">
                    <input type="text" class="form-control number" id="volume_usulan_1" name="volume_usulan_1"
                      style="text-align: right; vertical-align:top;" disabled>
                  </td>
                  <td width="30%" style="text-align: center; vertical-align:top;">
                    <input type="text" class="form-control number" id="volume_1_lokasi" name="volume_1_lokasi"
                      style="text-align: right; vertical-align:top;">
                  </td>
                  <td width="30%" style="text-align: center; vertical-align:top;">
                    <label class="radio">
                      <select type="text" class="form-control select2" id="id_satuan_1_lokasi" name="id_satuan_1_lokasi"
                        disabled></select>
                    </label>
                  </td>
                </tr>
                <tr>
                  ...
                  <td width="30%" style="text-align: center; vertical-align:top;">
                    <input type="text" class="form-control number" id="volume_usulan_2" name="volume_usulan_2"
                      style="text-align: right; vertical-align:top;" disabled>
                  </td>
                  <td width="30%" style="text-align: center; vertical-align:top;">
                    <input type="text" class="form-control number" id="volume_2_lokasi" name="volume_2_lokasi"
                      style="text-align: right; vertical-align:top;">
                  </td>
                  <td width="30%" style="text-align: center; vertical-align:top;">
                    <label class="radio">
                      <select type="text" class="form-control select2" id="id_satuan_2_lokasi" name="id_satuan_2_lokasi"
                        disabled></select>
                    </label>
                  </td>
                </tr>
          ...
          <div class="form-group" id="idStatusPelaksanaanLokasi">
            <label for="status_pelaksanaan_lokasi" class="col-sm-3 control-label" align='left'>Status Pelaksanaan
              :</label>
            <div class="col-sm-8" id="myRadio">
              <label class="radio-inline">
                <input type="radio" class="sp_lokasi" name="status_pelaksanaan_lokasi" id="status_pelaksanaan_lokasi"
                  value="0">Dilaksanakan
              </label>
              <label class="radio-inline">
                <input type="radio" class="sp_lokasi" name="status_pelaksanaan_lokasi" id="status_pelaksanaan_lokasi"
                  value="1">Dibatalkan
          ...
          <div class="form-group">
            <label for="keterangan_status_lokasi" class="col-sm-3 control-label" align='left'>Keterangan Pelaksanaan
              :</label>
            <div class="col-sm-8">
              <textarea type="text" class="form-control" name="keterangan_status_lokasi" id="keterangan_status_lokasi"
                rows="3"></textarea>
            </div>
          </div>
        </form>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="alert alert-danger deleteContent">
          ...
          Yakin akan menghapus lokasi : <strong><span id="ur_lokasi_hapus"></span></strong> sebagai lokasi pelaksanaan
          aktivitas ?
          <br>
          <br>
