  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form name="frmModalPelaksana" class="form-horizontal" role="form" autocomplete='off' action="" method="post"
            ...
            <div class="col-sm-8">
              <div class="input-group">
                ...
                <div class="input-group-btn">
                  <btn class="btn btn-primary" id="btnCariSubUnit" name="btnCariSubUnit"><i class="fa fa-search"></i>
                  </btn>
                </div>
              </div>
            </div>
          </div>
          <div class="form-group" id="idStatusPelaksanaanPelaksana" hidden>
            <label for="status_pelaksanaan_pelaksana" class="col-sm-3 control-label" align='left'>Status Pelaksanaan
              :</label>
            <div class="col-sm-8" id="myRadio">
              <label class="radio-inline">
                <input type="radio" class="sp_pelaksana" name="status_pelaksanaan_pelaksana"
                  id="status_pelaksanaan_pelaksana" value="0">Digunakan
              </label>
              <label class="radio-inline">
                <input type="radio" class="sp_pelaksana" name="status_pelaksanaan_pelaksana"
                  id="status_pelaksanaan_pelaksana" value="1">Dibatalkan
              </label>
            </div>
          </div>
          <div class="form-group">
            <label for="keterangan_status_pelaksana" class="col-sm-3 control-label" align='left'>Keterangan Pelaksanaan
              :</label>
            <div class="col-sm-8">
              <textarea type="text" class="form-control" name="keterangan_status_pelaksana"
                id="keterangan_status_pelaksana" rows="3"></textarea>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <div class="input-group">
                ...
                <div class="input-group-btn">
                  <btn class="btn btn-primary" id="btnCariLokasi" name="btnCariLokasi"><i class="fa fa-search"></i>
                  </btn>
                </div>
              </div>
            </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="alert alert-danger deleteContent">
          ...
          Yakin akan menghapus Sub Unit : <strong><span id="ur_pelaksana_hapus"></span></strong> sebagai pelaksana
          aktivitas ?
          <br>
          <br>
