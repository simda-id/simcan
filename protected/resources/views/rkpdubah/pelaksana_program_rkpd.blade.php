  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form name="frmEditPelaksana" class="form-horizontal" role="form" autocomplete='off' action="" method="post"
          ...
          <div class="form-group hidden">
            ...
            <div class="col-sm-3 chkPelaksana hidden">
              <label class="checkbox-inline">
                <input class="checkPelaksana" type="checkbox" name="checkPelaksana" id="checkPelaksana" value="1"> Telah
                Direviu</label>
            </div>
          </div>
          <div class="form-group">
            ...
            <span class="btn btn-sm btn-primary btnCariUnit" id="btnCariUnit" name="btnCariUnit"><i
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <label class="radio-inline" data-placement="bottom" data-toggle="popover" data-html="true"
                ...
                data-content="SKPD tidak dapat menambah program/kegiatan di Renja selain di Renstra untuk Program RPJMD ini">
                <input type="radio" name="ophak_akses" id="ophak_akses" value="0">Tidak Diperbolehkan
              </label>
              <label class="radio-inline" data-placement="bottom" data-toggle="popover" data-html="true"
                data-container="body" title="Ranwal RKPD" data-trigger="hover"
                data-content="SKPD dapat menambah program/kegiatan di Renja selain di Renstra untuk Program RPJMD ini">
          ...
          <div class="form-group idStatusPelaksanaUnit" id="idStatus">
            <label for="status_pelaksanaan_unit" class="col-sm-3 control-label" align='left'>Status Pelaksanaan
              :</label>
            <div class="col-sm-8" id="myRadio">
              <label class="radio-inline">
                <input type="radio" class="sUnit" name="status_pelaksanaan_unit" id="status_pelaksanaan_unit"
                  value="0">Tepat Waktu
              </label>
          ...
          <div class="form-group KetPelaksanaanUnit">
            <label for="keterangan_status_unit" class="col-sm-3 control-label" align='left'>Keterangan Pelaksanaan
              :</label>
            <div class="col-sm-8">
              <textarea type="text" class="form-control keterangan_status_unit" name="keterangan_status_unit"
                id="keterangan_status_unit" rows="3" disabled></textarea>
            </div>
          </div>
        </form>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-10 text-right">
            <div class="ui-group-buttons">
              <button type="button" class="btn btn-labeled btn-success btnAddPelaksana" data-dismiss="modal"><span
...
<div id="HapusPelaksana" class="modal fade" role="dialog" tabindex="-1" data-focus-on="input:first"
  ...
  <div class="modal-dialog modal-xs">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="ui-group-buttons">
          <button type="button" class="btn btn-labeled btn-danger btnDelUnit" data-dismiss="modal"><span
