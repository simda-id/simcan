  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form name="frmProgRenja" class="form-horizontal" role="form" autocomplete='off' action="" method="post"
          ...
          <div class="form-group hidden">
            ...
            <div class="col-sm-2">
              <input type="text" class="form-control nomor" name="no_urut_progrenja" id="no_urut_progrenja" value="0">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-3" for="id">Jenis Belanja :</label>
            <div class="col-sm-5">
              <select class="form-control select2" name="jenis_belanja" id="jenis_belanja">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <textarea type="name" class="form-control" name="uraian_program_renstra" id="uraian_program_renstra"
            ...
            <span class="btn btn-sm btn-primary btnCariProgramRenstra" id="btnCariProgramRenstra"
              name="btnCariProgramRenstra"><i class="fa fa-search fa-fw fa-lg"></i></span>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-3" for="title">Uraian Program Referensi:</label>
            <div class="col-sm-8">
              <textarea type="name" class="form-control ur_program_ref" name="ur_program_ref" id="ur_program_ref"
                rows="3" disabled></textarea>
            </div>
          ...
          <div class="form-group">
            <label for="pagu_rkpd_program" class="col-sm-3 control-label" align='left'>Pagu :</label>
            <div class="col-sm-8">
              <table class="table table-bordered table-responsive">
                <thead style="background-color: #428bca; color: #fff">
                  <tr>
                    <td style="text-align: center; vertical-align:middle;">RENSTRA</td>
                ...
                <tbody style="background-color: #fff">
                  <tr>
                    <td style="text-align: center; vertical-align:middle;">
                      <input type="text" class="form-control number" id="pagu_renstra_program"
                        name="pagu_renstra_program" style="text-align: right; vertical-align:middle;" disabled>
                    </td>
                    <td style="text-align: center; vertical-align:middle;">
                    ...
                    <td style="text-align: center; vertical-align:middle;">
                      <input type="text" class="form-control number" id="pagu_renja_program" name="pagu_renja_program"
                        style="text-align: right; vertical-align:middle;" required=" required">
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <div class="form-group" id="idStatusPelaksanaan">
            <label for="status_pelaksanaan_progrenja" class="col-sm-3 control-label" align='left'>Status Pelaksanaan
              :</label>
            <div class="col-sm-8" id="myRadio">
              <label class="radio-inline">
                <input type="radio" class="sp_progrenja" name="status_pelaksanaan_progrenja"
                  id="status_pelaksanaan_progrenja" value="0">Tepat Waktu
              </label>
              <label class="radio-inline hidden">
                <input type="radio" class="sp_progrenja " name="status_pelaksanaan_progrenja"
                  id="status_pelaksanaan_progrenja" value="1">Dimajukan
              </label>
              <label class="radio-inline">
                <input type="radio" class="sp_progrenja" name="status_pelaksanaan_progrenja"
                  id="status_pelaksanaan_progrenja" value="2">Ditunda
              </label>
              <label class="radio-inline">
                <input type="radio" class="sp_progrenja" name="status_pelaksanaan_progrenja"
                  id="status_pelaksanaan_progrenja" value="3">Dibatalkan
              </label>
              <label class="radio-inline" id="sp_progrenja4" style="display: none;">
                <input type="radio" class="sp_progrenja" name="status_pelaksanaan_progrenja"
                  id="status_pelaksanaan_progrenja" value="4">Baru
              </label>
            </div>
          </div>
          <div class="form-group KetPelaksanaanProgRenja">
            <label for="keterangan_status_program" class="col-sm-3 control-label" align='left'>Keterangan Pelaksanaan
              :</label>
            <div class="col-sm-8">
              <textarea type="text" class="form-control keterangan_status_progrenja" name="keterangan_status_progrenja"
                id="keterangan_status_progrenja" rows="3"></textarea>
            </div>
          </div>
        </form>
      </div>
      <div class="modal-footer">
        <div class="row">
          <div class="col-sm-2 text-left" id="btnHapusProgRenja">
            <button class="btn btn-sm btn-danger btn-labeled btnHapusProgRenja"><span class="btn-label"><i
                  class="fa fa-trash fa-fw fa-lg"></i></span>Hapus</button>
          </div>
          <div class="col-sm-10 text-right">
            <div class="ui-group-buttons">
              <button type="button" class="btn btn-sm btn-labeled btn-success btnProgRenja" data-dismiss="modal"><span
                  class="btn-label"><i class="fa fa-floppy-o fa-fw fa-lg"></i></span> Simpan</button>
              <div class="or"></div>
              <button type="button" class="btn btn-sm btn-labeled btn-warning" data-dismiss="modal"
