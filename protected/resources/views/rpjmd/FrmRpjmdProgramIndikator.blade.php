    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" autocomplete='off' action="" method="post">
          ...
          <input type="hidden" class="form-control" id="id_indikator_program_rpjmd_edit"
            name="id_indikator_program_rpjmd_edit" readonly>
          <input type="hidden" class="form-control" id="thn_id_indikator_program_edit"
            name="thn_id_indikator_program_edit" readonly>
          <input type="hidden" class="form-control" id="id_program_rpjmd_indikator_edit"
            name="id_program_rpjmd_indikator_edit" readonly>
          <div class="form-group">
            <label for="no_urut_edit" class="col-sm-3 control-label" align='left'>Nomor Urut :</label>
            <div class="col-sm-2">
              <div class="input-group">
                <input type="text" class="form-control number" id="no_urut_indikator_program_edit"
                  name="no_urut_indikator_program_edit" required="required">
              </div>
            </div>
            <label for="id_perubahan_edit" class="col-sm-3 control-label" align='left'>ID Perubahan :</label>
            <div class="col-sm-2">
              <div class="input-group">
                <input type="text" class="form-control number" id="id_perubahan_indikator_program_edit"
                  name="id_perubahan_indikator_program_edit" required="required">
              </div>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="satuan_program_indikator_edit" class="col-sm-3 control-label" align='left'>Satuan Indikator
              :</label>
            <div class="col-sm-8">
              <div class="input-group">
                <input type="text" class="form-control" id="satuan_program_indikator_edit"
                  name="satuan_program_indikator_edit" readonly>
              </div>
            </div>
            ...
            <tbody>
              <tr>
                <td width="20%" style="text-align: center; vertical-align:middle">
                  <input type="text" class="form-control number" id="indiprogram1_edit" name="indiprogram1_edit"
                    style="text-align: right; ">
                </td>
                <td width="20%" style="text-align: center; vertical-align:middle">
                  <input type="text" class="form-control number" id="indiprogram2_edit" name="indiprogram2_edit"
                    style="text-align: right; ">
                </td>
                <td width="20%" style="text-align: center; vertical-align:middle">
                  <input type="text" class="form-control number" id="indiprogram3_edit" name="indiprogram3_edit"
                    style="text-align: right; ">
                </td>
                <td width="20%" style="text-align: center; vertical-align:middle">
                  <input type="text" class="form-control number" id="indiprogram4_edit" name="indiprogram4_edit"
                    style="text-align: right; ">
                </td>
                <td width="20%" style="text-align: center; vertical-align:middle">
                  <input type="text" class="form-control number" id="indiprogram5_edit" name="indiprogram5_edit"
                    style="text-align: right; ">
                </td>
              </tr>
              <tr style="background: #428bca; color: #fff">
                ...
                <td style="text-align: center; vertical-align:middle">
                  <input type="text" class="form-control number" id="indiprogram_awal_edit" name="indiprogram_awal_edit"
                    style="text-align: right; ">
                </td>
                <td colspan="2" style="text-align: center; vertical-align:middle; font-weight: bold;">Kondisi Akhir :
                </td>
                <td style="text-align: center; vertical-align:middle">
                  <input type="text" class="form-control number" id="indiprogram_akhir_edit"
                    name="indiprogram_akhir_edit" style="text-align: right; ">
                </td>
              </tr>
            </tbody>
          </table>
...
<div id="HapusProgramIndikatorModal" class="modal fade" role="dialog" data-backdrop="static">
  <div class="modal-dialog modal-xs">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="ui-group-buttons">
          <button type="button" class="btn btn-sm btn-danger btn-labeled btnDelProgramIndikator"
