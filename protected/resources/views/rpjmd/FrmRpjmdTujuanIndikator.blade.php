    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" autocomplete='off' action="" method="post">
          ...
          <input type="hidden" class="form-control" id="id_indikator_tujuan_rpjmd_edit"
            name="id_indikator_tujuan_rpjmd_edit" readonly>
          <input type="hidden" class="form-control" id="thn_id_indikator_tujuan_edit"
            name="thn_id_indikator_tujuan_edit" readonly>
          <input type="hidden" class="form-control" id="id_tujuan_rpjmd_indikator_edit"
            name="id_tujuan_rpjmd_indikator_edit" readonly>
          <div class="form-group">
            <label for="no_urut_edit" class="col-sm-3 control-label" align='left'>Nomor Urut :</label>
            <div class="col-sm-2">
              <div class="input-group">
                <input type="text" class="form-control number" id="no_urut_indikator_tujuan_edit"
            ...
            <div class="col-sm-2">
              <div class="input-group">
                <input type="text" class="form-control number" id="id_perubahan_indikator_tujuan_edit"
