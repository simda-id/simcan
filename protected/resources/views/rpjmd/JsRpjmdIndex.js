$( document ).ready( function () {
  ...
  function backProgramBtl () {
    $( '.nav-tabs a[href="#uraianBtl"]' ).tab( 'show' );
  };

  function backUrusanBtl () {
    $( '.nav-tabs a[href="#urusanBtl"]' ).tab( 'show' );
  };

  function backProgramPdt () {
    $( '.nav-tabs a[href="#sumberdana"]' ).tab( 'show' );
  };

  function backUrusanPdt () {
    $( '.nav-tabs a[href="#urusanpdt"]' ).tab( 'show' );
  };
  ...
  $( document ).on( 'click', '.backMisi', function () {
    backMisi();
  } );
  ...
  $( document ).on( 'click', '.backUrusanBtl', function () {
    backUrusanBtl();
  } );
  ...
  $( document ).on( 'click', '.backUrusanPdt', function () {
    backUrusanPdt();
  } );
  ...
  $( '#pagu1_opd' ).number( true, 2, ',', '.' );
  $( '#pagu2_opd' ).number( true, 2, ',', '.' );
  $( '#pagu3_opd' ).number( true, 2, ',', '.' );
  $( '#pagu4_opd' ).number( true, 2, ',', '.' );
  ...
  function initInDokumen ( tableId, data ) {
    ...
    $( '#' + tableId + '  tbody' ).on( 'dblclick', 'tr', function () {
      ...
      $( '.nav-tabs a[href="#misi"]' ).tab( 'show' );
      $( '#uraian_visi_misi' ).text( data.uraian_visi_rpjmd );
  ...
  $( '#tblMisi tbody' ).on( 'dblclick', 'tr', function () {
    ...
    $( '.nav-tabs a[href="#tujuan"]' ).tab( 'show' );
    $( '#uraian_visi_tujuan' ).text( $( '#uraian_visi_misi' ).text() );
    $( '#uraian_misi_tujuan' ).text( data.uraian_misi_rpjmd );
  ...
  $( '#tblTujuan tbody' ).on( 'dblclick', 'tr', function () {
    ...
    $( '.nav-tabs a[href="#sasaran"]' ).tab( 'show' );
    $( '#uraian_visi_sasaran' ).text( $( '#uraian_visi_tujuan' ).text() );
    $( '#uraian_misi_sasaran' ).text( $( '#uraian_misi_tujuan' ).text() );
    $( '#uraian_tujuan_sasaran' ).text( data.uraian_tujuan_rpjmd );
  ...
  $( '#tblSasaran tbody' ).on( 'dblclick', 'tr', function () {
    ...
    $( '#uraian_visi_program' ).text( $( '#uraian_visi_sasaran' ).text() );
    $( '#uraian_misi_program' ).text( $( '#uraian_misi_sasaran' ).text() );
    $( '#uraian_tujuan_program' ).text( $( '#uraian_tujuan_sasaran' ).text() );
    $( '#uraian_sasaran_program' ).text( data.uraian_sasaran_rpjmd );
  ...
  $( document ).on( 'click', '.btnAddProgram', function () {
    ...
    $( '.actionBtn_program' ).removeClass( 'addProgramPdt' );
    $( '.actionBtn_program' ).removeClass( 'editProgramBtl' );
    $( '.actionBtn_program' ).removeClass( 'editProgramPdt' );
  ...
  $( document ).on( 'click', '.edit-program', function () {
    ...
    $( '#pagu1_opd' ).val( data.pagu_tahun1_opd );
    $( '#pagu2_opd' ).val( data.pagu_tahun2_opd );
    ...
    $( '#pagu_total_opd' ).val( data.pagu_total_opd );
    if ( data.sumber_data == 0 ) {
      $( '#btnDelProgram' ).hide()
    } else {
      $( '#btnDelProgram' ).show();
  ...
  $( '.modal-footer' ).on( 'click', '.btnDelProgram', function () {
    ...
    $.ajax( {
      ...
      success: function ( data ) {
        ...
        if ( sumberTbl == 1 ) {
          tblBtl.ajax.reload( null, false );
        }
        if ( sumberTbl == 2 ) {
          tblPendapatan.ajax.reload( null, false );
        }
  ...
  $( '#tblProgram tbody' ).on( 'dblclick', 'tr', function () {
    ...
    $( '.nav-tabs a[href="#urusan"]' ).tab( 'show' );
    $( '#uraian_program_urbid' ).text( data.uraian_program_rpjmd );
  ...
  $( document ).on( 'click', '.add-urbidprog', function () {
    ...
    $( '.btnUrusan' ).removeClass( 'addUrusanBtl' );
    $( '.btnUrusan' ).removeClass( 'editUrusanBtl' );
    $( '.btnUrusan' ).removeClass( 'addUrusanPdt' );
    $( '.btnUrusan' ).removeClass( 'editUrusanPdt' );
  ...
  $( document ).on( 'click', '.del-urbidprog', function () {
    ...
    $( '.btnDelUrusan' ).removeClass( 'delUrusanRPJMDBtl' );
    $( '.btnDelUrusan' ).removeClass( 'delUrusanRPJMDPdt' );
    ...
    $( '#id_program_rpjmd_hapus' ).val( data.id_program_rpjmd );
  ...
  $( '.modal-footer' ).on( 'click', '.delUrusanRPJMD', function () {
    ...
    $.ajax( {
      ...
      data: {
        ...
        'id_program_rpjmd_edit': $( '#id_program_rpjmd_hapus' ).val(),
      },
      success: function ( data ) {
        $( '#tblUrusan' ).DataTable().ajax.reload( null, false );
  ...
  $( '#tblUrusan tbody' ).on( 'dblclick', 'tr', function () {
    ...
    $( '#uraian_program_pelaksana' ).text( $( '#uraian_program_urbid' ).text() );
    $( '#uraian_urusan_pelaksana' ).text( data.nm_urusan );
    $( '#uraian_bidang_pelaksana' ).text( data.nm_bidang );
  ...
  $( document ).on( 'click', '.del-pelaksanaprog', function () {
    ...
    $( '.btnDelPelaksana' ).removeClass( 'delUnitPelaksanaBtl' );
    $( '.btnDelPelaksana' ).removeClass( 'delUnitPelaksanaPdt' );
  ...
  $( document ).on( 'click', '.view-rpjmdkebijakan', function () {
    ...
    $( '#uraian_sasaran_kebijakan' ).text( data.uraian_sasaran_rpjmd );
  ...
  $( document ).on( 'click', '.view-rpjmdstrategi', function () {
    ...
    $( '#uraian_sasaran_strategi' ).text( data.uraian_sasaran_rpjmd );
  ...
  function loadTblBtl ( id_visi ) {
    tblBtl = $( '#tblNonProgram' ).DataTable( {
      processing: true,
      serverSide: true,
      dom: 'BFrtip',
      responsive: true,
  ...
  $( document ).on( 'click', '.btnViewPendapatan', function () {
    ...
    $( '#uraian_dokumen_pdt' ).text( data.nomor_display );
  ...
  $( document ).on( 'click', '.btnViewBtl', function () {
    ...
    $( '#uraian_dokumen_btl' ).text( data.nomor_display );
  ...
  $( document ).on( 'click', '.btnPostingDok', function () {
    ...
    $.ajax( {
      type: 'post',
      url: './rpjmd/postDokRpjmd',
      data: {
        '_token': $( 'input[name=_token]' ).val(),
        'id_rpjmd': data.id_rpjmd,
  ...
  $( '.modal-footer' ).on( 'click', '.addProgramBtl', function () {
    ...
    $.ajax( {
      ...
      success: function ( data ) {
        $( '#tblNonProgram' ).DataTable().ajax.reload( null, false );
        if ( data.status_pesan == 1 ) {
          createPesan( data.pesan, "success" );
        } else {
          createPesan( data.pesan, "danger" );
  ...
  $( document ).on( 'click', '.btnEditBtl', function () {
    var data = tblBtl.row( $( this ).parents( 'tr' ) ).data();

    $( '.actionBtn_program' ).removeClass( 'editProgram' );
    $( '.actionBtn_program' ).removeClass( 'addProgram' );
    $( '.actionBtn_program' ).removeClass( 'addProgramBtl' );
    $( '.actionBtn_program' ).removeClass( 'addProgramPdt' );
    $( '.actionBtn_program' ).addClass( 'editProgramBtl' );
    $( '.actionBtn_program' ).removeClass( 'editProgramPdt' );
    $( '.modal-title' ).text( 'Data Program Pembangunan Daerah' );
    $( '.form-horizontal' ).show();
    $( '#id_program_rpjmd_edit' ).val( data.id_program_rpjmd );
  ...
  $( '#tblNonProgram tbody' ).on( 'dblclick', 'tr', function () {
    var data = tblBtl.row( this ).data();
    id_program_rpjmd = data.id_program_rpjmd;
    $( '.nav-tabs a[href="#urusanBtl"]' ).tab( 'show' );
    $( '#uraian_program_urbid_btl' ).text( data.uraian_program_rpjmd );
  ...
  $( document ).on( 'click', '.add-urbidbtl', function () {
    ...
    $( '.btnUrusan' ).removeClass( 'addUrusan' );
    $( '.btnUrusan' ).removeClass( 'editUrusan' );
    $( '.btnUrusan' ).addClass( 'addUrusanBtl' );
    $( '.btnUrusan' ).removeClass( 'editUrusanBtl' );
    $( '.btnUrusan' ).removeClass( 'addUrusanPdt' );
    $( '.btnUrusan' ).removeClass( 'editUrusanPdt' );
    $( '.modal-title' ).text( 'Tambah Urusan dan Bidang Pemerintahan RPJMD' );
  ...
  $( '.modal-footer' ).on( 'click', '.addUrusanBtl', function () {
    $.ajaxSetup( {
      headers: { 'X-CSRF-Token': $( 'meta[name=_token]' ).attr( 'content' ) }
    } );
    ...
    $.ajax( {
      ...
      success: function ( data ) {
        $( '#tblUrusanBtl' ).DataTable().ajax.reload( null, false );
        if ( data.status_pesan == 1 ) {
          createPesan( data.pesan, "success" );
        } else {
          createPesan( data.pesan, "danger" );
  ...
  $( document ).on( 'click', '.edit-urbidprog-btl', function () {
    ...
    $( '.btnUrusan' ).removeClass( 'editUrusan' );
    $( '.btnUrusan' ).removeClass( 'addUrusanBtl' );
    $( '.btnUrusan' ).addClass( 'editUrusanBtl' );
    $( '.btnUrusan' ).removeClass( 'addUrusanPdt' );
    $( '.btnUrusan' ).removeClass( 'editUrusanPdt' );
    $( '.modal-title' ).text( 'Tambah Urusan dan Bidang Pemerintahan RPJMD' );
    $( '.form-horizontal' ).show();
  ...
  $( '.modal-footer' ).on( 'click', '.editUrusanBtl', function () {
    $.ajaxSetup( {
      headers: { 'X-CSRF-Token': $( 'meta[name=_token]' ).attr( 'content' ) }
    } );
  ...
  $( document ).on( 'click', '.del-urbidprog-btl', function () {
    ...
    $( '.btnDelUrusan' ).removeClass( 'delUrusanRPJMD' );
    $( '.btnDelUrusan' ).addClass( 'delUrusanRPJMDBtl' );
    $( '.btnDelUrusan' ).removeClass( 'delUrusanRPJMDPdt' );
    $( '.modal-title' ).text( 'Hapus Urusan - Bidang pada RPJMD' );
    $( '#id_urusan_rkpd_hapus' ).val( data.id_urbid_rpjmd );
    $( '.ur_bidang_del' ).html( data.nm_bidang );
  ...
  $( '.modal-footer' ).on( 'click', '.delUrusanRPJMDBtl', function () {
    $.ajaxSetup( {
      headers: { 'X-CSRF-Token': $( 'meta[name=_token]' ).attr( 'content' ) }
    } );
  ...
  $( '#tblUrusanBtl tbody' ).on( 'dblclick', 'tr', function () {
    var data = UrusanBtl.row( this ).data();
    id_urusan_program = data.id_urbid_rpjmd;
    id_bidang_temp = data.id_bidang;
    $( '.nav-tabs a[href="#pelaksanaBtl"]' ).tab( 'show' );
    $( '#uraian_program_pelaksana_btl' ).text( $( '#uraian_program_urbid_btl' ).text() );
    $( '#uraian_urusan_pelaksana_btl' ).text( data.nm_urusan );
    $( '#uraian_bidang_pelaksana_btl' ).text( data.nm_bidang );
    loadPelaksanaBtl( id_urusan_program );
  } );

  $( document ).on( 'click', '.view-rpjmdpelaksana-btl', function () {
    var data = UrusanBtl.row( $( this ).parents( 'tr' ) ).data();
    id_urusan_program = data.id_urbid_rpjmd;
    id_bidang_temp = data.id_bidang;
    $( '.nav-tabs a[href="#pelaksanaBtl"]' ).tab( 'show' );
  ...
  var PelaksanaBtl;
  function loadPelaksanaBtl ( id_program_rpjmd ) {
    PelaksanaBtl = $( '#tblPelaksanaBtl' ).DataTable( {
      processing: true,
      serverSide: true,
      dom: 'BFrtip',
      responsive: true,
  ...
  $( document ).on( 'click', '.add-pelaksanabtl', function () {
    $( '.form-horizontal' ).show();
    $( '.modal-title' ).text( 'Daftar Unit Pelaksana yang dapat ditambahkan' );
    $( '#id_urbid_pelaksana' ).val( id_urusan_program );
    $( '#thn_pelaksana' ).val( tahun_rpjmd );
  ...
  $( document ).on( 'click', '.del-pelaksanaprog-btl', function () {
    var data = PelaksanaBtl.row( $( this ).parents( 'tr' ) ).data();
    $( '.btnDelPelaksana' ).removeClass( 'delUnitPelaksana' );
    $( '.btnDelPelaksana' ).addClass( 'delUnitPelaksanaBtl' );
    $( '.btnDelPelaksana' ).removeClass( 'delUnitPelaksanaPdt' );
    $( '.modal-title' ).text( 'Hapus Pelaksana pada RPJMD' );
    $( '#no_urut_hapus' ).val( data.no_urut );
    $( '#id_pelaksana_hapus' ).val( data.id_pelaksana_rpjmd );
  ...
  $( '.modal-footer' ).on( 'click', '.delUnitPelaksanaBtl', function () {
    $.ajaxSetup( {
      headers: { 'X-CSRF-Token': $( 'meta[name=_token]' ).attr( 'content' ) }
    } );
  ...
  $( document ).on( 'click', '.btnAddDapat', function () {
    ...
    $( '.actionBtn_program' ).removeClass( 'addProgramBtl' );
    $( '.actionBtn_program' ).addClass( 'addProgramPdt' );
    $( '.actionBtn_program' ).removeClass( 'editProgramBtl' );
    $( '.actionBtn_program' ).removeClass( 'editProgramPdt' );
    $( '.actionBtn_program' ).removeClass( 'addProgram' );
    $( '.actionBtn_program' ).removeClass( 'editProgram' );
  ...
  $( document ).on( 'click', '.btnEditPendapatan', function () {
    var data = tblPendapatan.row( $( this ).parents( 'tr' ) ).data();
    ...
    $( '.actionBtn_program' ).removeClass( 'addProgramPdt' );
    $( '.actionBtn_program' ).removeClass( 'editProgramBtl' );
    $( '.actionBtn_program' ).addClass( 'editProgramPdt' );
    $( '.modal-title' ).text( 'Data Program Pembangunan Daerah' );
    $( '.form-horizontal' ).show();
    $( '#id_program_rpjmd_edit' ).val( data.id_program_rpjmd );
    $( '#no_urut_program_edit' ).val( data.no_urut );
  ...
  $( '.modal-footer' ).on( 'click', '.editProgramPdt', function () {
    $.ajaxSetup( {
      headers: { 'X-CSRF-Token': $( 'meta[name=_token]' ).attr( 'content' ) }
    } );
  ...
  $( '#tblPendapatan tbody' ).on( 'dblclick', 'tr', function () {
    var data = tblPendapatan.row( this ).data();
    id_program_rpjmd = data.id_program_rpjmd;
    $( '.nav-tabs a[href="#urusanpdt"]' ).tab( 'show' );
    $( '#uraian_program_urbid_pdt' ).text( data.uraian_program_rpjmd );
    loadTblUrusanPdt( id_program_rpjmd );
  ...
  var UrusanPdt;
  function loadTblUrusanPdt ( id_program_rpjmd ) {
    UrusanPdt = $( '#tblUrusanPdt' ).DataTable( {
      processing: true,
      serverSide: true,
      dom: 'BFrtip',
      responsive: true,
  ...
  $( document ).on( 'click', '.add-urbidpdt', function () {
    ...
    $( '.btnUrusan' ).removeClass( 'addUrusanBtl' );
    $( '.btnUrusan' ).removeClass( 'editUrusanBtl' );
    $( '.btnUrusan' ).addClass( 'addUrusanPdt' );
    $( '.btnUrusan' ).removeClass( 'editUrusanPdt' );
    $( '.modal-title' ).text( 'Tambah Urusan dan Bidang Pemerintahan RPJMD' );
    $( '.form-horizontal' ).show();
    $( '#id_urbid_rpjmd_edit' ).val( null );
  ...
  $( '.modal-footer' ).on( 'click', '.addUrusanPdt', function () {
    $.ajaxSetup( {
      headers: { 'X-CSRF-Token': $( 'meta[name=_token]' ).attr( 'content' ) }
    } );
    ...
    $.ajax( {
      ...
      success: function ( data ) {
        $( '#tblUrusanPdt' ).DataTable().ajax.reload( null, false );
        if ( data.status_pesan == 1 ) {
          createPesan( data.pesan, "success" );
        } else {
          createPesan( data.pesan, "danger" );
  ...
  $( document ).on( 'click', '.edit-urbidprog-pdt', function () {

    var data = UrusanPdt.row( $( this ).parents( 'tr' ) ).data();
    $.ajax( {
      type: "GET",
      url: './admin/parameter/getBidang/' + data.kd_urusan,
      dataType: "json",
    ...
    $( '.btnUrusan' ).removeClass( 'editUrusanBtl' );
    $( '.btnUrusan' ).removeClass( 'addUrusanPdt' );
    $( '.btnUrusan' ).addClass( 'editUrusanPdt' );
    $( '.modal-title' ).text( 'Tambah Urusan dan Bidang Pemerintahan RPJMD' );
    $( '.form-horizontal' ).show();
    $( '#id_urbid_rpjmd_edit' ).val( data.id_urbid_rpjmd );
    $( '#thn_urbid_rpjmd_edit' ).val( data.thn_id );
  ...
  $( '.modal-footer' ).on( 'click', '.editUrusanPdt', function () {
    $.ajaxSetup( {
      headers: { 'X-CSRF-Token': $( 'meta[name=_token]' ).attr( 'content' ) }
    } );
  ...
  $( document ).on( 'click', '.del-urbidprog-pdt', function () {
    var data = UrusanPdt.row( $( this ).parents( 'tr' ) ).data();

    $( '.btnDelUrusan' ).removeClass( 'delUrusanRPJMD' );
    $( '.btnDelUrusan' ).removeClass( 'delUrusanRPJMDBtl' );
    $( '.btnDelUrusan' ).addClass( 'delUrusanRPJMDPdt' );
    $( '.modal-title' ).text( 'Hapus Urusan - Bidang pada RPJMD' );
    $( '#id_urusan_rkpd_hapus' ).val( data.id_urbid_rpjmd );
    $( '.ur_bidang_del' ).html( data.nm_bidang );
    $( '.ur_urusan_del' ).html( data.nm_urusan );
  ...
  $( '.modal-footer' ).on( 'click', '.delUrusanRPJMDPdt', function () {
    $.ajaxSetup( {
      headers: { 'X-CSRF-Token': $( 'meta[name=_token]' ).attr( 'content' ) }
    } );
  ...
  $( '#tblUrusanPdt tbody' ).on( 'dblclick', 'tr', function () {
    var data = UrusanPdt.row( this ).data();
    id_urusan_program = data.id_urbid_rpjmd;
    id_bidang_temp = data.id_bidang;
    $( '.nav-tabs a[href="#pelaksanapdt"]' ).tab( 'show' );
    $( '#uraian_program_pelaksana_pdt' ).text( $( '#uraian_program_urbid_pdt' ).text() );
    $( '#uraian_urusan_pelaksana_pdt' ).text( data.nm_urusan );
    $( '#uraian_bidang_pelaksana_pdt' ).text( data.nm_bidang );
    loadPelaksanaPdt( id_urusan_program );
  } );

  $( document ).on( 'click', '.view-rpjmdpelaksana-pdt', function () {
    var data = UrusanPdt.row( $( this ).parents( 'tr' ) ).data();
    id_urusan_program = data.id_urbid_rpjmd;
    id_bidang_temp = data.id_bidang;
    $( '.nav-tabs a[href="#pelaksanapdt"]' ).tab( 'show' );
  ...
  var PelaksanaPdt;
  function loadPelaksanaPdt ( id_program_rpjmd ) {
    PelaksanaPdt = $( '#tblPelaksanaPdt' ).DataTable( {
      processing: true,
      serverSide: true,
      dom: 'BFrtip',
      responsive: true,
  ...
  $( document ).on( 'click', '.add-pelaksanapdt', function () {
    $( '.form-horizontal' ).show();
    $( '.modal-title' ).text( 'Daftar Unit Pelaksana yang dapat ditambahkan' );
    $( '#id_urbid_pelaksana' ).val( id_urusan_program );
    $( '#thn_pelaksana' ).val( tahun_rpjmd );
  ...
  $( document ).on( 'click', '.del-pelaksanaprog-pdt', function () {
    var data = PelaksanaPdt.row( $( this ).parents( 'tr' ) ).data();
    $( '.btnDelPelaksana' ).removeClass( 'delUnitPelaksana' );
    $( '.btnDelPelaksana' ).removeClass( 'delUnitPelaksanaBtl' );
    $( '.btnDelPelaksana' ).addClass( 'delUnitPelaksanaPdt' );
    $( '.modal-title' ).text( 'Hapus Pelaksana pada RPJMD' );
    $( '#no_urut_hapus' ).val( data.no_urut );
    $( '#id_pelaksana_hapus' ).val( data.id_pelaksana_rpjmd );
    $( '#ur_pelaksana_hapus' ).html( data.nm_unit );
  ...
  $( '.modal-footer' ).on( 'click', '.delUnitPelaksanaPdt', function () {
    $.ajaxSetup( {
      headers: { 'X-CSRF-Token': $( 'meta[name=_token]' ).attr( 'content' ) }
    } );
