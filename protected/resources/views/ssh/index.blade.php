    ...
    <div class="col-md-12">
      <div class="panel panel-success">
        <div class="panel-heading">
          <p>
            <h2 class="panel-title"><span href="#" data-toggle="popover" data-container="body" title="Struktur SSH"
                data-trigger="hover"
                data-content="Terdiri dari empat level. Level keempat dikaitkan ke rekening belanja; tiap item SSH bisa lebih dari satu rekening belanja.">Standar
                Satuan Harga</span></h2>
          </p>
        </div>
        ...
        <div class="panel-body">
          ...
          <ul class="nav nav-tabs" role="tablist">
            <li class="active"><a href="#golongan" aria-controls="golongan" role="tab" data-toggle="tab">Golongan</a>
            </li>
          ...
          <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="golongan">
              ...
              <div class="add">
                <p>
                  ...
                  <span><a id="btnAddGol" class="add-golongan btn btn-success btn-labeled"><span class="btn-label"><i
                          class="glyphicon glyphicon-plus"></i></span>Tambah Golongan</a></span>
                </p>
              </div>
              <div class="">
                <table id='tblGolongan' class="table display table-striped compact table-bordered table-responsive"
            ...
            <div role="tabpanel" class="tab-pane" id="kelompok">
              ...
              <div class="add">
                <p>
                  ...
                  <span><a id="btnAddKel" class="add-kelompok btn btn-sm btn-success btn-labeled"><span
                        class="btn-label"><i class="glyphicon glyphicon-plus"></i></span>Tambah Kelompok</a></span>
                </p>
              </div>
                  ...
                  <table class="table display table-striped compact table-bordered table-responsive">
                    <tbody>
                      <tr>
                        ...
                        <td style="text-align: left; vertical-align:top;"><label id="nm_golongan_kel"
                            align='left'></label></td>
                      </tr>
                    </tbody>
                  </table>
            ...
            <div role="tabpanel" class="tab-pane" id="subkelompok">
              ...
              <div class="add">
                <p>
                  ...
                  <span><a id="btnAddSubKel" class="add-subkelompok btn btn-sm btn-success btn-labeled">
                      <span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span>Tambah Sub
                      Kelompok</a></span>
                </p>
              </div>
              <form class="form-horizontal" role="form" autocomplete='off' action="" method="">
                <div class="">
                  <table class="table display table-striped compact table-bordered table-responsive">
                    <tbody>
                      <tr>
                        <td width="15%" style="text-align: left; vertical-align:top;">Nama Golongan</td>
                        <td style="text-align: left; vertical-align:top;"><label id="nm_golongan_skel"
                            align='left'></label></td>
                      </tr>
                      <tr>
                        <td width="15%" style="text-align: left; vertical-align:top;">Nama Kelompok</td>
                        <td style="text-align: left; vertical-align:top;"><label id="nm_kelompok_skel"
                            align='left'></label></td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div id="divSubKelompok">
                <div class="">
                  <table id="tblSubKelompok" class="table display compact table-striped table-bordered table-responsive"
                    cellspacing="0" width="100%">
                    <thead>
                      <tr>
            ...
            <div role="tabpanel" class="tab-pane" id="tarif">
                ...
                <div class="">
                  <table class="table display table-striped compact table-bordered table-responsive">
                    <tbody>
                      <tr>
                        <td width="15%" style="text-align: left; vertical-align:top;">Nama Golongan</td>
                        <td style="text-align: left; vertical-align:top;"><label id="nm_golongan_tarif"
                            align='left'></label></td>
                      </tr>
                      <tr>
                        <td width="15%" style="text-align: left; vertical-align:top;">Nama Kelompok</td>
                        <td style="text-align: left; vertical-align:top;"><label id="nm_kelompok_tarif"
                            align='left'></label></td>
                      </tr>
                      <tr>
                        <td width="15%" style="text-align: left; vertical-align:top;">Nama Sub Kelompok</td>
                        <td style="text-align: left; vertical-align:top;"><label id="nm_subkelompok_tarif"
                            align='left'></label></td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div id="divTarif">
                <div class="">
                  <table id="tblTarif" class="table display compact table-striped table-bordered table-responsive"
                    cellspacing="0" width="100%">
                    <thead>
                      <tr>
            ...
            <div role="tabpanel" class="tab-pane" id="rekening">
              <br>
              <div class="add">
                <p id="btnAddRek"><a class="add-rekening btn btn-success btn-labeled"><span class="btn-label"><i
                        class="glyphicon glyphicon-plus"></i></span></i> Tambah Rekening</a></p>
              </div>
              <form class="form-horizontal" role="form" autocomplete='off' action="" method="">
                <div class="">
                  <table class="table display table-striped compact table-bordered table-responsive">
                    <tbody>
                      <tr>
                        <td width="15%" style="text-align: left; vertical-align:top;">Nama Golongan</td>
                        <td style="text-align: left; vertical-align:top;"><label id="nm_golongan_rek"
                            align='left'></label></td>
                      </tr>
                      <tr>
                        <td width="15%" style="text-align: left; vertical-align:top;">Nama Kelompok</td>
                        <td style="text-align: left; vertical-align:top;"><label id="nm_kelompok_rek"
                            align='left'></label></td>
                      </tr>
                      <tr>
                        <td width="15%" style="text-align: left; vertical-align:top;">Nama Sub Kelompok</td>
                        <td style="text-align: left; vertical-align:top;"><label id="nm_subkelompok_rek"
                            align='left'></label></td>
                      </tr>
                      <tr>
                        <td width="15%" style="text-align: left; vertical-align:top;">Nama Item SSH</td>
                        <td style="text-align: left; vertical-align:top;"><label id="nm_itemssh_rek"
                            align='left'></label></td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div id="divRekening">
                <div class="">
                  <table id="tblRekening" class="table display compact table-striped table-bordered table-responsive"
                    cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th width="10%" style="text-align: center; vertical-align:middle">Id Item SSH</th>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" autocomplete='off' action="{{ route('TambahGolongan') }}"
          method="post">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <input type="text" class="form-control" id="no_urut_gol" name="no_urut_gol" required="required"
                data-toggle="popover" data-container="body" title="Struktur SSH" data-trigger="hover"
                data-content="Diisi sesuai urutan nomor di pencetakan daftar SSH">
            </div>
          </div>
          <div class="form-group">
            <label for="ur_golongan" class="col-sm-3 control-label" align='left'>Uraian Golongan SSH :</label>
            <div class="col-sm-8">
              <textarea type="text" class="form-control" rows="5" id="ur_golongan" name="ur_golongan"
...
<div id="TambahKelompok" class="modal fade" role="dialog" data-backdrop="static">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <!-- <form class="form-horizontal" role="form"> -->
      <div class="modal-body">
        <form class="form-horizontal" role="form" autocomplete='off' action="{{ route('TambahKelompok') }}"
          method="post">
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <textarea type="text" class="form-control" rows="5" id="ur_kel_ssh" name="ur_kel_ssh"
                required="required"></textarea>
            </div>
          </div>
        </form>
...
<div id="TambahSubKelompok" class="modal fade" role="dialog" data-backdrop="static">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <!-- <form class="form-horizontal" role="form"> -->
      <div class="modal-body">
        <form class="form-horizontal" role="form" autocomplete='off' action="{{ route('TambahSubKelompok') }}"
          method="post">
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <textarea type="text" class="form-control" rows="5" id="ur_subkel_ssh" name="ur_subkel_ssh"
                required="required"></textarea>
            </div>
          </div>
        </form>
          ...
          <div class="col-sm-10 text-right">
            <div class="ui-group-buttons">
              <button type="button" class="btn btn-success btnEditSKel btn-labeled" data-dismiss="modal">
                <span class="btn-label"><i id="fooEditSKel"
                    class="fa fa-floppy-o fa-fw fa-lg"></i></span>Update</button>
              <div class="or"></div>
              <button type="button" class="btn btn-warning btn-labeled" data-dismiss="modal" aria-hidden="true">
                <span class="btn-label"><i class="fa fa-sign-out fa-fw fa-lg"></i></span>Tutup</button>
            </div>
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" autocomplete='off' action="{{ route('TambahItem') }}" method="post">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <textarea type="text" class="form-control" rows="5" id="ur_item_ssh" name="ur_item_ssh"
                required="required"></textarea>
            </div>
          </div>
          <div class="form-group">
            <label for="ket_item_ssh" class="col-sm-3 control-label" align='left'>Keterangan/Merek/Spesifikasi Lainnya
              :</label>
            <div class="col-sm-8">
              <textarea type="text" class="form-control" rows="5" id="ket_item_ssh" name="ket_item_ssh"
                required="required"></textarea>
            </div>
          </div>
          <div class="form-group">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" autocomplete='off' action="" method="post" name="frmEditItem">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <input type="text" class="form-control" id="no_urut_item_edit" name="no_urut_item_edit"
                required="required" data-toggle="popover" data-container="body" title="Struktur SSH"
                data-trigger="hover" data-content="Diisi sesuai urutan nomor di pencetakan daftar SSH">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="ket_item_ssh_edit" class="col-sm-3 control-label" align='left'>Keterangan/Merek/Spesifikasi
              Lainnya :</label>
            <div class="col-sm-8">
              <textarea type="text" class="form-control" rows="5" id="ket_item_ssh_edit" name="ket_item_ssh_edit"
                required="required"></textarea>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <label class="radio-inline">
                <input type="radio" class="status_item_edit" name="status_item_edit" id="status_item_edit" value="0">
                Aktif
              </label>
              <label class="radio-inline">
                <input type="radio" class="status_item_edit" name="status_item_edit" id="status_item_edit" value="1">
                Tidak Aktif
              </label>
            </div>
          </div>
          ...
          <div class="col-sm-10 text-right">
            <div class="ui-group-buttons">
              <button type="button" class="btn btn-success btnEditItem btn-labeled" data-dismiss="modal">
                <span class="btn-label"><i id="fooEditItem"
                    class="fa fa-floppy-o fa-fw fa-lg"></i></span>Update</button>
              <div class="or"></div>
              <button type="button" class="btn btn-warning btn-labeled" data-dismiss="modal" aria-hidden="true">
                <span class="btn-label"><i class="fa fa-sign-out fa-fw fa-lg"></i></span>Tutup</button>
...
<div id="TambahRekening" class="modal fade" role="dialog" data-backdrop="static">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" autocomplete='off' action="{{ route('TambahRekening') }}"
            ...
            <div class="col-sm-8">
              <div class="input-group">
                ...
                <div class="input-group-btn">
                  <button class="btn btn-primary" data-toggle="modal" href="#cariRekening" data-toggle="popover"
                    data-container="body" title="Struktur SSH" data-trigger="hover"
                    data-content="Dikaitkan ke parameter rekening; dapat dikaitkan ke lebih dari satu rekening"><i
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" autocomplete='off' action="" method="post" onsubmit="return false;">
          ...
          <div class="form-group">
            <label for="id_rekening_edit" class="col-sm-3 control-label" align='left'>Rekening belanja Item SSH
              :</label>
            <div class="col-sm-8">
              <input type="hidden" class="form-control" id="id_rekening_edit" name="id_rekening_edit"
                required="required">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" autocomplete='off' action="" method="">
          <div class="form-group">
            <div class="col-sm-12">
              <table id='tblCariRekening' class="table display table-striped table-bordered" cellspacing="0"
                width="100%">
                <thead>
                  <tr>
                    <th width="5%" style="text-align: center; vertical-align:middle">No Urut</th>
...
<script type="text/javascript" language="javascript" class="init"
  src="{{ asset('/protected/resources/views/ssh/js_index_ssh.js')}}"></script>
@endsection