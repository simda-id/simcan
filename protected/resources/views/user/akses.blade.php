                            ...
                            <ul>
                                <li> Parameter
                                    <ul>
                                        ...
                                        <li data-value="114"> Program Prioritas
                                            <ul>
                                                <li data-value="113"> Prioritas Nasional</li>
                                                <li data-value="114"> Prioritas Provinsi</li>
                                            </ul>
                                        </li>
                                    ...
                                    <ul>
                                        <li> Standar Satuan Harga
                                            <ul>
                                                ...
                                                <li data-value="808"> Hibah & Bantuan Sosial</li>
                            ...
                            <ul>
                                <li> Renja Final
                                    <ul>
                                        ...
                                        <li data-value="505"> Dokumen Renja< Final</li> <li data-value="542"> Cetak
                                                Renja Final </li>
                                    </ul>
                                </li>
                            </ul>
                    ...
                    <div class="col-md-3 text-left">
                        <div class="ui-group-buttons">
                            <button id="submit" type="submit" class="btn btn-sm btn-primary btnLoadAsb btn-labeled">
                                <span class="btn-label"><i id="fooLoadAsb"
                                        class="fa fa-floppy-o fa-lg fa-fw"></i></span>Simpan</button>
                            <div class="or"></div>
                            <a href="{{url('admin/parameter/user/group')}}" id="btnBatal" type="button"
