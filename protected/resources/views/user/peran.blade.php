  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body" style="background-color: #eee;">
        <form name="frmModalGroup" class="form-horizontal" role="form" autocomplete='off' action="" method="post"
          ...
          <div class="row">
            ...
            <div class="col-sm-10">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="name_proup" name="name_proup" required="required">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="col-sm-6">
                    <label class="radio-inline">
                      <input class="flag_aktif" type="radio" name="flag_aktif" id="flag_aktif" value="0"> Tidak
                      Aktif</label>
                  </div>
                  <div class="col-sm-6">
                    <label class="radio-inline">
